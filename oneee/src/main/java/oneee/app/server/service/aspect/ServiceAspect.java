package oneee.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* oneee.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* oneee.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* oneee.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* oneee.app.server.service..*..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* oneee.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* oneee.app.server.service..get*(..))")
