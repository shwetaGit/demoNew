package oneee.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* oneee.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* oneee.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* oneee.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* oneee.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* oneee.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* oneee.app.server.repository..*(..))")
