package oneee.app.shared.contacts;
...
import oneee.app.shared.EntityAudit;
import oneee.app.shared.SystemInfo;
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<oneee.app.shared.contacts.CommunicationData>();
        }
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<oneee.app.shared.location.Address>();
        }
        if (_address != null) {
    ...
    public boolean equals(Object obj) {
        try {
            oneee.app.shared.contacts.CoreContacts other = (oneee.app.shared.contacts.CoreContacts) obj;
            if (contactId == null) {
                return false;
