 ...
 * 
 */
Ext.define('Oneee.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Oneee.view.logalarm.mainscreen.AddLogAlarmController',
			'Oneee.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Oneee.view.logalarm.mainscreen.AppAlarmPanel',
