 ...
 * 
 */
Ext.define('Oneee.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Oneee.view.logalarm.LogAlarmMainViewController',
			'Oneee.view.logalarm.tree.LogAlarmTreePanel',
			'Oneee.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
