Ext.define('Oneee.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Oneee.view.usermanagement.enduser.UserProfileController', 'Oneee.view.usermanagement.admin.AddUserDetailsViewModel', 'Oneee.model.AddUserDataModel' ],
