Ext.define('Oneee.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Oneee.view.usermanagement.admin.UserPasswordReset',
	            'Oneee.view.usermanagement.admin.AddUserDetails',
	            'Oneee.view.usermanagement.admin.ViewUser'],
