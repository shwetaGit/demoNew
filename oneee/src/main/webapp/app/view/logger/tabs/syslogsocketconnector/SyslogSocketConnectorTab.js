 ...
 * 
 */
Ext.define('Oneee.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Oneee.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
