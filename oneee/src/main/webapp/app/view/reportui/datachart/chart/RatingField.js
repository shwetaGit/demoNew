...
Ext.define('Oneee.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Oneee.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Oneee.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
