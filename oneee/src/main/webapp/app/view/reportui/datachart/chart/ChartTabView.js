Ext.define('Oneee.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Oneee.view.reportui.datachart.chart.RatingField','Oneee.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
