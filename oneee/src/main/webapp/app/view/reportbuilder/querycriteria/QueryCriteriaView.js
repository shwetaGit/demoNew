Ext.define('Oneee.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Oneee.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Oneee.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Oneee.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Oneee.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
