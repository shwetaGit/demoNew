Ext.define('Oneee.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Oneee.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Oneee.view.reportbuilder.gridconfig.GridConfigView',
	           'Oneee.view.reportbuilder.properties.PropertiesPanelView',
	           'Oneee.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
