Ext.define("Oneee.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Oneee.view.clouddrive.CloudDriveController',
	             'Oneee.view.clouddrive.documentview.DocumentsView',
	             'Oneee.view.clouddrive.drivedetails.DriveDetails',
	             //'Oneee.view.clouddrive.documentview.DocumentListView'
	             ],
