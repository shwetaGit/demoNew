Ext.define('Oneee.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Oneee.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
