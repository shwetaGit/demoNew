Ext.define('Oneee.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Oneee.view.querybuildernewmodel.querycondition.QuerySelectController',
