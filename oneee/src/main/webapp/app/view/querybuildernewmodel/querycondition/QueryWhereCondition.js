Ext.define('Oneee.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Oneee.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
