Ext.define('Oneee.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Oneee.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Oneee.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Oneee.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Oneee.view.querybuildernewmodel.querydetail.QueryDetail');
