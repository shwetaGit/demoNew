Ext.define('Oneee.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Oneee.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Oneee.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Oneee.view.querybuildernewmodel.floatingentity.EntitySprite',
