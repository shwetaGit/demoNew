 ...
 * 
 */
Ext.define('Oneee.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Oneee.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Oneee.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
