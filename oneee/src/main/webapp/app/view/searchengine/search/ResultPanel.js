Ext
		.define(
				'Oneee.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Oneee.view.searchengine.search.SearchEngineMainPanelController','Oneee.view.searchengine.search.PanelHeaderField' ,'Oneee.view.searchengine.search.ReportGridView','Oneee.view.searchengine.search.ReportChartView','Oneee.view.searchengine.search.documentView','Oneee.view.searchengine.search.DouMeanView','Oneee.view.googlemaps.map.MapPanel'],
