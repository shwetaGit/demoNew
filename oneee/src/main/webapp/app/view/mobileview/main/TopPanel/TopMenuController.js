...
Ext.define('Oneee.view.mobileview.main.TopPanel.TopMenuController', {
 					...
 					for(var  int = 0 ; int < menuChildLength ; int++)
 		    		{
 						...
 						menuData.push(
 						{
 							...
 							renderCentralPanel:function(currentObject,menu)
 							{
 								...
 								{
 	 									debugger;
 	 									var component = Ext.create('Oneee.view.mobileview.art.masterform.MasterPanel',{closable : true,title: menu.text, artMasterFormId:menu.config.data.refId});
