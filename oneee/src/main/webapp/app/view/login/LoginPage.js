Ext.define('Oneee.view.login.LoginPage', {
	extend : 'Ext.panel.Panel',
	xtype : 'login',

	controller : 'login',
	requires : [ 'Oneee.view.login.LoginPageController',
	             // 'Oneee.view.login.LoginModel',
	             'Ext.form.Panel', 'Ext.button.Button', 'Ext.form.field.Text', 'Oneee.view.main.MainPanel' ],
