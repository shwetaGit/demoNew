...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionDetails("3Za4dPeI6i");
        question.setLevelid(6);
        question.setQuestionIcon("5WL9NOsmga7QmN30jHwPeXpqvDPr8ac3WzUing4LqwGF4CgsZE");
        question.setQuestion("TJCNFTLJEFySOieuWLa3HaQU4HD7JIc6bvGVtse9hdKdhtvqLs");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("GTHVGvIiUH");
            question.setVersionId(1);
            question.setLevelid(5);
            question.setQuestionIcon("7N155VwNTliFQ0JdSPgGJcoxEQ3PP7voEzZu5O5Xq0HgkacPTs");
            question.setQuestion("ur42pXP5sDqAbjyOWguF5GYNuXaZRjDV2pthxZcSIqJHQFn4jR");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "BwsfqKqn4Ti5EYeZgSwUAfWQnXhoeCLfUe9HwZyolgxB5drHleIVzi21HJNJDxNjy"));
