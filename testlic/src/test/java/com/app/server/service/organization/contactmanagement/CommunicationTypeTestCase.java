...
public class CommunicationTypeTestCase extends EntityTestCriteria {
    ...
    private CommunicationType createCommunicationType(Boolean isSave) throws Exception {
        ...
        communicationgroup.setCommGroupDescription("xDQ0JWUouwvPIJ6P3UnAfM5hJGRJBTFcMx3vy6F00WjI1l1Ptu");
        communicationgroup.setCommGroupName("hp3nBoUEi1Da8KF2UgwGehV2v51wQQZUKUbt8FIN2zYZY6o6O5");
        ...
        communicationtype.setCommTypeName("kHcBBSmrZgaNMW9xCQPWfMDIjI6bvKQIIIlsJ6KjALoh9iXZmt");
        communicationtype.setCommGroupId((java.lang.String) CommunicationGroupTest._getPrimarykey());
        communicationtype.setCommTypeDescription("U5qJ3u5EGEFpdxuH13kTKPUFQAANSnuZiSoLnlG0YEHbwkYUWk");
    ...
    public void test2Update() {
        try {
            ...
            communicationtype.setCommTypeName("aex0EdvasnaDETuIJDY7wcJfoUqzllyG7ZHjqJhrqwJOWlasXU");
            communicationtype.setCommTypeDescription("5fZXh3cl91rVf87iJaVrsB1jeJnfETEx5yPDuI5BAoMrFZiYLL");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "commTypeName", "2cxeQqmE6ZirrX1wWZA2b6bV2gspdI4Y5zsUjtQLT1kRrIkJggtiadR80Y0RrHCPKfM0bGfuE0k2EF9y2YOZ9loPOVLXtKYFCF7oECcbItgSAN3lYLbLttefDhvtBXvmP"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "commTypeDescription", ""));
