...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccessdomain.setDomainName("dyK50sWt47gpQSFSiuFdUhwjRKCwG0vjgynyyBVt5S8CGnhIZK");
        useraccessdomain.setDomainHelp("WpBb6ZAoYpt0cIaH5Sz7zyFbLZRExwyFo4hcSyqzQ8cmIyMvgA");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainIcon("YRz8PIu88OUZRgQ8L12vtPxLNm4FzUPdA0U81pq0dI2Itd9cQO");
        useraccessdomain.setDomainDescription("u69MJmDjqBLDi0rIt1TEu0kZGdEHgQzStlu6HJ7P5YAsyVM70b");
        ...
        useraccesslevel.setLevelHelp("bbBXK0QigOjT107ACl2aw3f12OmKMSA7bshtgCiEw85mUboTsh");
        useraccesslevel.setLevelName("nOhSwManVMNM93fhXCnl49qY5nM9CgjHHWuREDD6eoXWpn9Wa9");
        useraccesslevel.setLevelIcon("ueO3Ascv6uN83JEB87HbYXR4CCuqa84IX3XCrn1RxXdNswnj3Z");
        useraccesslevel.setLevelDescription("AX7gPkXPAaADi6nHHQLeehIBUDGslg82PHmzxDcA6avSaUkKOb");
        ...
        User user = new User();
        user.setSessionTimeout(3220);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1463137337315l));
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setChangePasswordNextLogin(1);
        user.setIsLocked(1);
        user.setUserAccessCode(29130);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setAllowMultipleLogin(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1463137337396l));
        user.setIsDeleted(1);
        user.setGenTempOneTimePassword(1);
        user.setPasswordAlgo("MJYV8W7H3QvPArCBjF3mcyymaWZGFLa7fCL2tOkpMiCuTr3lZB");
        user.setMultiFactorAuthEnabled(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionDetails("0Vlfmmxhf1");
        question.setLevelid(2);
        question.setQuestionIcon("PnXWUznZn2DzjiiQpIQOaBAD86NJEMglGfoalGC8tVfDiQiw4R");
        question.setQuestion("yVsNsX8JApcA1DAMtVE3QshkTHg3nYEefCWS8xDjfvjzgoXB4D");
        ...
        passrecovery.setAnswer("4G0vJvjL95Sxq4LDuvmpkpHKhfCCtBNDTmql9NmoYP6ZNrSZoU");
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePasswordExpiry(6);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1463137337597l));
        userdata.setLast5Passwords("LecUQQrQLhfBa99yvYIouw3bdoyy0hrD1ze1sT94E08C1B1OKm");
        userdata.setOneTimePasswordExpiry(10);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1463137337607l));
        userdata.setLast5Passwords("TIxLSuG3LdojZMrwqCtLxzGwB9Y0TtsTV2ISaUshh9yfumr8aM");
        userdata.setUser(user);
        userdata.setPassword("Arstrf4vOhiMfLKWblzWizJYYjNv88MvfouBWZ8j98GPEUj6Fk");
        userdata.setOneTimePassword("HUfznTWESgDer2MQTKytWeLDBvjChp5s");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 112772));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "UCiz01qBzRAyDCfdriaolunvnYeCwKES64AXnn4sYLCDmQ0gZUvdPktqaqjyd6z6Q"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 5669));
