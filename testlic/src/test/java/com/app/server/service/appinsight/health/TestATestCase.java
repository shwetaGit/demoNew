...
public class TestATestCase extends EntityTestCriteria {
    ...
    private TestA createTestA(Boolean isSave) throws Exception {
        ...
        testa.setTnm("ghymsZ3Jd4vw7Y2Y5N6MrKUJhIBKGxRvHZo7lXnT3BznIQ3Aui");
    ...
    public void test2Update() {
        try {
            ...
            testa.setTno(2147483647);
            testa.setTnm("LRF98mfWf4ZYjJ8cYQ2MmiF74LsxzItkIQ1yMSiIWQ1aqr0YhY");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "tnm", ""));
