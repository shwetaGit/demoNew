Ext.define('Testlic.view.desktop.design.menubar.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Testlic.view.desktop.design.menubar.main.MainPanelController','Testlic.view.desktop.design.menubar.menu.AppMenuBar'],
    userinfo:{},
    id:'mainPanel',
