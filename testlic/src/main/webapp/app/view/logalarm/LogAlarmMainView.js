 ...
 * 
 */
Ext.define('Testlic.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Testlic.view.logalarm.LogAlarmMainViewController',
			'Testlic.view.logalarm.tree.LogAlarmTreePanel',
			'Testlic.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
