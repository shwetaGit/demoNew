 ...
 * 
 */
Ext.define('Testlic.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testlic.view.logalarm.mainscreen.AddLogAlarmController',
			'Testlic.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testlic.view.logalarm.mainscreen.AppAlarmPanel',
