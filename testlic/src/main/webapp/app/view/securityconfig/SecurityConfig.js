 ...
 * 
 */
Ext.define('Testlic.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testlic.view.securityconfig.SecurityConfigController',
			'Testlic.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
