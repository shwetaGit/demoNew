Ext
		.define(
				'Testlic.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testlic.view.searchengine.search.SearchEngineMainPanelController','Testlic.view.searchengine.search.PanelHeaderField' ,'Testlic.view.searchengine.search.ReportGridView','Testlic.view.searchengine.search.ReportChartView','Testlic.view.searchengine.search.documentView','Testlic.view.searchengine.search.DouMeanView','Testlic.view.googlemaps.map.MapPanel'],
