Ext.define("Testlic.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Testlic.view.clouddrive.CloudDriveController',
	             'Testlic.view.clouddrive.documentview.DocumentsView',
	             'Testlic.view.clouddrive.drivedetails.DriveDetails',
	             //'Testlic.view.clouddrive.documentview.DocumentListView'
	             ],
