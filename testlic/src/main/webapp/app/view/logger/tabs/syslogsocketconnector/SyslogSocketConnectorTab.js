 ...
 * 
 */
Ext.define('Testlic.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testlic.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
