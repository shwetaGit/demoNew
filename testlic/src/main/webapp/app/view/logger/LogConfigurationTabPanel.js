...
Ext
		.define(
				'Testlic.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testlic.view.logger.tabs.details.DetailsTab',
							'Testlic.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testlic.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testlic.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testlic.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testlic.view.logger.LogConfigurationTabPanelController',
