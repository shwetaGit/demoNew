Ext.define('Testlic.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testlic.view.usermanagement.admin.UserPasswordReset',
	            'Testlic.view.usermanagement.admin.AddUserDetails',
	            'Testlic.view.usermanagement.admin.ViewUser'],
