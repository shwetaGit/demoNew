...
public class BusinessServiceusermanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.appbasicsetup.usermanagement..*(..)) && !alarmOperation()")
    protected void allOperation() {
    }

    @Pointcut("execution(* com.app.server.businessservice.appbasicsetup.usermanagement.AppLogAlarmGenerationBizService..*(..))")
