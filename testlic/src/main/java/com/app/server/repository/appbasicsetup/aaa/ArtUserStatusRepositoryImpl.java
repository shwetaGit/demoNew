...
import com.athena.server.constant.RepositoryConstants;



@Repository
@Transactional
public class ArtUserStatusRepositoryImpl implements ArtUserStatusRepository, RepositoryConstants{
	...
	public void save(ArtUserLastStatus userLastStatus)throws Exception
	{
		...
		try {
			...
			throw new Exception(DATABASE_QUERY_FAILED_INFO + " in " + Thread.currentThread().getStackTrace()[1].getMethodName());
		}
	}
