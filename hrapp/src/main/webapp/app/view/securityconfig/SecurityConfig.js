 ...
 * 
 */
Ext.define('Hrapp.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Hrapp.view.securityconfig.SecurityConfigController',
			'Hrapp.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
