Ext.define("Hrapp.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Hrapp.view.clouddrive.CloudDriveController',
	             'Hrapp.view.clouddrive.documentview.DocumentsView',
	             'Hrapp.view.clouddrive.drivedetails.DriveDetails',
	             //'Hrapp.view.clouddrive.documentview.DocumentListView'
	             ],
