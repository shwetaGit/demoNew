...
Ext
		.define(
				'Hrapp.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Hrapp.view.logger.tabs.details.DetailsTab',
							'Hrapp.view.logger.tabs.fileconnector.FileConnectorTab',
							'Hrapp.view.logger.tabs.dbconnector.DBConnectorTab',
							'Hrapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Hrapp.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Hrapp.view.logger.LogConfigurationTabPanelController',
