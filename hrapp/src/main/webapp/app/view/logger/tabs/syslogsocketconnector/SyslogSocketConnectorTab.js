 ...
 * 
 */
Ext.define('Hrapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Hrapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
