Ext
		.define(
				'Hrapp.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Hrapp.view.searchengine.search.SearchEngineMainPanelController','Hrapp.view.searchengine.search.PanelHeaderField' ,'Hrapp.view.searchengine.search.ReportGridView','Hrapp.view.searchengine.search.ReportChartView','Hrapp.view.searchengine.search.documentView','Hrapp.view.searchengine.search.DouMeanView','Hrapp.view.googlemaps.map.MapPanel'],
