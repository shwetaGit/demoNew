Ext.define('Hrapp.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Hrapp.view.usermanagement.admin.UserPasswordReset',
	            'Hrapp.view.usermanagement.admin.AddUserDetails',
	            'Hrapp.view.usermanagement.admin.ViewUser'],
