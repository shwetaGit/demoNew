 ...
 * 
 */
Ext.define('Hrapp.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Hrapp.view.logalarm.mainscreen.AddLogAlarmController',
			'Hrapp.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Hrapp.view.logalarm.mainscreen.AppAlarmPanel',
