package hrapp.app.shared.aaaboundedcontext.authorization;
...
@SourceCodeAuthorClass(createdBy = "sagar.jadhav@algorhythm.co.in", updatedBy = "sagar.jadhav@algorhythm.co.in", versionNumber = "2", comments = "RoleMenuBridge", complexity = Complexity.LOW)
...
public class RoleMenuBridge implements Serializable, CommonEntityInterface, Comparator<RoleMenuBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            hrapp.app.shared.aaaboundedcontext.authorization.RoleMenuBridge other = (hrapp.app.shared.aaaboundedcontext.authorization.RoleMenuBridge) obj;
            if (roleMenuMapId == null) {
                return false;
