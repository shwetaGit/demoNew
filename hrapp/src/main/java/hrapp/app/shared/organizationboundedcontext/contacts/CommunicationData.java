package hrapp.app.shared.organizationboundedcontext.contacts;
...
public class CommunicationData implements Serializable, CommonEntityInterface, Comparator<CommunicationData> {
    ...
    public boolean equals(Object obj) {
        try {
            hrapp.app.shared.organizationboundedcontext.contacts.CommunicationData other = (hrapp.app.shared.organizationboundedcontext.contacts.CommunicationData) obj;
            if (commDataId == null) {
                return false;
