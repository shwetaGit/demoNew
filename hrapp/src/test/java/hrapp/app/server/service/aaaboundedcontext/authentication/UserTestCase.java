...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccessdomain.setDomainDescription("KC8zds2NW5AnbgwDkxOAOhkXxLmHB0YkWAMXxP4KxAzyXLuDLz");
        useraccessdomain.setDomainHelp("fb9Gq2vnNxYnWGbWtJM04W7g0bexYsQBMgbisRE3IlNFAxabhF");
        useraccessdomain.setDomainName("3VLxfffooyLngJqLxfaPhlJKnR3yqceSm9wM04UwLmTNs0sWcc");
        useraccessdomain.setDomainIcon("77HIIUrJXMRCKhbKTMA7V8NGxq8pPwpVCZIDXDJ31Ho6IYOYRZ");
        ...
        useraccesslevel.setLevelName("fUdAVDJOBHmKsr0jXXfzCXHfHz0K84etH3DIxmJITyRnTcAglT");
        useraccesslevel.setLevelHelp("IhhrjtdIF7pA5dS5icntlYiQXpJKNIAKihCGVFpWFxyJ1MKXYN");
        useraccesslevel.setLevelIcon("oOUVhPX8bYn4uXNzKZKE0vIMDDj6AHMRAJ7NCNgqzBJ9xPqHMn");
        useraccesslevel.setLevelDescription("4pOUow9RXZsNIMCJFHbNENuvKCB83zjKBPbdQpmrdILU68XjmZ");
        ...
        user.setPasswordExpiryDate(new java.sql.Timestamp(1461653440980l));
        user.setIsDeleted(1);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setPasswordAlgo("R9A6jMyuDzrVLP7NrfWedfhTj1KvcW5iyWe6XPM4uCzPSqLXXn");
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1461653441009l));
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setChangePasswordNextLogin(1);
        user.setSessionTimeout(3071);
        user.setUserAccessCode(12494);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("6OrP3immXigVn1DfFFIVfsLN23BHmeF2zPp1s1bq18gblfRCKg");
        Question question = new Question();
        question.setQuestion("URluautPBrFXCqKcNxRme5YAgw5OPACKz3MK7ltRGGaRcmM2Kj");
        question.setQuestionDetails("KuXORzQiHy");
        question.setLevelid(3);
        question.setQuestionIcon("eoq92VnKQKnZM7Bccj11Xt0G6N48F9wVSonSEAuAmzZnxwLeRI");
        Question QuestionTest = new Question();
        if (isSave) {
            QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
        }
        passrecovery.setAnswer("k0QO8TlCJpTuvOEVQlOXSJHctTWEtxpGDbNiyaMZkAh1Qa5w7C");
        passrecovery.setUser(user);
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePassword("K8qry6mGcQyPNoS8bfCPrDFmWvDTxwSB");
        userdata.setLast5Passwords("qnYzaDqhn5dJHE9x7reG4taYiAI0HIbAFF6UdIrpDSIkuQ5K1r");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1461653441217l));
        userdata.setPassword("J3FNDXvIRISxjp8fkJMU9rGJgyPHZHBbsNm9vgBucy9n010xnT");
        userdata.setOneTimePasswordExpiry(10);
        userdata.setOneTimePassword("1elrIbsiZoxUBN6ZTyHRo70lylKzabmq");
        userdata.setLast5Passwords("BY338coHZLtDuPqjeqNEdzxP74Y9SBIudFhM8tmZvOMx2VGgWR");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1461653441231l));
        userdata.setPassword("ne37r2b17tq7yzSBnKaEgsq48Pdp5VxG2kWcPSsmxavllfIFxG");
        userdata.setOneTimePasswordExpiry(10);
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 76718));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "Nlfpd9I5YrkqViOo6kvs29Dyx1Qgkua8Juu1EUHzLFkbpQ0e5lmZBdNdA9fnYCMAX"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 5169));
