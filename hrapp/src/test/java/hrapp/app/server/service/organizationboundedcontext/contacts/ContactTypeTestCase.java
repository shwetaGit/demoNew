...
import hrapp.app.server.repository.organizationboundedcontext.contacts.ContactTypeRepository;
import hrapp.app.shared.organizationboundedcontext.contacts.ContactType;
...
public class ContactTypeTestCase extends EntityTestCriteria {
    ...
    private ContactType createContactType(Boolean isSave) throws Exception {
        ...
        contacttype.setContactTypeIcon("moIO8OpXmOm6nzIFF99BRpO11YuyPMmtrkXV8Kk7Sv22PF2NoK");
        contacttype.setContactTypeDesc("SQ9zKf4FGWGqcX0wsJnB2e8uuFDBnSdQMDTZlyMkqTbtnBw03E");
        contacttype.setContactType("btixng1NwTbVhk3YlBVearGP0hpX6te1sW1Sq2SGKFTRrdFMn8");
    ...
    public void test2Update() {
        try {
            ...
            contacttype.setContactTypeIcon("H7MF4DKOhJhrCOPMryJ9019TwuJS2eIemklg5aHCrZABTOOQlo");
            contacttype.setVersionId(1);
            contacttype.setContactTypeDesc("MAOdhXyWnM7SUFAsQEq6S7VvtRuAHe8cRYE04peAywUMBm1l1W");
            contacttype.setContactType("zDRGSz6RUHcrRqCovsr4SZrTXlqPADfq5HsWTIkOjI2HfNHeV6");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "contactType", "iGJgrRs55RJ2gCI5DpkP61lG2ZR5IjEfVYJl7DIKUIXCpRCgYk9ntz357VdlpFy95o24XNlaWlPzX2rYAyYkK7txVaeSALj6ambGysATrs9gD8u6Il66lmVgJp3aHhgUh"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "contactTypeDesc", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "contactTypeIcon", "15wqjnAb2Jhwwcs2owYdfpyRqSt2w9Rjpw4IWdvd4FSyFed7lt2QcOnCPJ6LeSh2ZWcrQJWUx36BeBJYakrqF4zt9g3bACsezkfOhHCWU748vHaXSHnu4wzEPzMxgHEdO"));
