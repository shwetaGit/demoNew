...
echo $PATH
OSNAME=`uname -s`
DB_PATH=/tmp/applifire/db/9911330EEB9FCBE3610C72D1DBD494FF/4MY6QBYMLWOBKNV9YPZQ
ART_CREATE_PATH=/tmp/applifire/db/9911330EEB9FCBE3610C72D1DBD494FF/4MY6QBYMLWOBKNV9YPZQ/art/create
AST_CREATE_PATH=/tmp/applifire/db/9911330EEB9FCBE3610C72D1DBD494FF/4MY6QBYMLWOBKNV9YPZQ/ast/create
MYSQL=/usr/bin
APPLFIREUSER=root
