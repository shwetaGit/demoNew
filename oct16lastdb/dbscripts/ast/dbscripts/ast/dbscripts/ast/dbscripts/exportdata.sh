...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/CE2B5E7FF127396753922B6D71A55B43/4MY6QBYMLWOBKNV9YPZQ/art/data
AST_DATA_PATH=/tmp/applifire/db/CE2B5E7FF127396753922B6D71A55B43/4MY6QBYMLWOBKNV9YPZQ/ast/data
DB_NAME=applifire
USER=root
PASSWORD=root
PORT=3306
HOST=localhost
MYSQL=/usr/bin
PROJECT_ID=4MY6QBYMLWOBKNV9YPZQ
