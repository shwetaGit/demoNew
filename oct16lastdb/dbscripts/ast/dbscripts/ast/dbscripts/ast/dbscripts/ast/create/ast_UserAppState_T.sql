...
CREATE TABLE `ast_UserAppState_T` ( `appStateId` VARCHAR(64) NOT NULL, `AppSessionId` VARCHAR(256) NOT NULL, `TabId` VARCHAR(11) NOT NULL, `isActive` INT(11) NOT NULL DEFAULT '0', `sessionDataType` VARCHAR(11) NULL DEFAULT NULL, `sessionData` VARCHAR(5120) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` DATE NULL DEFAULT '1900-01-01', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` DATE NULL DEFAULT '1900-01-01', `versionId` INT(11) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(11) NULL DEFAULT NULL, PRIMARY KEY (`appStateId`));
