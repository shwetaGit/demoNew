...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/170496B1FD81F3B1EFBDF3B5007460B5/4MY6QBYMLWOBKNV9YPZQ/art/data
AST_DATA_PATH=/tmp/applifire/db/170496B1FD81F3B1EFBDF3B5007460B5/4MY6QBYMLWOBKNV9YPZQ/ast/data
DB_NAME=applifire
USER=root
PASSWORD=root
PORT=3306
