...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/4F7450AE884C54EE12BFB5859C7E1A4D/4MY6QBYMLWOBKNV9YPZQ/art/data
AST_DATA_PATH=/tmp/applifire/db/4F7450AE884C54EE12BFB5859C7E1A4D/4MY6QBYMLWOBKNV9YPZQ/ast/data
DB_NAME=applifire
USER=root
PASSWORD=root
PORT=3306
