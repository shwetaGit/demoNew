...
echo $PATH
OSNAME=`uname -s`
DB_PATH=/tmp/applifire/db/4F7450AE884C54EE12BFB5859C7E1A4D/4MY6QBYMLWOBKNV9YPZQ
ART_CREATE_PATH=/tmp/applifire/db/4F7450AE884C54EE12BFB5859C7E1A4D/4MY6QBYMLWOBKNV9YPZQ/art/create
AST_CREATE_PATH=/tmp/applifire/db/4F7450AE884C54EE12BFB5859C7E1A4D/4MY6QBYMLWOBKNV9YPZQ/ast/create
MYSQL=/usr/bin
APPLFIREUSER=root
