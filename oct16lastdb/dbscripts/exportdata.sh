...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/9911330EEB9FCBE3610C72D1DBD494FF/4MY6QBYMLWOBKNV9YPZQ/art/data
AST_DATA_PATH=/tmp/applifire/db/9911330EEB9FCBE3610C72D1DBD494FF/4MY6QBYMLWOBKNV9YPZQ/ast/data
DB_NAME=applifire
USER=root
PASSWORD=root
PORT=3306
