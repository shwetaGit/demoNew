...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("qf7mXkl1U7A0qZhgFDahP4sSG2C8Jqrl");
            country.setCapitalLatitude(11);
            country.setCapitalLongitude(1);
            country.setCountryCode1("YFp");
            country.setCountryCode2("bF7");
            country.setCountryFlag("gjMasWMa7g7tTXQklaUOFYTqEnAj9r9WBoZ1LHILDaLR0nCeER");
            country.setCountryName("ABmm1LSvFr0Jn9pL1h1dz8gh2Sn5sNR8uYRKHm7wFwCudybJsj");
            country.setCurrencyCode("Xym");
            country.setCurrencyName("Cd2OwSGq7920GCd4z436WFM7LPJBtbgkRgMtegOudd4GEIvFmS");
            country.setCurrencySymbol("ckIbSuBgslBZ9UMeC78saSJ4RAF4UGKA");
            country.setIsoNumeric(4);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("evX8fshVKEfJ18cOVqEYKojCQn2VAIKCNzk9HIGT8L8raFJ7zV");
            currency.setUnicodeDecimal("NEwb5sozXXQHs8mtggIXrNygdKCkNx40JAWpjdM8FGYoHezHuN");
            currency.setUnicodeHex("UAuJHHIZl5zri1TQgNHvlQseVjYHfdET9UUnLoj4lD6ufOy14K");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("KpoXQM3Vd7EbEOJVvUxiipiluqg9DIixp8ys056XcUKPAoSK0V");
            currency.setUnicodeDecimal("hxgAbKSwGjx52VFuGFXcgDY1gMCmku8btZEZUX0L8kHhZIAYL4");
            currency.setUnicodeHex("v38g0XcYKahLT3gigjGVzfQqgRXzkJz9EEiRg3qVwoYW71LyQG");
