...
import testone.app.server.repository.QuestionRepository;
...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("md8WoOWJtQR1sYH0PUdYzpAkoQ5Svma1xxvbYsZeGUom6fplPc");
            question.setQuestionDetails("G");
            question.setQuestionIcon("bsDiCbZ4SzoLvhnFI1kAW3X5USLgerQtoeuaxR2ou4dIAmNkId");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("CuLNSwn0wgk3n5K7cg4gyZXl1tVw7U9Gr0i337kU053Utj8ssA");
            question.setQuestionDetails("J");
            question.setQuestionIcon("vp3wxMryjJ9CfRHjGOGKbcwIW7dhDByDolrhy5DUaTXJSkExtO");
