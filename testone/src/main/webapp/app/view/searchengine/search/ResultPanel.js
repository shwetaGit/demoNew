Ext
		.define(
				'Testone.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testone.view.searchengine.search.SearchEngineMainPanelController','Testone.view.searchengine.search.PanelHeaderField' ,'Testone.view.searchengine.search.ReportGridView','Testone.view.searchengine.search.ReportChartView','Testone.view.searchengine.search.documentView','Testone.view.searchengine.search.DouMeanView','Testone.view.googlemaps.map.MapPanel'],
