Ext.define('Testone.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Testone.view.reportui.datachart.chart.RatingField','Testone.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
