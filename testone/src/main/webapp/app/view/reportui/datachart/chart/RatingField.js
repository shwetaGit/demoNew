...
Ext.define('Testone.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Testone.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Testone.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
