...
Ext
		.define(
				'Testone.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testone.view.logger.tabs.details.DetailsTab',
							'Testone.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testone.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testone.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testone.view.logger.LogConfigurationTabPanelController',
