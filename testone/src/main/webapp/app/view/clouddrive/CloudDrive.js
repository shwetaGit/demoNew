Ext.define("Testone.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Testone.view.clouddrive.CloudDriveController',
	             'Testone.view.clouddrive.documentview.DocumentsView',
	             'Testone.view.clouddrive.drivedetails.DriveDetails',
	             //'Testone.view.clouddrive.documentview.DocumentListView'
	             ],
