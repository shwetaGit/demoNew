 ...
 * 
 */
Ext.define('Testone.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testone.view.securityconfig.SecurityConfigController',
			'Testone.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
