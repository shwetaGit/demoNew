 ...
 * 
 */
Ext.define('Testone.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Testone.view.logalarm.LogAlarmMainViewController',
			'Testone.view.logalarm.tree.LogAlarmTreePanel',
			'Testone.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
