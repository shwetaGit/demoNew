 ...
 * 
 */
Ext.define('Testone.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testone.view.logalarm.mainscreen.AddLogAlarmController',
			'Testone.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testone.view.logalarm.mainscreen.AppAlarmPanel',
