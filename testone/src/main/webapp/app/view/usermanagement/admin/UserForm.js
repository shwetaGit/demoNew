Ext.define('Testone.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testone.view.usermanagement.admin.AddUserDetailsViewModel', 'Testone.model.AddUserDataModel' ],
