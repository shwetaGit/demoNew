Ext.define('Testone.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Testone.view.usermanagement.enduser.UserProfileController', 'Testone.view.usermanagement.admin.AddUserDetailsViewModel', 'Testone.model.AddUserDataModel' ],
