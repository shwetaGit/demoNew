Ext.define('Testone.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Testone.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Testone.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Testone.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Testone.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
