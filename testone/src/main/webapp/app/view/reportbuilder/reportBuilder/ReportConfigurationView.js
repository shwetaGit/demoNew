Ext.define('Testone.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Testone.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Testone.view.reportbuilder.gridconfig.GridConfigView',
	           'Testone.view.reportbuilder.properties.PropertiesPanelView',
	           'Testone.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
