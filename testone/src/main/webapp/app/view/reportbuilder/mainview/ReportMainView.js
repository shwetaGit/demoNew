Ext.define('Testone.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Testone.view.reportbuilder.reportlist.ReportListPanelView',
             'Testone.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Testone.view.reportbuilder.mainview.ReportMainController'
             ],
