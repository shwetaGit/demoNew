Ext.define('Testone.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Testone.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Testone.view.console.ConsoleWindow');
