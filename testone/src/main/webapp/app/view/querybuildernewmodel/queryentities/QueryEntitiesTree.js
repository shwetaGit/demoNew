Ext.define('Testone.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testone.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
