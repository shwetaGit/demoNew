Ext.define('Testone.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testone.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
