Ext.define('Testone.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Testone.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Testone.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Testone.view.querybuildernewmodel.floatingentity.EntitySprite',
