Ext.define('Testone.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Testone.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Testone.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Testone.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Testone.view.querybuildernewmodel.querydetail.QueryDetail');
