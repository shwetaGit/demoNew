Ext.define('Testone.testone.web.testone.view.contacts.CoreContactsMain', {
     ...
     "requires": ["Testone.testone.shared.testone.model.contacts.CoreContactsModel", "Testone.testone.web.testone.controller.contacts.CoreContactsMainController", "Testone.testone.shared.testone.model.contacts.TitleModel", "Testone.testone.shared.testone.model.location.LanguageModel", "Testone.testone.shared.testone.model.contacts.GenderModel", "Testone.view.fw.component.Grids", "Testone.testone.shared.testone.model.contacts.CommunicationGroupModel", "Testone.testone.shared.testone.model.contacts.CommunicationTypeModel", "Testone.view.fw.component.Grids", "Testone.testone.shared.testone.model.location.AddressTypeModel", "Testone.testone.shared.testone.model.location.CountryModel", "Testone.testone.shared.testone.model.location.StateModel", "Testone.testone.shared.testone.model.location.CityModel", "Testone.testone.shared.testone.viewmodel.contacts.CoreContactsViewModel"],
     "communicationLog": [],
     "tabPosition": "bottom",
     "items": [{
          "title": "Data Browser",
                    ...
                    "items": [{
                         ...
                         "items": [{
                              ...
                              "items": [{
                                   ...
                                   "fieldId": "433AAE31-51C1-4D90-B08E-1191A15E16AA",
                                   "minLength": "0",
                                   "maxLength": "64",
                                   "hidden": true,
                                   "value": "",
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "DFFB7F1D-BC07-40C6-9A4E-81F9D8E5A9FA",
                                   ...
                                   "store": {
                                        "data": [],
                                        "model": "Testone.testone.shared.testone.model.contacts.TitleModel"
                                   },
                                   "bindable": "titleId",
                                   "columnWidth": 0.5,
                                   "bind": "{titleId}"
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "B1363B35-AD6E-492C-A5E8-80BC023B2C87",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "fieldId": "0EAEBEDF-5E02-4D65-96FD-174B6530AB5F",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   "bindable": "middleName",
                                   "columnWidth": 0.5,
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "371F30B0-67F5-43C3-B3F0-E7E46816336A",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "fieldId": "244851B6-CC81-4130-B273-56EA7B4BB734",
                                   ...
                                   "store": {
                                        "data": [],
                                        "model": "Testone.testone.shared.testone.model.location.LanguageModel"
                                   },
                                   ...
                                   "fieldId": "4606E953-ED5A-4214-B713-1C8C911E4981",
                                   "displayField": "primaryDisplay",
                                   "valueField": "primaryKey",
                                   "typeAhead": true,
                                   "queryMode": "local",
                                   ...
                                   "fieldId": "1710E693-6324-47CA-8B46-8BA2722ADA00",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "fieldId": "1E78E518-DBC9-48CE-8E75-36CA7BC6B50E",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "fieldId": "E86709F1-9536-4ACB-AFB6-FF8112450145",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "814908AC-33AF-4566-8694-EDC0E66C7539",
                                   "errorMessage": "Please enter gender",
                                   "restURL": "Gender",
                                   "displayField": "primaryDisplay",
                                   "valueField": "primaryKey",
                                   ...
                                   "store": {
                                        "data": [],
                                        "model": "Testone.testone.shared.testone.model.contacts.GenderModel"
                                   },
                                   "bindable": "genderId",
                                   "columnWidth": 0.5,
                                   "bind": "{genderId}"
                                   ...
                                   "margin": "5 5 5 5",
                                   "fieldLabel": "DOB",
                                   "fieldId": "A6281798-498A-442B-A178-27A84B30BEDB",
                                   ...
                                   "margin": "5 5 5 5",
                                   "fieldLabel": "Age",
                                   "fieldId": "609AB70E-7853-4C52-A8DF-F5B49E4DC7D2",
                                   "minValue": "0",
                                   "maxValue": "125",
                                   "bindable": "age",
                                   "columnWidth": 0.5,
                                   ...
                                   "fieldId": "56A61A5F-7BE9-438C-9FD1-C4A5DCEEDFD7",
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "D68EEA87-F2CB-4C9F-9B5B-2B1E2AD2DEB0",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "4710607A-05C2-4EF8-BC65-90C9E03A99B1",
                                   "minLength": "0",
                                   "maxLength": "20",
                                   ...
                                   "fieldId": "B58B7DC1-AA7E-4E59-B1C3-F411A446ED89",
                                   "bindable": "versionId",
                                   "bind": "{versionId}",
                                   "hidden": true
                              }]
                         ...
                         "items": [{
                              ...
                              "items": [{
                                   ...
                                   "items": [{
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "39EA5A98-C403-4133-B82D-48AF202A8299",
                                        ...
                                        "store": {
                                             "data": [],
                                             "model": "Testone.testone.shared.testone.model.contacts.CommunicationGroupModel"
                                        },
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "5A88F493-AB16-4378-9D42-69562B811773",
                                        ...
                                        "store": {
                                             "data": [],
                                             "model": "Testone.testone.shared.testone.model.contacts.CommunicationTypeModel"
                                        },
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "3A5ED642-62A3-435C-BE03-97E45312A8DE",
                                        "minLength": "0",
                         ...
                         "items": [{
                              ...
                              "items": [{
                                   ...
                                   "items": [{
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "5D8BBDE8-8A09-4547-AC6E-F97CB69E3F2F",
                                        ...
                                        "store": {
                                             "data": [],
                                             "model": "Testone.testone.shared.testone.model.location.AddressTypeModel"
                                        },
                                        ...
                                        "fieldId": "F15C5940-A52D-4658-8ED1-E4AE86F90FF0",
                                        "minLength": "0",
                                        "maxLength": "11",
                                        ...
                                        "margin": "5 5 5 5",
                                        "fieldLabel": "Address1",
                                        "fieldId": "15036130-C822-4257-99AF-A7557DF3892F",
                                        ...
                                        "margin": "5 5 5 5",
                                        "fieldLabel": "Address2",
                                        "fieldId": "F61A8ACB-4207-4C3D-BEBB-517827A224F4",
                                        ...
                                        "margin": "5 5 5 5",
                                        "fieldLabel": "Address3",
                                        "fieldId": "AFC9AA3E-F82B-4BF8-92ED-840FEC1B1715",
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "2329E76D-F004-40A9-8DBB-C9370F91E75C",
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "80273139-5FC9-400D-897F-FD24FABD53F2",
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "74CC140F-09AE-4D37-B4D8-5F1BCDEDDEE2",
                                        ...
                                        "store": {
                                             "data": [],
                                             "model": "Testone.testone.shared.testone.model.location.CityModel"
                                        },
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "531CAD8A-B979-4F0E-BE90-935A15A5F496",
                                        "minLength": "0",
                                        "maxLength": "6",
                                        ...
                                        "margin": "5 5 5 5",
                                        "fieldLabel": "Latitude",
                                        "fieldId": "03E13E35-7C14-45A2-8DB6-8B4B05B938E1",
                                        "minLength": "0",
                                        "maxLength": "64",
                                        ...
                                        "fieldId": "AC59C119-C99F-4AD1-A186-782D5AD53210",
                                        "minLength": "0",
                                        "maxLength": "64",
