package testone.app.shared.customers;
...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "AppCustomerCategory", complexity = Complexity.LOW)
...
public class AppCustomerCategory implements Serializable, CommonEntityInterface, Comparator<AppCustomerCategory> {
    ...
    public boolean equals(Object obj) {
        try {
            testone.app.shared.customers.AppCustomerCategory other = (testone.app.shared.customers.AppCustomerCategory) obj;
            if (appcustCategoryId == null) {
                return false;
