package testone.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* testone.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* testone.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* testone.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* testone.app.server.service..*..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* testone.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* testone.app.server.service..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
