...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "Repository for AppCustomerType Master table Entity", complexity = Complexity.LOW)
public class AppCustomerTypeRepositoryImpl extends SearchInterfaceImpl implements AppCustomerTypeRepository<AppCustomerType> {
    ...
    public List<AppCustomerType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<testone.app.shared.customers.AppCustomerType> query = emanager.createQuery("select u from AppCustomerType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AppCustomerType> save(List<AppCustomerType> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                testone.app.shared.customers.AppCustomerType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            testone.app.shared.customers.AppCustomerType s = emanager.find(testone.app.shared.customers.AppCustomerType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public AppCustomerType findById(String appcustTypeId) throws Exception, SpartanPersistenceException {
        try {
            ...
            testone.app.shared.customers.AppCustomerType listOfAppCustomerType = (testone.app.shared.customers.AppCustomerType) query.getSingleResult();
