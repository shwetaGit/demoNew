package testone.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* testone.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* testone.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* testone.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* testone.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* testone.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* testone.app.server.repository..*(..))")
