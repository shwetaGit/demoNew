package hrpro.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* hrpro.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* hrpro.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* hrpro.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* hrpro.app.server.service..*..*(..)) && !within(hrpro.app.server.service.sessionmgt.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* hrpro.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* hrpro.app.server.service..get*(..))")
