package hrpro.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* hrpro.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* hrpro.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* hrpro.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* hrpro.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* hrpro.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* hrpro.app.server.repository..*(..))")
