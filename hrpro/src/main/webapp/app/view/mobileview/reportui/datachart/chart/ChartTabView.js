Ext.define('Buzzor.view.mobileview.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Buzzor.view.mobileview.reportui.datachart.chart.RatingField','Buzzor.view.mobileview.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
