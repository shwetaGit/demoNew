Ext.define('Buzzor.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Buzzor.view.usermanagement.admin.UserPasswordReset',
	            'Buzzor.view.usermanagement.admin.AddUserDetails',
	            'Buzzor.view.usermanagement.admin.ViewUser'],
