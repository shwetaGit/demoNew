Ext.define('Buzzor.view.login.LoginPage', {
	extend : 'Ext.panel.Panel',
	xtype : 'login',

	controller : 'login',
	requires : [ 'Buzzor.view.login.LoginPageController',
	             // 'Buzzor.view.login.LoginModel',
	             'Ext.form.Panel', 'Ext.button.Button', 'Ext.form.field.Text', 'Buzzor.view.main.MainPanel' ],
