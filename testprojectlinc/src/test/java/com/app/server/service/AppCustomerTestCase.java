...
public class AppCustomerTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomercategory.setCustomerCategory("1NW9lYgzBvM96gxW0J3gllM0nqK5ZipRwXBhSr2IuiXq5wX3ef");
            ...
            appcustomertype.setCustomerType("MJdxRp0sBgVYs7njcxPUtDT8HIDyA6sSq1RCcv01pPxuGHRKTr");
            ...
            corecontacts.setEmailId("eNnoVQGOfawBNu7GW306xl69QRLx0rgHNDQgRM7aQVJMEWg3Ug");
            corecontacts.setFirstName("Z9fi5xTleVneiakjjp5xWfKSsAnqT3D0yW4m2qsJOGgDFG1Bjc");
            Gender gender = new Gender();
            gender.setGender("jRQZ7yir2oTCbTKCSHctjS4RugSfffibUaWqZGZc1t9dh2kBFl");
            Gender GenderTest = genderRepository.save(gender);
            map.put("GenderPrimaryKey", gender._getPrimarykey());
            Language language = new Language();
            language.setAlpha2("T2");
            language.setAlpha3("5Z3");
            language.setAlpha4("COw9");
            language.setAlpha4parentid(5);
            language.setLanguage("7DvjKnSX0CzC68Tnc36CIDjb3obIvUbFuVQ4vt8mmiMLnj3MZM");
            language.setLanguageDescription("fmemgADrRT51c2an8rDcjDj0qaRv95t1PKCB6i7x7VD7WR96ZW");
            language.setLanguageIcon("5469Yhd5rQotWJMoWWg32KH0n7E4VK9hCsYFVuhMeD1VyRWWQ7");
            language.setLanguageType("lyBlTQBz34xr6reMFybKIUNyU5rfb7d1");
            Language LanguageTest = languageRepository.save(language);
            map.put("LanguagePrimaryKey", language._getPrimarykey());
            Timezone timezone = new Timezone();
            timezone.setCities("QoQazZfFjuDsZGjWTAdoPzk6h34YpYjFyTASR2QDfTYTpt728k");
            timezone.setCountry("YI6ohJ6MzK7H7mMk02y0RQnzSSbS7IZYe9GOhXqcqsoXtuga95");
            timezone.setGmtLabel("jKTo0enQVHUvfnDPKXgkAOncs5EDbjnjKqYnjhrawge8LWrM45");
            timezone.setTimeZoneLabel("rv3fKkULLtEbKi3Tz6i6dQ0LetNTOCoohLysTV2Mz8gBn7vRZu");
            timezone.setUtcdifference(5);
            Title title = new Title();
            title.setTitles("IGJaB7ODvV3Ut4OAdYNkjZ6A53KGmNLWaflKMejN5qA9rUFyhA");
            Title TitleTest = titleRepository.save(title);
            map.put("TitlePrimaryKey", title._getPrimarykey());
            corecontacts.setAge(110);
            corecontacts.setApproximateDOB(new java.sql.Date(123456789));
            corecontacts.setDateofbirth(new java.sql.Date(123456789));
            corecontacts.setEmailId("57KQOXPKkaNeAMT0V2gxQgwnRYkUI6M2EaxaAn320dA7YgRTkG");
            corecontacts.setFirstName("tmcaFOrd4PCBgL7dhU4Vtb5LbF13cTfNpGyQ7m0HlbVTuZHzaI");
            corecontacts.setGenderId((java.lang.String) GenderTest._getPrimarykey()); /* ******Adding refrenced table data */
            corecontacts.setLastName("DYpz036bOl2mRniBPlG1638zBiZFJciBuhCYLfX7ZO2P7kV3ik");
            corecontacts.setMiddleName("SCFhTrMW5iRBqQUFgPvXOs5NndCQvYAEvYIQE8vQXdwVdQPRrv");
            corecontacts.setNativeFirstName("Q71fXnpPcVvHq2F8ZvVr93omJ7H623aAkiqcjxWOz4WfH1BIST");
            corecontacts.setNativeLanguageCode((java.lang.String) LanguageTest._getPrimarykey()); /* ******Adding refrenced table data */
            corecontacts.setNativeLastName("1N4mwNoSkgK4aw7XcCuwx0S3uTSEHhNWLXgKwTMNncZ4za9TeV");
            corecontacts.setNativeMiddleName("9NSAX0sajtplgHxbjTJelOLWBvAa69EYJi7WMAMfpH3d5Lgpeg");
            corecontacts.setNativeTitle("1kqB4bmDtkDj77isYE68d8eYZhCiSmyKc7lwQmqLUCMbHX0Z5j");
            corecontacts.setPhoneNumber("NYlYtRWmjtni9UZnIJVr");
            ...
            appcustomer.setCustomerName("UZravvI5Yx8XsSwonLHVq50nzvctZkXJAW8cA3AEaRxtjwt23Q");
    ...
    public void test2Update() {
        try {
            ...
            appcustomer.setCustomerName("s6N9CT2cmfFhi5eSUznpFHXxXPbgqWd3lwtUFplh47EYm3wJrL");
