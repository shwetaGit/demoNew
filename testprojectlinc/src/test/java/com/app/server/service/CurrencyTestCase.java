...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("ZjRNCuGkFO6OEbiM6omm3uWbVylgYLSA");
            country.setCapitalLatitude(10);
            country.setCapitalLongitude(8);
            country.setCountryCode1("sfQ");
            country.setCountryCode2("MG9");
            country.setCountryFlag("Vshu7c5XCn2extYNLDN4swW3txh91utYUoKjMRKs701QN7EQkW");
            country.setCountryName("trkNYTm8Nce5B1zeBPk1JmMAkQJJFWbR0ugQBkyPHDlCQWGrrJ");
            country.setCurrencyCode("Xdn");
            country.setCurrencyName("hQCqdyoXsqdsqLIXUA3h4OD8suRBmsVELtaAriZ2xEGgXykB36");
            country.setCurrencySymbol("dKtrfTFlBQSE2fyr9KopN0KGdhFVVTOo");
            country.setIsoNumeric(7);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("7BJGOp04MMrT83eioX8stScquwMkExbkyFXUv5RNEsAMIJ7Epc");
            currency.setUnicodeDecimal("ekiu4l3EH63zTDXVrWatyOSHqgRWL0Sg58LoRUNhFNah3ZAbOA");
            currency.setUnicodeHex("2TsrBGpSeq2q7gAlATvAQenfs6CY18Vt4ukshce6diYtYTSz54");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("x5foaUAatXZHcPNcW2FXiX82jZmGL7hPqvKCaKEPz4N7tpm9yq");
            currency.setUnicodeDecimal("AmnAuwOA69OQeL9g1DbBHjNx5d7MIfxO26j1yCfLy3hMZq2biD");
            currency.setUnicodeHex("dHDUYxStBssEF2VsFb6uoKK5BnZRNAJfvGszzqNED8l8tGwxox");
