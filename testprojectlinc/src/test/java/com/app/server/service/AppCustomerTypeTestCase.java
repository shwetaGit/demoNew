...
public class AppCustomerTypeTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomertype.setCustomerType("iMkedjLvlMwP8Rzu4uFgpeTRSiUtDI9wqGluJYO602p85cNa6f");
    ...
    public void test2Update() {
        try {
            ...
            appcustomertype.setCustomerType("CNc7xe1FdF5uP9bOUMmgu5tBUuqNDrKASMvDYot9ndV3DjSFYp");
            appcustomertype.setDefaults(0);
            appcustomertype.setSequenceId(2147483647);
