 ...
 * 
 */
Ext.define('Testprojectlinc.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testprojectlinc.view.logalarm.mainscreen.AddLogAlarmController',
			'Testprojectlinc.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testprojectlinc.view.logalarm.mainscreen.AppAlarmPanel',
