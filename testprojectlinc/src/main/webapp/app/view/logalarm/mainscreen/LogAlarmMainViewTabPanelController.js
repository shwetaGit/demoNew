 ...
 * 
 */
Ext.define('Testprojectlinc.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	{
		debugger;
		var component = Ext.create("Testprojectlinc.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
