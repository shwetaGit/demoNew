Ext.define('Testprojectlinc.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Testprojectlinc.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Testprojectlinc.view.console.ConsoleWindow');
