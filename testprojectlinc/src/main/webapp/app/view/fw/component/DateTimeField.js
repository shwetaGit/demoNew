 ...
 */
Ext.define('Testprojectlinc.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Testprojectlinc.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Testprojectlinc.view.fw.component.DateTimePicker(o);
    },
