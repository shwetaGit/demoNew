Ext.define('Testprojectlinc.view.fw.mainViewPanel.MainPanelController', {
	extend : 'Ext.app.ViewController',
	requires : ['Ext.util.Cookies',
	            'Testprojectlinc.view.login.ChangePasswordScreen'],
	...
	afterRender:function()
	{
		...
		if(cookieChangePwd=="true"){
			 var component = Ext.create("Testprojectlinc.view.login.ChangePasswordScreen",
							{
								modal:true,
							});
			 component.show();
