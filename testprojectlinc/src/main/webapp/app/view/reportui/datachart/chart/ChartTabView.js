Ext.define('Testprojectlinc.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Testprojectlinc.view.reportui.datachart.chart.RatingField','Testprojectlinc.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
