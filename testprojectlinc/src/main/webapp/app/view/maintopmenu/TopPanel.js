 ...
 */
Ext.define('Testprojectlinc.view.maintopmenu.TopPanel', {
	extend : 'Ext.toolbar.Toolbar',
	xtype : 'topToolbar',
	
	requires : [ 'Testprojectlinc.view.maintopmenu.TopPanelController',
	             'Testprojectlinc.view.maintopmenu.MenuPanel' ],
