Ext.define('Testprojectlinc.view.reportbuilder.reportlist.ReportListPanelView', {
	extend : 'Ext.panel.Panel',
	requires:['Testprojectlinc.view.reportbuilder.reportlist.ReportListPanelController'],
