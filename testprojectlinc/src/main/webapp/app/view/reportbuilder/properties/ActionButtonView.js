Ext.define('Testprojectlinc.view.reportbuilder.properties.ActionButtonView', {
	extend : 'Ext.grid.Panel',
	requires:['Testprojectlinc.view.reportbuilder.properties.ActionButtonController'],
