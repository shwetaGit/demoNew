Ext.define('Testprojectlinc.view.reportbuilder.properties.RptChartPropGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Testprojectlinc.view.reportbuilder.properties.RptChartPropGridController'],
