Ext.define('Testprojectlinc.view.reportbuilder.properties.RptDrillDownGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Testprojectlinc.view.reportbuilder.properties.RptDrillDownGridController'],
