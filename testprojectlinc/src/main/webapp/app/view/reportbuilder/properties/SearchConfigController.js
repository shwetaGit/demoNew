Ext.define('Testprojectlinc.view.reportbuilder.properties.SearchConfigController', {
	extend : 'Ext.panel.Panel',
	requires:['Testprojectlinc.view.reportbuilder.properties.SearchConfigView'],
