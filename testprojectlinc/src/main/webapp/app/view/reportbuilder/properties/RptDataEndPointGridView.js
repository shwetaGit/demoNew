Ext.define('Testprojectlinc.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Testprojectlinc.view.reportbuilder.properties.RptDataEndPointGridController'],
