Ext.define('Testprojectlinc.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Testprojectlinc.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Testprojectlinc.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Testprojectlinc.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Testprojectlinc.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
