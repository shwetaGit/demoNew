 ...
 * 
 */
Ext.define('Testprojectlinc.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testprojectlinc.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
