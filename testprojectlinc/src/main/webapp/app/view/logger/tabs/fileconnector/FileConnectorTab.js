 ...
 * 
 */
Ext.define('Testprojectlinc.view.logger.tabs.fileconnector.FileConnectorTab', {
	...
	requires : ['Testprojectlinc.view.logger.tabs.fileconnector.FileConnectorTabController'],
