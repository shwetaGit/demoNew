...
Ext
		.define(
				'Testprojectlinc.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testprojectlinc.view.logger.tabs.details.DetailsTab',
							'Testprojectlinc.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testprojectlinc.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testprojectlinc.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testprojectlinc.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testprojectlinc.view.logger.LogConfigurationTabPanelController',
