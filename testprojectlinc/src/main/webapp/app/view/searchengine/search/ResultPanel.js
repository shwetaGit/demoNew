Ext
		.define(
				'Testprojectlinc.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testprojectlinc.view.searchengine.search.SearchEngineMainPanelController','Testprojectlinc.view.searchengine.search.PanelHeaderField' ,'Testprojectlinc.view.searchengine.search.ReportGridView','Testprojectlinc.view.searchengine.search.ReportChartView','Testprojectlinc.view.searchengine.search.documentView','Testprojectlinc.view.searchengine.search.DouMeanView','Testprojectlinc.view.googlemaps.map.MapPanel'],
