Ext.define('Testprojectlinc.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testprojectlinc.view.searchengine.search.NorthPanel', 'Testprojectlinc.view.searchengine.search.SearchResult','Testprojectlinc.view.searchengine.search.SearchEngineMainPanelController'],
