Ext
		.define(
				'Testprojectlinc.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Testprojectlinc.view.searchengine.search.documentController',
							'Testprojectlinc.view.searchengine.search.RowExpander' ],
