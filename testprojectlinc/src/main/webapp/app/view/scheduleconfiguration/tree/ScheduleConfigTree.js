 ...
 * 
 */
Ext.define("Testprojectlinc.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Testprojectlinc.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
