 ...
 * 
 */
Ext.define('Testprojectlinc.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testprojectlinc.view.securityconfig.SecurityConfigController',
			'Testprojectlinc.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
