Ext.define('Testprojectlinc.view.chartbuilder.chartjsonsource.ChartJsonSourceView', {
	
	extend : 'Ext.panel.Panel',
	requires : [ 'Ext.layout.container.Column',
	             'Testprojectlinc.view.chartbuilder.chartjsonsource.ChartJsonSourceController'
	           ],
	xtype : 'source-view',
	itemId:'sourceView',
