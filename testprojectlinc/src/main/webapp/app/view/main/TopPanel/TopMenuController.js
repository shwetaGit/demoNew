...
Ext.define('Testprojectlinc.view.main.TopPanel.TopMenuController', {
 					...
 					for(var  int = 0 ; int < menuChildLength ; int++)
 		    		{
 						...
 						menuData.push(
 						{
 							...
 							renderCentralPanel:function(currentObject,menu)
 							{
 								...
 								{
 	 									debugger;
 	 									var component = Ext.create('Testprojectlinc.view.art.masterform.MasterPanel',{closable : true,title: menu.text, artMasterFormId:menu.config.data.refId});
