Ext.define('Testprojectlinc.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Testprojectlinc.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Testprojectlinc.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Testprojectlinc.view.querybuildernewmodel.floatingentity.EntitySprite',
