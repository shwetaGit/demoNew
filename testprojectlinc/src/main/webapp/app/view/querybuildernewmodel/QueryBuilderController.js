Ext.define('Testprojectlinc.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Testprojectlinc.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Testprojectlinc.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Testprojectlinc.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Testprojectlinc.view.querybuildernewmodel.querydetail.QueryDetail');
