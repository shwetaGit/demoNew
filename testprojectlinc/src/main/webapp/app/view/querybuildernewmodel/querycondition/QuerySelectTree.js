Ext.define('Testprojectlinc.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testprojectlinc.view.querybuildernewmodel.querycondition.QuerySelectController',
