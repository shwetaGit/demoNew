package project2.app.server.service.defaultcontext.defaultdomain.aspect;
...
public class ServicedefaultdomainAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* project2.app.server.service.defaultcontext.defaultdomain..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.defaultcontext.defaultdomain..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.defaultcontext.defaultdomain..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.defaultcontext.defaultdomain..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.defaultcontext.defaultdomain..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.defaultcontext.defaultdomain..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
