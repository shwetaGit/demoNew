package project2.app.server.service.organizationboundedcontext.location.aspect;
...
public class ServicelocationAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* project2.app.server.service.organizationboundedcontext.location..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.organizationboundedcontext.location..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.organizationboundedcontext.location..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.organizationboundedcontext.location..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.organizationboundedcontext.location..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.organizationboundedcontext.location..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
