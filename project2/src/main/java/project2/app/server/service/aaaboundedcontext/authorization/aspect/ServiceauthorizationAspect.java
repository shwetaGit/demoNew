package project2.app.server.service.aaaboundedcontext.authorization.aspect;
...
public class ServiceauthorizationAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* project2.app.server.service.aaaboundedcontext.authorization..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.aaaboundedcontext.authorization..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.aaaboundedcontext.authorization..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.aaaboundedcontext.authorization..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.aaaboundedcontext.authorization..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.aaaboundedcontext.authorization..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
