package project2.app.server.service.aaaboundedcontext.authentication.aspect;
...
public class ServiceauthenticationAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* project2.app.server.service.aaaboundedcontext.authentication..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.aaaboundedcontext.authentication..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.aaaboundedcontext.authentication..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.aaaboundedcontext.authentication..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.aaaboundedcontext.authentication..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* project2.app.server.service.aaaboundedcontext.authentication..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
