package project2.app.server.businessservice.aaaboundedcontext.authentication.aspect;
...
public class BusinessServiceauthenticationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* project2.app.server.businessservice.aaaboundedcontext.authentication..*(..))")
