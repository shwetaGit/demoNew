package project2.app.server.businessservice.organizationboundedcontext.contacts.aspect;
...
public class BusinessServicecontactsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* project2.app.server.businessservice.organizationboundedcontext.contacts..*(..))")
