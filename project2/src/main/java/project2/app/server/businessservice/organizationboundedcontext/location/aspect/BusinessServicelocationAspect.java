package project2.app.server.businessservice.organizationboundedcontext.location.aspect;
import project2.app.server.businessservice.aspect.BusinessAspect;
...
public class BusinessServicelocationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* project2.app.server.businessservice.organizationboundedcontext.location..*(..))")
