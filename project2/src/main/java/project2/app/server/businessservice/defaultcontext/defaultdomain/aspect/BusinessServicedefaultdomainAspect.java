package project2.app.server.businessservice.defaultcontext.defaultdomain.aspect;
...
public class BusinessServicedefaultdomainAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* project2.app.server.businessservice.defaultcontext.defaultdomain..*(..))")
