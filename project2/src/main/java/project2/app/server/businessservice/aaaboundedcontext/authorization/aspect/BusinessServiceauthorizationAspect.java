package project2.app.server.businessservice.aaaboundedcontext.authorization.aspect;
...
public class BusinessServiceauthorizationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* project2.app.server.businessservice.aaaboundedcontext.authorization..*(..))")
