...
import project2.app.shared.aaaboundedcontext.authentication.PasswordPolicy;
...
public class PasswordPolicyRepositoryImpl extends SearchInterfaceImpl implements PasswordPolicyRepository<PasswordPolicy> {
    ...
    public List<PasswordPolicy> save(List<PasswordPolicy> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                project2.app.shared.aaaboundedcontext.authentication.PasswordPolicy obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            project2.app.shared.aaaboundedcontext.authentication.PasswordPolicy s = emanager.find(project2.app.shared.aaaboundedcontext.authentication.PasswordPolicy.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public PasswordPolicy findById(String policyId) throws Exception, SpartanPersistenceException {
        try {
            ...
            project2.app.shared.aaaboundedcontext.authentication.PasswordPolicy listOfPasswordPolicy = (project2.app.shared.aaaboundedcontext.authentication.PasswordPolicy) query.getSingleResult();
