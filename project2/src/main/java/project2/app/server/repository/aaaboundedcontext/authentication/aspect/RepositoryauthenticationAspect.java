package project2.app.server.repository.aaaboundedcontext.authentication.aspect;
...
public class RepositoryauthenticationAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* project2.app.server.repository.aaaboundedcontext.authentication..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.aaaboundedcontext.authentication..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.aaaboundedcontext.authentication..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.aaaboundedcontext.authentication..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.aaaboundedcontext.authentication..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.aaaboundedcontext.authentication..*(..))")
