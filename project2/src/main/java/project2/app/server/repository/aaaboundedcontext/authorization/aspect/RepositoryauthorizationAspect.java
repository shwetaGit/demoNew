package project2.app.server.repository.aaaboundedcontext.authorization.aspect;
...
public class RepositoryauthorizationAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* project2.app.server.repository.aaaboundedcontext.authorization..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.aaaboundedcontext.authorization..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.aaaboundedcontext.authorization..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.aaaboundedcontext.authorization..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.aaaboundedcontext.authorization..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.aaaboundedcontext.authorization..*(..))")
