...
public class UserAccessDomainRepositoryImpl extends SearchInterfaceImpl implements UserAccessDomainRepository<UserAccessDomain> {
    ...
    public List<UserAccessDomain> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<project2.app.shared.aaaboundedcontext.authentication.UserAccessDomain> query = emanager.createQuery("select u from UserAccessDomain u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<UserAccessDomain> save(List<UserAccessDomain> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                project2.app.shared.aaaboundedcontext.authentication.UserAccessDomain obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            project2.app.shared.aaaboundedcontext.authentication.UserAccessDomain s = emanager.find(project2.app.shared.aaaboundedcontext.authentication.UserAccessDomain.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public UserAccessDomain findById(String userAccessDomainId) throws Exception, SpartanPersistenceException {
        try {
            ...
            project2.app.shared.aaaboundedcontext.authentication.UserAccessDomain listOfUserAccessDomain = (project2.app.shared.aaaboundedcontext.authentication.UserAccessDomain) query.getSingleResult();
