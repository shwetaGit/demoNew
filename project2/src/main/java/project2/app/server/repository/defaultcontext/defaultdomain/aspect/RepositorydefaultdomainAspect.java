package project2.app.server.repository.defaultcontext.defaultdomain.aspect;
...
public class RepositorydefaultdomainAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* project2.app.server.repository.defaultcontext.defaultdomain..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.defaultcontext.defaultdomain..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.defaultcontext.defaultdomain..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.defaultcontext.defaultdomain..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.defaultcontext.defaultdomain..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.defaultcontext.defaultdomain..*(..))")
