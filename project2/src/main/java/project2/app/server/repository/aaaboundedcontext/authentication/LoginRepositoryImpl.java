...
public class LoginRepositoryImpl extends SearchInterfaceImpl implements LoginRepository<Login> {
    ...
    public List<Login> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<project2.app.shared.aaaboundedcontext.authentication.Login> query = emanager.createQuery("select u from Login u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Login> save(List<Login> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                project2.app.shared.aaaboundedcontext.authentication.Login obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            project2.app.shared.aaaboundedcontext.authentication.Login s = emanager.find(project2.app.shared.aaaboundedcontext.authentication.Login.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<Login> findByUserId(String userId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<project2.app.shared.aaaboundedcontext.authentication.Login> listOfLogin = query.getResultList();
            return listOfLogin;
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Login findById(String loginPk) throws Exception, SpartanPersistenceException {
        try {
            ...
            project2.app.shared.aaaboundedcontext.authentication.Login listOfLogin = (project2.app.shared.aaaboundedcontext.authentication.Login) query.getSingleResult();
            return listOfLogin;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
