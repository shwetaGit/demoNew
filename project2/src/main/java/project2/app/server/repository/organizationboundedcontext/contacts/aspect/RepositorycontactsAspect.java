package project2.app.server.repository.organizationboundedcontext.contacts.aspect;
import project2.app.server.repository.aspect.RepositoryAspect;
...
public class RepositorycontactsAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* project2.app.server.repository.organizationboundedcontext.contacts..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.organizationboundedcontext.contacts..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.organizationboundedcontext.contacts..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.organizationboundedcontext.contacts..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.organizationboundedcontext.contacts..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* project2.app.server.repository.organizationboundedcontext.contacts..*(..))")
