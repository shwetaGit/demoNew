...
public class AppMenusRepositoryImpl extends SearchInterfaceImpl implements AppMenusRepository<AppMenus> {
    ...
    public List<AppMenus> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<project2.app.shared.aaaboundedcontext.authorization.AppMenus> query = emanager.createQuery("select u from AppMenus u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AppMenus> save(List<AppMenus> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                project2.app.shared.aaaboundedcontext.authorization.AppMenus obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            project2.app.shared.aaaboundedcontext.authorization.AppMenus s = emanager.find(project2.app.shared.aaaboundedcontext.authorization.AppMenus.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public AppMenus findById(String menuId) throws Exception, SpartanPersistenceException {
        try {
            ...
            project2.app.shared.aaaboundedcontext.authorization.AppMenus listOfAppMenus = (project2.app.shared.aaaboundedcontext.authorization.AppMenus) query.getSingleResult();
