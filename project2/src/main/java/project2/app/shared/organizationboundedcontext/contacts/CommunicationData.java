...
public class CommunicationData implements Serializable, CommonEntityInterface, Comparator<CommunicationData> {
    ...
    public boolean equals(Object obj) {
        try {
            project2.app.shared.organizationboundedcontext.contacts.CommunicationData other = (project2.app.shared.organizationboundedcontext.contacts.CommunicationData) obj;
            if (commDataId == null) {
                return false;
