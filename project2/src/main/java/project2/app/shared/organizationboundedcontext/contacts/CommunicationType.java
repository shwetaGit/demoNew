...
public class CommunicationType implements Serializable, CommonEntityInterface, Comparator<CommunicationType> {
    ...
    public boolean equals(Object obj) {
        try {
            project2.app.shared.organizationboundedcontext.contacts.CommunicationType other = (project2.app.shared.organizationboundedcontext.contacts.CommunicationType) obj;
            if (commType == null) {
                return false;
