...
public class CommunicationGroup implements Serializable, CommonEntityInterface, Comparator<CommunicationGroup> {
    ...
    public boolean equals(Object obj) {
        try {
            project2.app.shared.organizationboundedcontext.contacts.CommunicationGroup other = (project2.app.shared.organizationboundedcontext.contacts.CommunicationGroup) obj;
            if (commGroupId == null) {
                return false;
