package project2.app.shared.aaaboundedcontext.authentication;
...
public class User implements Serializable, CommonEntityInterface, UserInterface, Comparator<User> {
    ...
    public User addPassRecovery(PassRecovery _passRecovery) {
        if (this.passRecovery == null) {
            this.passRecovery = new java.util.ArrayList<project2.app.shared.aaaboundedcontext.authentication.PassRecovery>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            project2.app.shared.aaaboundedcontext.authentication.User other = (project2.app.shared.aaaboundedcontext.authentication.User) obj;
            if (userId == null) {
                return false;
