 ...
 * 
 */
Ext.define('Project2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Project2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
