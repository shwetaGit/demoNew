...
Ext
		.define(
				'Project2.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Project2.view.logger.tabs.details.DetailsTab',
							'Project2.view.logger.tabs.fileconnector.FileConnectorTab',
							'Project2.view.logger.tabs.dbconnector.DBConnectorTab',
							'Project2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Project2.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Project2.view.logger.LogConfigurationTabPanelController',
