 ...
 * 
 */
Ext.define('Project2.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Project2.view.securityconfig.SecurityConfigController',
			'Project2.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
