Ext.define('Project2.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Project2.view.usermanagement.admin.UserPasswordReset',
	            'Project2.view.usermanagement.admin.AddUserDetails',
	            'Project2.view.usermanagement.admin.ViewUser'],
