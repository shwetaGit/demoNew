Ext.define('Project2.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Project2.view.searchengine.search.NorthPanel', 'Project2.view.searchengine.search.SearchResult','Project2.view.searchengine.search.SearchEngineMainPanelController'],
