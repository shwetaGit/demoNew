Ext
		.define(
				'Project2.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Project2.view.searchengine.search.SearchEngineMainPanelController','Project2.view.searchengine.search.PanelHeaderField' ,'Project2.view.searchengine.search.ReportGridView','Project2.view.searchengine.search.ReportChartView','Project2.view.searchengine.search.documentView','Project2.view.searchengine.search.DouMeanView','Project2.view.googlemaps.map.MapPanel'],
