...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for Allownull Master table Entity", complexity = Complexity.LOW)
public interface AllownullRepository<T> extends SearchInterface {
    ...
    public T findById(String pk1) throws Exception, SpartanPersistenceException;
}
