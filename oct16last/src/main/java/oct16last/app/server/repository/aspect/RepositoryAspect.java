package oct16last.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* oct16last.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* oct16last.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* oct16last.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* oct16last.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* oct16last.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* oct16last.app.server.repository..*(..))")
