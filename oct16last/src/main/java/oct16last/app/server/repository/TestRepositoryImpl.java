...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for Test Master table Entity", complexity = Complexity.LOW)
public class TestRepositoryImpl extends SearchInterfaceImpl implements TestRepository<Test> {
    ...
    @Override
    @Transactional
    public List<Test> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<oct16last.app.shared.defaultdomain.Test> query = emanager.createQuery("select u from Test u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public Test save(Test entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<Test> save(List<Test> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                oct16last.app.shared.defaultdomain.Test obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            oct16last.app.shared.defaultdomain.Test s = emanager.find(oct16last.app.shared.defaultdomain.Test.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(Test entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<Test> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                oct16last.app.shared.defaultdomain.Test obj = entity.get(i);
    ...
    @Transactional
    public Test findById(String pk) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("Test.findById");
            query.setParameter("pk", pk);
            oct16last.app.shared.defaultdomain.Test listOfTest = (oct16last.app.shared.defaultdomain.Test) query.getSingleResult();
            return listOfTest;
        } catch (javax.persistence.PersistenceException e) {
