...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for CheckboxTest Master table Entity", complexity = Complexity.LOW)
public class CheckboxTestRepositoryImpl extends SearchInterfaceImpl implements CheckboxTestRepository<CheckboxTest> {
    ...
    @Override
    @Transactional
    public List<CheckboxTest> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<oct16last.app.shared.defaultdomain.CheckboxTest> query = emanager.createQuery("select u from CheckboxTest u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public CheckboxTest save(CheckboxTest entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<CheckboxTest> save(List<CheckboxTest> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                oct16last.app.shared.defaultdomain.CheckboxTest obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            oct16last.app.shared.defaultdomain.CheckboxTest s = emanager.find(oct16last.app.shared.defaultdomain.CheckboxTest.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(CheckboxTest entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<CheckboxTest> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                oct16last.app.shared.defaultdomain.CheckboxTest obj = entity.get(i);
    ...
    @Transactional
    public CheckboxTest findById(String pk) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CheckboxTest.findById");
            query.setParameter("pk", pk);
            oct16last.app.shared.defaultdomain.CheckboxTest listOfCheckboxTest = (oct16last.app.shared.defaultdomain.CheckboxTest) query.getSingleResult();
