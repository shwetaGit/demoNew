...
import oct16last.app.server.repository.CheckboxTestRepository;
...
public class CheckboxTestServiceImpl extends CheckboxTestService {
    ...
    @Autowired
    private CheckboxTestRepository<CheckboxTest> checkboxTestrepo;
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<oct16last.app.shared.defaultdomain.CheckboxTest> lstcheckboxtest = checkboxTestrepo.findAll();
        responseBean.add("success", true);
        responseBean.add("message", "Successfully retrived ");
        responseBean.add("data", lstcheckboxtest);
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, httpStatus);
    }

    @RequestMapping(consumes = "application/json", method = RequestMethod.POST)
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody CheckboxTest entity) throws SpartanPersistenceException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            checkboxTestrepo.save(entity);
            responseBean.add("success", true);
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody List<CheckboxTest> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            checkboxTestrepo.save(entity);
    ...
    public HttpEntity<ResponseBean> delete(@PathVariable("cid") String entity) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            checkboxTestrepo.delete(entity);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody CheckboxTest entity) throws SpartanPersistenceException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            checkboxTestrepo.update(entity);
            responseBean.add("success", true);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody List<CheckboxTest> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            checkboxTestrepo.update(entity);
    ...
    public HttpEntity<ResponseBean> search(@RequestBody Map<String, Object> fieldData) throws SpartanPersistenceException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        List<java.lang.Object> lstcheckboxtest = checkboxTestrepo.search("CheckboxTest.DefaultFinders", fieldData, getFieldMetaData());
        responseBean.add("success", true);
        responseBean.add("message", "Successfully retrived ");
        responseBean.add("data", lstcheckboxtest);
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, httpStatus);
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            oct16last.app.shared.defaultdomain.CheckboxTest lstcheckboxtest = checkboxTestrepo.findById((String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstcheckboxtest);
        } catch (org.springframework.transaction.TransactionException e) {
