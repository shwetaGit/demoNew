package oct16last.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* oct16last.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* oct16last.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* oct16last.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* oct16last.app.server.service..*..*(..)) && !within(oct16last.app.server.service.sessionmgt.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* oct16last.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* oct16last.app.server.service..get*(..))")
