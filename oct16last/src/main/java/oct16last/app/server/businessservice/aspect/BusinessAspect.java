package oct16last.app.server.businessservice.aspect;
...
public class BusinessAspect {
    ...
    @Before("execution(* oct16last.app.server.repository.*Impl.save(..))")
    public void beforeSaveAdvice(JoinPoint joinPoint) throws SpartanConstraintViolationException {
        Object obj[] = joinPoint.getArgs();
    }

    @After("execution(* oct16last.app.server.businessservice..*(..))")
