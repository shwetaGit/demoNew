package oct16last.app.shared.contacts;
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<oct16last.app.shared.contacts.CommunicationData>();
        }
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<oct16last.app.shared.location.Address>();
        }
        if (_address != null) {
    ...
    public boolean equals(Object obj) {
        try {
            oct16last.app.shared.contacts.CoreContacts other = (oct16last.app.shared.contacts.CoreContacts) obj;
            if (contactId == null) {
                return false;
