Ext.define('Oct16last.oct16last.web.oct16last.controller.defaultdomain.TestMainController', {
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var gridPanel = this.view.up().down('#TestGrid');
               ...
               var formPanel = this.getView().up().down("#Test");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#TestTree');
     ...
     loadData: function(responseData) {
          this.view.down('#Test').getViewModel().setData(responseData.response.data);
     },
