 ...
 * 
 */
Ext.define('Oct16last.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Oct16last.view.logalarm.LogAlarmMainViewController',
			'Oct16last.view.logalarm.tree.LogAlarmTreePanel',
			'Oct16last.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
