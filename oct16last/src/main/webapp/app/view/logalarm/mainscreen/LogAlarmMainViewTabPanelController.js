 ...
 * 
 */
Ext.define('Oct16last.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	{
		debugger;
		var component = Ext.create("Oct16last.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
