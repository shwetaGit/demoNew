Ext.define('Oct16last.view.fw.frameworkController.FrameworkViewController', {
     ...
     onConsoleClick: function() {
          var window = Ext.create('Oct16last.view.console.ConsoleWindow');
     ...
     /** Final jsonData creation function */
      ...
      createWindow : function (component){
		...
		{
			 var mainTab =  Ext.getCmp('appMainTabPanel');
             var tab = mainTab.getActiveTab();
             tab.destroy();
             mainTab.add(component);
             mainTab.setActiveTab(component);
		}*/
