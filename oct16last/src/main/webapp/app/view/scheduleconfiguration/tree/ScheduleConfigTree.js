 ...
 * 
 */
Ext.define("Oct16last.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Oct16last.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
