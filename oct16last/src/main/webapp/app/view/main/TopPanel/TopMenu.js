Ext.define('Oct16last.view.main.TopPanel.TopMenu', { 
	extend: 'Ext.toolbar.Toolbar',
    xtype: 'topMenu',
    requires:['Oct16last.view.main.TopPanel.TopMenuController',/*'Oct16last.view.main.ResourceWindow'*/],
        ...
        items: [
                {		text: 'Resorces',
                		handler:function(panel,e,eOpts)
                    	{
                    		debugger;
                    		var westAccodianPanel = this.up().up().up().up().up().down('#appMenuTreePanel');
                    		var resourceWindow = Ext.create('Oct16last.view.main.ResourceWindow');
