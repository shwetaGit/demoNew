Ext.define('Oct16last.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Oct16last.view.reportui.datachart.chart.RatingField','Oct16last.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
