 ...
 * 
 */
Ext.define('Oct16last.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Oct16last.view.securityconfig.SecurityConfigController',
			'Oct16last.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
