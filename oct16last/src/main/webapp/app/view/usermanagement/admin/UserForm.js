Ext.define('Oct16last.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Oct16last.view.usermanagement.admin.AddUserDetailsViewModel', 'Oct16last.model.AddUserDataModel' ],
