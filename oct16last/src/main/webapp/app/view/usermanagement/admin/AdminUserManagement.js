Ext.define('Oct16last.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Oct16last.view.usermanagement.admin.UserPasswordReset',
	            'Oct16last.view.usermanagement.admin.AddUserDetails',
	            'Oct16last.view.usermanagement.admin.ViewUser'],
