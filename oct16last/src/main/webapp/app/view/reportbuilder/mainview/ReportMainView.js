Ext.define('Oct16last.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Oct16last.view.reportbuilder.reportlist.ReportListPanelView',
             'Oct16last.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Oct16last.view.reportbuilder.mainview.ReportMainController'
             ],
