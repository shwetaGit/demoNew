Ext.define('Oct16last.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Oct16last.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Oct16last.view.reportbuilder.gridconfig.GridConfigView',
	           'Oct16last.view.reportbuilder.properties.PropertiesPanelView',
	           'Oct16last.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
