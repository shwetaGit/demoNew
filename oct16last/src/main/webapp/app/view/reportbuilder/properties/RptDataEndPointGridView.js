Ext.define('Oct16last.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Oct16last.view.reportbuilder.properties.RptDataEndPointGridController'],
