Ext.define('Oct16last.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Oct16last.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Oct16last.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Oct16last.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Oct16last.view.querybuildernewmodel.querydetail.QueryDetail');
