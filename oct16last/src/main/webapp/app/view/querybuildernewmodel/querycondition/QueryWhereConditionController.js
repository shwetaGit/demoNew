Ext.define('Oct16last.view.querybuildernewmodel.querycondition.QueryWhereConditionController', {
	...
	beforeCellEdit : function(editor, context, eOpts){
		...
		if(context.record.isRoot()||(context.record.isFirst()&&context.colIdx ==1 && 
			...
			var whereClauseWindow = Ext.create('Oct16last.view.querybuildernewmodel.querycondition.QueryWhereClauseWindow',{
