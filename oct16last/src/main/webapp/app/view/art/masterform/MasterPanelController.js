Ext.define('Oct16last.view.art.masterform.MasterPanelController', {
	     ...
	     Ext.Ajax.request(
 	             {
 	                 ...
 	                 success : function(response,currentObject){
 	                	 ...
 	                	 debugger;
 	                	  var masterFormPanelViewModel = Ext.create('Oct16last.view.art.masterform.MasterFormViewModel');
 	                	  ...
 	                	  var newFormPanelViewModel = Ext.create('Oct16last.view.art.masterform.MasterFormViewModel');
