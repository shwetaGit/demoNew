...
Ext
		.define(
				'Oct16last.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Oct16last.view.logger.tabs.details.DetailsTab',
							'Oct16last.view.logger.tabs.fileconnector.FileConnectorTab',
							'Oct16last.view.logger.tabs.dbconnector.DBConnectorTab',
							'Oct16last.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Oct16last.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Oct16last.view.logger.LogConfigurationTabPanelController',
