 ...
 * 
 */
Ext.define('Oct16last.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Oct16last.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
