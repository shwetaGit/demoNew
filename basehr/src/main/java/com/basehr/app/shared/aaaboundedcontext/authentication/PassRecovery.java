...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "root", versionNumber = "2", comments = "PassRecovery", complexity = Complexity.LOW)
...
public class PassRecovery implements Serializable, CommonEntityInterface, PassRecoveryInterface, Comparator<PassRecovery> {
    ...
    public boolean equals(Object obj) {
        try {
            com.basehr.app.shared.aaaboundedcontext.authentication.PassRecovery other = (com.basehr.app.shared.aaaboundedcontext.authentication.PassRecovery) obj;
            if (passRecoveryId == null) {
                return false;
