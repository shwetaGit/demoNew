...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationData>();
        }
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<com.basehr.app.shared.organizationboundedcontext.location.Address>();
        }
        if (_address != null) {
    ...
    public boolean equals(Object obj) {
        try {
            com.basehr.app.shared.organizationboundedcontext.contacts.CoreContacts other = (com.basehr.app.shared.organizationboundedcontext.contacts.CoreContacts) obj;
            if (contactId == null) {
                return false;
