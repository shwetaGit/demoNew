...
public class UserAccessLevel implements Serializable, CommonEntityInterface, Comparator<UserAccessLevel> {
    ...
    public boolean equals(Object obj) {
        try {
            com.basehr.app.shared.aaaboundedcontext.authentication.UserAccessLevel other = (com.basehr.app.shared.aaaboundedcontext.authentication.UserAccessLevel) obj;
            if (userAccessLevelId == null) {
                return false;
