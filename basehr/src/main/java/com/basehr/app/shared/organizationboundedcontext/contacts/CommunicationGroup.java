...
public class CommunicationGroup implements Serializable, CommonEntityInterface, Comparator<CommunicationGroup> {
    ...
    public boolean equals(Object obj) {
        try {
            com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationGroup other = (com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationGroup) obj;
            if (commGroupId == null) {
                return false;
