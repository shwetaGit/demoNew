package com.basehr.app.shared.aaaboundedcontext.authentication;
...
public class Login implements Serializable, CommonEntityInterface, UserAuthentication, Comparator<Login> {
    ...
    public boolean equals(Object obj) {
        try {
            com.basehr.app.shared.aaaboundedcontext.authentication.Login other = (com.basehr.app.shared.aaaboundedcontext.authentication.Login) obj;
            if (loginPk == null) {
                return false;
