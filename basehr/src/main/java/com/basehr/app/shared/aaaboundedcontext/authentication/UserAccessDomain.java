...
public class UserAccessDomain implements Serializable, CommonEntityInterface, Comparator<UserAccessDomain> {
    ...
    public boolean equals(Object obj) {
        try {
            com.basehr.app.shared.aaaboundedcontext.authentication.UserAccessDomain other = (com.basehr.app.shared.aaaboundedcontext.authentication.UserAccessDomain) obj;
            if (userAccessDomainId == null) {
                return false;
