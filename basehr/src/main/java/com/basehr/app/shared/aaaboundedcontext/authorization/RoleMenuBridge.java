package com.basehr.app.shared.aaaboundedcontext.authorization;
...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "root", versionNumber = "2", comments = "RoleMenuBridge", complexity = Complexity.LOW)
...
public class RoleMenuBridge implements Serializable, CommonEntityInterface, Comparator<RoleMenuBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            com.basehr.app.shared.aaaboundedcontext.authorization.RoleMenuBridge other = (com.basehr.app.shared.aaaboundedcontext.authorization.RoleMenuBridge) obj;
            if (roleMenuMapId == null) {
                return false;
