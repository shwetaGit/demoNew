...
public class CommunicationData implements Serializable, CommonEntityInterface, Comparator<CommunicationData> {
    ...
    public boolean equals(Object obj) {
        try {
            com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationData other = (com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationData) obj;
            if (commDataId == null) {
                return false;
