...
public class PasswordPolicyRepositoryImpl extends SearchInterfaceImpl implements PasswordPolicyRepository<PasswordPolicy> {
    ...
    public List<PasswordPolicyInterface> findAll() throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordPolicyRepositoryImpl", "findAll", "Total Records Fetched = " + query.size());
        return query;
    }
    ...
    public PasswordPolicy save(PasswordPolicy entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordPolicyRepositoryImpl", "save", entity);
        return entity;
    }
    ...
    public List<PasswordPolicy> save(List<PasswordPolicy> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.basehr.app.shared.aaaboundedcontext.authentication.PasswordPolicy obj = entity.get(i);
            emanager.persist(obj);
        }
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordPolicyRepositoryImpl", "saveAll", "Total Records saved = " + entity.size());
        return entity;
    }
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.basehr.app.shared.aaaboundedcontext.authentication.PasswordPolicy s = emanager.find(com.basehr.app.shared.aaaboundedcontext.authentication.PasswordPolicy.class, id);
        emanager.remove(s);
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordPolicyRepositoryImpl", "delete", "Record Deleted");
    }
    ...
    public void update(PasswordPolicy entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordPolicyRepositoryImpl", "update", entity);
    }
    ...
    public void update(List<PasswordPolicy> entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordPolicyRepositoryImpl", "updateAll", "Total Records updated = " + entity.size());
    }
    ...
    public List<Object> search(String finderName, Map<String, Object> fields, Map<String, String> fieldMetaData) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordPolicyRepositoryImpl", "search", "Total Records Fetched = " + list.size());
        return list;
    }
    ...
    public PasswordPolicy findById(String policyId) throws Exception {
        ...
        com.basehr.app.shared.aaaboundedcontext.authentication.PasswordPolicy listOfPasswordPolicy = (com.basehr.app.shared.aaaboundedcontext.authentication.PasswordPolicy) query.getSingleResult();
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordPolicyRepositoryImpl", "findById", "Total Records Fetched = " + listOfPasswordPolicy);
