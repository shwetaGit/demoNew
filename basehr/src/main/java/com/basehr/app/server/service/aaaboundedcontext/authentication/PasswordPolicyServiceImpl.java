...
public class PasswordPolicyServiceImpl extends PasswordPolicyService {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        com.basehr.app.shared.aaaboundedcontext.authentication.PasswordPolicy lstpasswordpolicy = passwordPolicyrepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("null");
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "PasswordPolicy"));
        responseBean.add("data", lstpasswordpolicy);
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordPolicyServiceImpl", "save", "PasswordPolicy");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
}
