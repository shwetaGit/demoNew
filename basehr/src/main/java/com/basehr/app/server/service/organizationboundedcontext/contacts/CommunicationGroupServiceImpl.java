...
public class CommunicationGroupServiceImpl extends CommunicationGroupService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationGroup> lstcommunicationgroup = communicationGrouprepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationGroup lstcommunicationgroup = communicationGrouprepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("null");
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "CommunicationGroup"));
        responseBean.add("data", lstcommunicationgroup);
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationGroupServiceImpl", "save", "CommunicationGroup");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
}
