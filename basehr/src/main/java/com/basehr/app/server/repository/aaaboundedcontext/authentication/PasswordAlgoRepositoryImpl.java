...
public class PasswordAlgoRepositoryImpl extends SearchInterfaceImpl implements PasswordAlgoRepository<PasswordAlgo> {
    ...
    public List<PasswordAlgoInterface> findAll() throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordAlgoRepositoryImpl", "findAll", "Total Records Fetched = " + query.size());
        return query;
    }
    ...
    public PasswordAlgo save(PasswordAlgo entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordAlgoRepositoryImpl", "save", entity);
        return entity;
    }
    ...
    public List<PasswordAlgo> save(List<PasswordAlgo> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.basehr.app.shared.aaaboundedcontext.authentication.PasswordAlgo obj = entity.get(i);
            emanager.persist(obj);
        }
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordAlgoRepositoryImpl", "saveAll", "Total Records saved = " + entity.size());
        return entity;
    }
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.basehr.app.shared.aaaboundedcontext.authentication.PasswordAlgo s = emanager.find(com.basehr.app.shared.aaaboundedcontext.authentication.PasswordAlgo.class, id);
        emanager.remove(s);
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordAlgoRepositoryImpl", "delete", "Record Deleted");
    }
    ...
    public void update(PasswordAlgo entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordAlgoRepositoryImpl", "update", entity);
    }
    ...
    public void update(List<PasswordAlgo> entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordAlgoRepositoryImpl", "updateAll", "Total Records updated = " + entity.size());
    }
    ...
    public List<Object> search(String finderName, Map<String, Object> fields, Map<String, String> fieldMetaData) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordAlgoRepositoryImpl", "search", "Total Records Fetched = " + list.size());
        return list;
    }
    ...
    public PasswordAlgo findById(String algoId) throws Exception {
        ...
        com.basehr.app.shared.aaaboundedcontext.authentication.PasswordAlgo listOfPasswordAlgo = (com.basehr.app.shared.aaaboundedcontext.authentication.PasswordAlgo) query.getSingleResult();
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "PasswordAlgoRepositoryImpl", "findById", "Total Records Fetched = " + listOfPasswordAlgo);
