...
public class AddressTypeServiceImpl extends AddressTypeService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.basehr.app.shared.organizationboundedcontext.location.AddressType> lstaddresstype = addressTyperepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        com.basehr.app.shared.organizationboundedcontext.location.AddressType lstaddresstype = addressTyperepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("null");
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "AddressType"));
        responseBean.add("data", lstaddresstype);
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "AddressTypeServiceImpl", "save", "AddressType");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
}
