...
public class TimezoneServiceImpl extends TimezoneService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.basehr.app.shared.organizationboundedcontext.location.Timezone> lsttimezone = timezonerepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        com.basehr.app.shared.organizationboundedcontext.location.Timezone lsttimezone = timezonerepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("null");
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Timezone"));
        responseBean.add("data", lsttimezone);
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "TimezoneServiceImpl", "save", "Timezone");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
}
