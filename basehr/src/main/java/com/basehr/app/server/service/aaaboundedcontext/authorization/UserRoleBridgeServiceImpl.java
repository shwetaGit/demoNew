...
public class UserRoleBridgeServiceImpl extends UserRoleBridgeService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.basehr.app.shared.aaaboundedcontext.authorization.UserRoleBridge> lstuserrolebridge = userRoleBridgerepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByRoleId(@RequestBody FindByBean findByBean) throws Exception {
        ...
        List<com.basehr.app.shared.aaaboundedcontext.authorization.UserRoleBridge> lstuserrolebridge = userRoleBridgerepo.findByRoleId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ABSAU124100200");
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "UserRoleBridge"));
        responseBean.add("data", lstuserrolebridge);
        Log.out.println("ABSAU124100200", runtimeLogInfoHelper.getRequestHeaderBean(), "UserRoleBridgeServiceImpl", "save", "UserRoleBridge");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
    ...
    public HttpEntity<ResponseBean> findByUserId(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        List<com.basehr.app.shared.aaaboundedcontext.authorization.UserRoleBridge> lstuserrolebridge = userRoleBridgerepo.findByUserId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ABSAU124100200");
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "UserRoleBridge"));
        responseBean.add("data", lstuserrolebridge);
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        com.basehr.app.shared.aaaboundedcontext.authorization.UserRoleBridge lstuserrolebridge = userRoleBridgerepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("null");
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "UserRoleBridge"));
        responseBean.add("data", lstuserrolebridge);
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "UserRoleBridgeServiceImpl", "save", "UserRoleBridge");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
}
