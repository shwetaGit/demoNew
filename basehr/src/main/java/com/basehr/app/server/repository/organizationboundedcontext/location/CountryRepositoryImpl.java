...
public class CountryRepositoryImpl extends SearchInterfaceImpl implements CountryRepository<Country> {
    ...
    public List<Country> findAll() throws Exception {
        ...
        java.util.List<com.basehr.app.shared.organizationboundedcontext.location.Country> query = emanager.createQuery("select u from Country u where u.systemInfo.activeStatus=1").getResultList();
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CountryRepositoryImpl", "findAll", "Total Records Fetched = " + query.size());
        return query;
    }
    ...
    public Country save(Country entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CountryRepositoryImpl", "save", entity);
        return entity;
    }
    ...
    public List<Country> save(List<Country> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.basehr.app.shared.organizationboundedcontext.location.Country obj = entity.get(i);
            emanager.persist(obj);
        }
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CountryRepositoryImpl", "saveAll", "Total Records saved = " + entity.size());
        return entity;
    }
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.basehr.app.shared.organizationboundedcontext.location.Country s = emanager.find(com.basehr.app.shared.organizationboundedcontext.location.Country.class, id);
        emanager.remove(s);
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CountryRepositoryImpl", "delete", "Record Deleted");
    }
    ...
    public void update(Country entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CountryRepositoryImpl", "update", entity);
    }
    ...
    public void update(List<Country> entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CountryRepositoryImpl", "updateAll", "Total Records updated = " + entity.size());
    }
    ...
    public List<Object> search(String finderName, Map<String, Object> fields, Map<String, String> fieldMetaData) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CountryRepositoryImpl", "search", "Total Records Fetched = " + list.size());
        return list;
    }
    ...
    public Country findById(String countryId) throws Exception {
        ...
        com.basehr.app.shared.organizationboundedcontext.location.Country listOfCountry = (com.basehr.app.shared.organizationboundedcontext.location.Country) query.getSingleResult();
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CountryRepositoryImpl", "findById", "Total Records Fetched = " + listOfCountry);
