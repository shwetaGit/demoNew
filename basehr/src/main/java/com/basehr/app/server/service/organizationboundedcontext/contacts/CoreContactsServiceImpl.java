...
import com.basehr.app.server.businessservice.organizationboundedcontext.contacts.CoreContactsBusinessService;
...
public class CoreContactsServiceImpl extends CoreContactsService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.basehr.app.shared.organizationboundedcontext.contacts.CoreContacts> lstcorecontacts = coreContactsrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByTitleId(@RequestBody FindByBean findByBean) throws Exception {
        ...
        List<com.basehr.app.shared.organizationboundedcontext.contacts.CoreContacts> lstcorecontacts = coreContactsrepo.findByTitleId((java.lang.String) findByBean.getFindKey());
        ...
        responseBean.add("message", String.format(appAlarm.getMessage(), "CoreContacts"));
        responseBean.add("data", lstcorecontacts);
        Log.out.println("ORGCN124100200", runtimeLogInfoHelper.getRequestHeaderBean(), "CoreContactsServiceImpl", "save", "CoreContacts");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
    ...
    public HttpEntity<ResponseBean> findByNativeLanguageCode(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        List<com.basehr.app.shared.organizationboundedcontext.contacts.CoreContacts> lstcorecontacts = coreContactsrepo.findByNativeLanguageCode((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ORGCN124100200");
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "CoreContacts"));
        responseBean.add("data", lstcorecontacts);
    ...
    public HttpEntity<ResponseBean> findByGenderId(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        List<com.basehr.app.shared.organizationboundedcontext.contacts.CoreContacts> lstcorecontacts = coreContactsrepo.findByGenderId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ORGCN124100200");
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "CoreContacts"));
        responseBean.add("data", lstcorecontacts);
    ...
    public HttpEntity<ResponseBean> findByTimeZoneId(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        List<com.basehr.app.shared.organizationboundedcontext.contacts.CoreContacts> lstcorecontacts = coreContactsrepo.findByTimeZoneId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ORGCN124100200");
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "CoreContacts"));
        responseBean.add("data", lstcorecontacts);
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        com.basehr.app.shared.organizationboundedcontext.contacts.CoreContacts lstcorecontacts = coreContactsrepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("null");
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "CoreContacts"));
        responseBean.add("data", lstcorecontacts);
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CoreContactsServiceImpl", "save", "CoreContacts");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
}
