...
public class CommunicationTypeRepositoryImpl extends SearchInterfaceImpl implements CommunicationTypeRepository<CommunicationType> {
    ...
    public List<CommunicationType> findAll() throws Exception {
        ...
        java.util.List<com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationType> query = emanager.createQuery("select u from CommunicationType u where u.systemInfo.activeStatus=1").getResultList();
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationTypeRepositoryImpl", "findAll", "Total Records Fetched = " + query.size());
        return query;
    }
    ...
    public CommunicationType save(CommunicationType entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationTypeRepositoryImpl", "save", entity);
        return entity;
    }
    ...
    public List<CommunicationType> save(List<CommunicationType> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationType obj = entity.get(i);
            emanager.persist(obj);
        }
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationTypeRepositoryImpl", "saveAll", "Total Records saved = " + entity.size());
        return entity;
    }
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationType s = emanager.find(com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationType.class, id);
        emanager.remove(s);
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationTypeRepositoryImpl", "delete", "Record Deleted");
    }
    ...
    public void update(CommunicationType entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationTypeRepositoryImpl", "update", entity);
    }
    ...
    public void update(List<CommunicationType> entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationTypeRepositoryImpl", "updateAll", "Total Records updated = " + entity.size());
    }
    ...
    public List<Object> search(String finderName, Map<String, Object> fields, Map<String, String> fieldMetaData) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationTypeRepositoryImpl", "search", "Total Records Fetched = " + list.size());
        return list;
    }
    ...
    public List<CommunicationType> findByCommGroupId(String commGroupId) throws Exception {
        ...
        java.util.List<com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationType> listOfCommunicationType = query.getResultList();
        Log.out.println("ORGCN324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationTypeRepositoryImpl", "findByCommGroupId", "Total Records Fetched = " + listOfCommunicationType.size());
    ...
    public CommunicationType findById(String commType) throws Exception {
        ...
        com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationType listOfCommunicationType = (com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationType) query.getSingleResult();
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationTypeRepositoryImpl", "findById", "Total Records Fetched = " + listOfCommunicationType);
        return listOfCommunicationType;
    }
}
