...
public class CommunicationGroupRepositoryImpl extends SearchInterfaceImpl implements CommunicationGroupRepository<CommunicationGroup> {
    ...
    public List<CommunicationGroup> findAll() throws Exception {
        ...
        java.util.List<com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationGroup> query = emanager.createQuery("select u from CommunicationGroup u where u.systemInfo.activeStatus=1").getResultList();
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationGroupRepositoryImpl", "findAll", "Total Records Fetched = " + query.size());
        return query;
    }
    ...
    public CommunicationGroup save(CommunicationGroup entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationGroupRepositoryImpl", "save", entity);
        return entity;
    }
    ...
    public List<CommunicationGroup> save(List<CommunicationGroup> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationGroup obj = entity.get(i);
            emanager.persist(obj);
        }
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationGroupRepositoryImpl", "saveAll", "Total Records saved = " + entity.size());
        return entity;
    }
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationGroup s = emanager.find(com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationGroup.class, id);
        emanager.remove(s);
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationGroupRepositoryImpl", "delete", "Record Deleted");
    }
    ...
    public void update(CommunicationGroup entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationGroupRepositoryImpl", "update", entity);
    }
    ...
    public void update(List<CommunicationGroup> entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationGroupRepositoryImpl", "updateAll", "Total Records updated = " + entity.size());
    }
    ...
    public List<Object> search(String finderName, Map<String, Object> fields, Map<String, String> fieldMetaData) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationGroupRepositoryImpl", "search", "Total Records Fetched = " + list.size());
        return list;
    }
    ...
    public CommunicationGroup findById(String commGroupId) throws Exception {
        ...
        com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationGroup listOfCommunicationGroup = (com.basehr.app.shared.organizationboundedcontext.contacts.CommunicationGroup) query.getSingleResult();
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "CommunicationGroupRepositoryImpl", "findById", "Total Records Fetched = " + listOfCommunicationGroup);
