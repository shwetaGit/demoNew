...
public class LanguageServiceImpl extends LanguageService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.basehr.app.shared.organizationboundedcontext.location.Language> lstlanguage = languagerepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        com.basehr.app.shared.organizationboundedcontext.location.Language lstlanguage = languagerepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("null");
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Language"));
        responseBean.add("data", lstlanguage);
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "LanguageServiceImpl", "save", "Language");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
}
