...
public class AppMenusRepositoryImpl extends SearchInterfaceImpl implements AppMenusRepository<AppMenus> {
    ...
    public List<AppMenus> findAll() throws Exception {
        ...
        java.util.List<com.basehr.app.shared.aaaboundedcontext.authorization.AppMenus> query = emanager.createQuery("select u from AppMenus u where u.systemInfo.activeStatus=1").getResultList();
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "AppMenusRepositoryImpl", "findAll", "Total Records Fetched = " + query.size());
        return query;
    }
    ...
    public AppMenus save(AppMenus entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "AppMenusRepositoryImpl", "save", entity);
        return entity;
    }
    ...
    public List<AppMenus> save(List<AppMenus> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.basehr.app.shared.aaaboundedcontext.authorization.AppMenus obj = entity.get(i);
            emanager.persist(obj);
        }
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "AppMenusRepositoryImpl", "saveAll", "Total Records saved = " + entity.size());
        return entity;
    }
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.basehr.app.shared.aaaboundedcontext.authorization.AppMenus s = emanager.find(com.basehr.app.shared.aaaboundedcontext.authorization.AppMenus.class, id);
        emanager.remove(s);
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "AppMenusRepositoryImpl", "delete", "Record Deleted");
    }
    ...
    public void update(AppMenus entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "AppMenusRepositoryImpl", "update", entity);
    }
    ...
    public void update(List<AppMenus> entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "AppMenusRepositoryImpl", "updateAll", "Total Records updated = " + entity.size());
    }
    ...
    public List<Object> search(String finderName, Map<String, Object> fields, Map<String, String> fieldMetaData) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "AppMenusRepositoryImpl", "search", "Total Records Fetched = " + list.size());
        return list;
    }
    ...
    public AppMenus findById(String menuId) throws Exception {
        ...
        com.basehr.app.shared.aaaboundedcontext.authorization.AppMenus listOfAppMenus = (com.basehr.app.shared.aaaboundedcontext.authorization.AppMenus) query.getSingleResult();
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "AppMenusRepositoryImpl", "findById", "Total Records Fetched = " + listOfAppMenus);
