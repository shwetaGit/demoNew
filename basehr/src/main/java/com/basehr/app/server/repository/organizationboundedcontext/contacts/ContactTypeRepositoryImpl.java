...
public class ContactTypeRepositoryImpl extends SearchInterfaceImpl implements ContactTypeRepository<ContactType> {
    ...
    public List<ContactType> findAll() throws Exception {
        ...
        java.util.List<com.basehr.app.shared.organizationboundedcontext.contacts.ContactType> query = emanager.createQuery("select u from ContactType u where u.systemInfo.activeStatus=1").getResultList();
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "ContactTypeRepositoryImpl", "findAll", "Total Records Fetched = " + query.size());
        return query;
    }
    ...
    public ContactType save(ContactType entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "ContactTypeRepositoryImpl", "save", entity);
        return entity;
    }
    ...
    public List<ContactType> save(List<ContactType> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.basehr.app.shared.organizationboundedcontext.contacts.ContactType obj = entity.get(i);
            emanager.persist(obj);
        }
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "ContactTypeRepositoryImpl", "saveAll", "Total Records saved = " + entity.size());
        return entity;
    }
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.basehr.app.shared.organizationboundedcontext.contacts.ContactType s = emanager.find(com.basehr.app.shared.organizationboundedcontext.contacts.ContactType.class, id);
        emanager.remove(s);
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "ContactTypeRepositoryImpl", "delete", "Record Deleted");
    }
    ...
    public void update(ContactType entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "ContactTypeRepositoryImpl", "update", entity);
    }
    ...
    public void update(List<ContactType> entity) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "ContactTypeRepositoryImpl", "updateAll", "Total Records updated = " + entity.size());
    }
    ...
    public List<Object> search(String finderName, Map<String, Object> fields, Map<String, String> fieldMetaData) throws Exception {
        ...
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "ContactTypeRepositoryImpl", "search", "Total Records Fetched = " + list.size());
        return list;
    }
    ...
    public ContactType findById(String contactTypeId) throws Exception {
        ...
        com.basehr.app.shared.organizationboundedcontext.contacts.ContactType listOfContactType = (com.basehr.app.shared.organizationboundedcontext.contacts.ContactType) query.getSingleResult();
        Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), "ContactTypeRepositoryImpl", "findById", "Total Records Fetched = " + listOfContactType);
