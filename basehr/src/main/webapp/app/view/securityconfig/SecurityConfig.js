 ...
 * 
 */
Ext.define('Basehr.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Basehr.view.securityconfig.SecurityConfigController',
			'Basehr.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
