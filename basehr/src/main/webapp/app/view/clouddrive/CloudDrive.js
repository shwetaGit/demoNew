Ext.define("Basehr.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Basehr.view.clouddrive.CloudDriveController',
	             'Basehr.view.clouddrive.documentview.DocumentsView',
	             'Basehr.view.clouddrive.drivedetails.DriveDetails',
	             //'Basehr.view.clouddrive.documentview.DocumentListView'
	             ],
