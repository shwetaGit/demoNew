 ...
 * 
 */
Ext.define('Basehr.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Basehr.view.logalarm.mainscreen.AddLogAlarmController',
			'Basehr.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Basehr.view.logalarm.mainscreen.AppAlarmPanel',
