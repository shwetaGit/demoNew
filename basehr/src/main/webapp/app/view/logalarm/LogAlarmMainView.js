 ...
 * 
 */
Ext.define('Basehr.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Basehr.view.logalarm.LogAlarmMainViewController',
			'Basehr.view.logalarm.tree.LogAlarmTreePanel',
			'Basehr.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
