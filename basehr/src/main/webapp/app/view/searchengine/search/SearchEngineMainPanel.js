Ext.define('Basehr.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Basehr.view.searchengine.search.NorthPanel', 'Basehr.view.searchengine.search.SearchResult','Basehr.view.searchengine.search.SearchEngineMainPanelController'],
