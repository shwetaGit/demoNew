Ext
		.define(
				'Basehr.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Basehr.view.searchengine.search.SearchEngineMainPanelController','Basehr.view.searchengine.search.PanelHeaderField' ,'Basehr.view.searchengine.search.ReportGridView','Basehr.view.searchengine.search.ReportChartView','Basehr.view.searchengine.search.documentView','Basehr.view.searchengine.search.DouMeanView','Basehr.view.googlemaps.map.MapPanel'],
