 ...
 * 
 */
Ext.define('Basehr.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Basehr.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
