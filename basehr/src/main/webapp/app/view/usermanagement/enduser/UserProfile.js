Ext.define('Basehr.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Basehr.view.usermanagement.enduser.UserProfileController', 'Basehr.view.usermanagement.admin.AddUserDetailsViewModel', 'Basehr.model.AddUserDataModel' ],
