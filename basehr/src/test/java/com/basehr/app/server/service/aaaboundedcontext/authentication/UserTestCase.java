...
public class UserTestCase extends EntityTestCriteria {
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 92123));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "rNtA9Bj3tMAXUhOdF5TkgzMiXrIxXZyNnGOEAbjsuD3YFzN4tpvTLzBcVZhxLUXAd"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 7129));
