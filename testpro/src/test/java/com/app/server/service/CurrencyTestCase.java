...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("5i6MFgFPFSlyBuBXLnHiV1VbwHcK81B4");
            country.setCapitalLatitude(10);
            country.setCapitalLongitude(9);
            country.setCountryCode1("xkS");
            country.setCountryCode2("SbR");
            country.setCountryFlag("b7zpYI6WTHhih7lq9U9PTqOL1IDf5espQuAekL0fZNPMB381au");
            country.setCountryName("KVofVM24CHM8PvqxVb9jd3nS6X7wBBnscaNbxV151gBKMc6pp3");
            country.setCurrencyCode("psz");
            country.setCurrencyName("mmqxVDLdKjkS8uea8WGhYYXfWbKZABTQTR2g8ksKtoypMIlMOI");
            country.setCurrencySymbol("sFg2uCGz0i0VAGeMRktM1an6tlE2thSm");
            country.setIsoNumeric(11);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("bCyZ83iVvxfHVqYKtL41Z1WiAbwOkMagG1hswISK8FNGIixIdc");
            currency.setUnicodeDecimal("7KEltZufaYw7ZbM5Cz8paIFhfB2dbUuB3MAU0fPf3rkzhdlV0G");
            currency.setUnicodeHex("4YYmwcSKjLosBRxb3WyxkSB9H8G0gMDMIl5IO5yhvKQ1t3hRXy");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("b8AcCUHEysCz9cBmZyef0t3XlwoygwBpxKhHAlLeDtlac2ovHe");
            currency.setUnicodeDecimal("7etv3caXwvipUv3y6y7NwIcBIuQm2d0CiFXTFcQD0Dz3mL346Q");
            currency.setUnicodeHex("qYNjdykF9RVutGJYTxM01al9AazAvsWeXAsYzaRQNx3z7zpUuV");
