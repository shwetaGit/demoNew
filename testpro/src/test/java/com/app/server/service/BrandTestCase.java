...
public class BrandTestCase {
    ...
    public void test1Save() {
        try {
            ...
            category.setCategory("Mf64QjgAYWPWByOPvZVt06uk8vi0Qx2KrbmKhNeiPBRwQLSB1i");
            Category CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
            Brand brand = new Brand();
            brand.setBranddesc("zmqDjhKNzGDWEcxx2bEFOBSTT3Zt1OB9pCiWQFnOysUctCrtKV");
    ...
    public void test2Update() {
        try {
            ...
            brand.setBranddesc("bWQQECkalYSgBJgpLeSK9mq4vfX2kKmE0VlNf75X7YKz0ynGss");
