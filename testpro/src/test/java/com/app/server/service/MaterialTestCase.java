...
public class MaterialTestCase {
    ...
    public void test1Save() {
        try {
            ...
            brand.setBranddesc("ehGogoT0LeS15pBCyqomq2s3j3dxygDaJLCnP6ofijSPgINJ25");
            Category category = new Category();
            category.setCategory("KcyNFZM617iR9Qc7gVLLRIGHM6fLyAaNUB6DvudEC9KAilNP96");
            Category CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
            brand.setBranddesc("wjZJ2agbktToCNmHFVduQ3tlUMZOfax2b86m5pOlfkSwnAcCAU");
            ...
            material.setMaterialdesc("Jo0ECMHcrw8AvpSguZPvXcWWauW7wRjCVL06Dv9SDYDw7eRh3W");
    ...
    public void test2Update() {
        try {
            ...
            material.setMaterialdesc("sLYSaWXqQgJ7OiaLTIJvja7I2pDo5A1LNLsUk7wmJ6USSOZIyF");
