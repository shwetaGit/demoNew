...
public class AppCustomerTypeTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomertype.setCustomerType("JvgXIUyx466xXolWNUzEeLN5ZhOISTz3myCJqBhBIjCxgZlfRp");
    ...
    public void test2Update() {
        try {
            ...
            appcustomertype.setCustomerType("uPBIhV44CZyilkZIA1KnZSZIzlkEHj5qKeVHnK9g4T4GIL39tc");
            appcustomertype.setDefaults(1);
            appcustomertype.setSequenceId(2147483647);
