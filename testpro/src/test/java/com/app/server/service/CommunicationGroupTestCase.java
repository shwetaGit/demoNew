...
public class CommunicationGroupTestCase {
    ...
    public void test1Save() {
        try {
            ...
            communicationgroup.setCommGroupDescription("WkuRgHtaLjxxs3GhVBTCbXReEPnMEXRCJvDNzIOLvVD0D7mda9");
            communicationgroup.setCommGroupName("vDLKJ8jKxJni1LnICXlgLGzwlLeAYWGzbD13D2wuIKxGaCNeZD");
    ...
    public void test2Update() {
        try {
            ...
            communicationgroup.setCommGroupDescription("DyVFgKx1Bci2DPuKQrGVEG2cTBDNnwSG4kSPKel8ghbfLpl8zD");
            communicationgroup.setCommGroupName("LBzwmKLdNASQARCYbNlBjnZbFhtS6RW6H9QorWLcFUgWGcZGyV");
