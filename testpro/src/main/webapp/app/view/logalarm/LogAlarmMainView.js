 ...
 * 
 */
Ext.define('Testpro.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Testpro.view.logalarm.LogAlarmMainViewController',
			'Testpro.view.logalarm.tree.LogAlarmTreePanel',
			'Testpro.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
