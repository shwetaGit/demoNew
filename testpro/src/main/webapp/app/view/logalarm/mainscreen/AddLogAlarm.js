 ...
 * 
 */
Ext.define('Testpro.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testpro.view.logalarm.mainscreen.AddLogAlarmController',
			'Testpro.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testpro.view.logalarm.mainscreen.AppAlarmPanel',
