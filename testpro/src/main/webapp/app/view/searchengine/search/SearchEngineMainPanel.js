Ext.define('Testpro.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testpro.view.searchengine.search.NorthPanel', 'Testpro.view.searchengine.search.SearchResult','Testpro.view.searchengine.search.SearchEngineMainPanelController'],
