Ext
		.define(
				'Testpro.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testpro.view.searchengine.search.SearchEngineMainPanelController','Testpro.view.searchengine.search.PanelHeaderField' ,'Testpro.view.searchengine.search.ReportGridView','Testpro.view.searchengine.search.ReportChartView','Testpro.view.searchengine.search.documentView','Testpro.view.searchengine.search.DouMeanView','Testpro.view.googlemaps.map.MapPanel'],
