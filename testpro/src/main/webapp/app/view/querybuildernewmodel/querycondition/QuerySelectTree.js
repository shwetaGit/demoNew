Ext.define('Testpro.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testpro.view.querybuildernewmodel.querycondition.QuerySelectController',
