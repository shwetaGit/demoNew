Ext.define('Testpro.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Testpro.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Testpro.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Testpro.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Testpro.view.querybuildernewmodel.querydetail.QueryDetail');
