Ext.define('Testpro.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Testpro.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Testpro.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Testpro.view.querybuildernewmodel.floatingentity.EntitySprite',
