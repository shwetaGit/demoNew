Ext.define('Testpro.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testpro.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
