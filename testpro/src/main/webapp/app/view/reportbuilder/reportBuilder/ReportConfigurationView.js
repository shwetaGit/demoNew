Ext.define('Testpro.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Testpro.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Testpro.view.reportbuilder.gridconfig.GridConfigView',
	           'Testpro.view.reportbuilder.properties.PropertiesPanelView',
	           'Testpro.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
