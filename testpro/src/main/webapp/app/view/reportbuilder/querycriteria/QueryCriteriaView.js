Ext.define('Testpro.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Testpro.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Testpro.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Testpro.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Testpro.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
