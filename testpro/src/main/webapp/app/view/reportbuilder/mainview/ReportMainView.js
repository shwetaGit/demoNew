Ext.define('Testpro.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Testpro.view.reportbuilder.reportlist.ReportListPanelView',
             'Testpro.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Testpro.view.reportbuilder.mainview.ReportMainController'
             ],
