Ext.define("Testpro.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Testpro.view.clouddrive.CloudDriveController',
	             'Testpro.view.clouddrive.documentview.DocumentsView',
	             'Testpro.view.clouddrive.drivedetails.DriveDetails',
	             //'Testpro.view.clouddrive.documentview.DocumentListView'
	             ],
