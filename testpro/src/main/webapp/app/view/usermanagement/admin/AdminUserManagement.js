Ext.define('Testpro.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testpro.view.usermanagement.admin.UserPasswordReset',
	            'Testpro.view.usermanagement.admin.AddUserDetails',
	            'Testpro.view.usermanagement.admin.ViewUser'],
