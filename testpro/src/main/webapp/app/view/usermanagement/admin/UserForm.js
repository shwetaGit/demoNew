Ext.define('Testpro.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testpro.view.usermanagement.admin.AddUserDetailsViewModel', 'Testpro.model.AddUserDataModel' ],
