Ext.define('Testpro.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Testpro.view.usermanagement.enduser.UserProfileController', 'Testpro.view.usermanagement.admin.AddUserDetailsViewModel', 'Testpro.model.AddUserDataModel' ],
