 ...
 * 
 */
Ext.define('Testpro.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testpro.view.securityconfig.SecurityConfigController',
			'Testpro.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
