...
Ext
		.define(
				'Testpro.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testpro.view.logger.tabs.details.DetailsTab',
							'Testpro.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testpro.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testpro.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testpro.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testpro.view.logger.LogConfigurationTabPanelController',
