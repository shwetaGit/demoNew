 ...
 */
Ext.define('Testpro.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Testpro.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Testpro.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Testpro.view.login.SessionLogin').center();
