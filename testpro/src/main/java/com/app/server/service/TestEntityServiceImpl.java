...
import com.app.server.repository.TestEntityRepository;
...
public class TestEntityServiceImpl extends TestEntityService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.defaultdomain.TestEntity> lsttestentity = testEntityrepo.findAll();
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody TestEntity entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.defaultdomain.TestEntity lsttestentity = testEntityrepo.findById((java.lang.Integer) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lsttestentity);
        } catch (org.springframework.transaction.TransactionException e) {
