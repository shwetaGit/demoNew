...
@SourceCodeAuthorClass(createdBy = "nayan.chaudhari@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Channel", complexity = Complexity.LOW)
...
public class Channel implements Serializable, CommonEntityInterface, Comparator<Channel> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.sales.Channel other = (com.app.shared.sales.Channel) obj;
            if (channelId == null) {
                return false;
