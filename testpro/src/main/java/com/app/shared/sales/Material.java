...
@SourceCodeAuthorClass(createdBy = "nayan.chaudhari@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Material", complexity = Complexity.LOW)
...
public class Material implements Serializable, CommonEntityInterface, Comparator<Material> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.sales.Material other = (com.app.shared.sales.Material) obj;
            if (materialcode == null) {
                return false;
