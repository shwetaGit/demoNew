...
@SourceCodeAuthorClass(createdBy = "nayan.chaudhari@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "UserAccess", complexity = Complexity.LOW)
...
public class UserAccess implements Serializable, CommonEntityInterface, Comparator<UserAccess> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.sales.UserAccess other = (com.app.shared.sales.UserAccess) obj;
            if (userAccessId == null) {
                return false;
