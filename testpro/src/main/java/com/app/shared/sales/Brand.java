...
@SourceCodeAuthorClass(createdBy = "nayan.chaudhari@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Brand", complexity = Complexity.LOW)
...
public class Brand implements Serializable, CommonEntityInterface, Comparator<Brand> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.sales.Brand other = (com.app.shared.sales.Brand) obj;
            if (brandcode == null) {
                return false;
