...
@SourceCodeAuthorClass(createdBy = "nayan.chaudhari@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Retailer", complexity = Complexity.LOW)
...
public class Retailer implements Serializable, CommonEntityInterface, Comparator<Retailer> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.sales.Retailer other = (com.app.shared.sales.Retailer) obj;
            if (retailercode == null) {
                return false;
