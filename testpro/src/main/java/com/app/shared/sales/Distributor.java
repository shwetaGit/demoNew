...
@SourceCodeAuthorClass(createdBy = "nayan.chaudhari@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Distributor", complexity = Complexity.LOW)
...
public class Distributor implements Serializable, CommonEntityInterface, Comparator<Distributor> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.sales.Distributor other = (com.app.shared.sales.Distributor) obj;
            if (distributorcode == null) {
                return false;
