...
public class SalesDataRepositoryImpl extends SearchInterfaceImpl implements SalesDataRepository<SalesData> {
    ...
    public List<SalesData> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.sales.SalesData> query = emanager.createQuery("select u from SalesData u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<SalesData> save(List<SalesData> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.sales.SalesData obj = entity.get(i);
    ...
    public void delete(Integer id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.sales.SalesData s = emanager.find(com.app.shared.sales.SalesData.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<SalesData> findByChannelId(String channelId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.sales.SalesData> listOfSalesData = query.getResultList();
    ...
    public SalesData findById(Integer autoid) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.sales.SalesData listOfSalesData = (com.app.shared.sales.SalesData) query.getSingleResult();
            return listOfSalesData;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
