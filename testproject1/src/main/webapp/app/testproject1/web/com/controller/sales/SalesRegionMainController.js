Ext.define('Testproject1.testproject1.web.com.controller.sales.SalesRegionMainController', {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.regioncode;
          me = this;
