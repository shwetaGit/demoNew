Ext.define('Testproject1.testproject1.web.com.controller.sales.BrandMainController', {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.brandcode;
          me = this;
