Ext.define('Testproject1.testproject1.web.com.controller.sales.DistributorMainController', {
     extend: 'Testproject1.view.fw.frameworkController.FrameworkViewController',
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.distributorcode;
          me = this;
     ...
     saveForm: function(but, evt) {
          ...
          var method;
          if (jsonData.distributorcode == null) {
               method = 'POST'
          } else {
               method = 'PUT';
               jsonData.systemInfo = {
