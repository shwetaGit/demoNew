Ext.define('Testproject1.testproject1.web.com.controller.sales.MaterialMainController', {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.materialcode;
          me = this;
