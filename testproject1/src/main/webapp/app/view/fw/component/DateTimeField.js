 ...
 */
Ext.define('Testproject1.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Testproject1.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Testproject1.view.fw.component.DateTimePicker(o);
    },
