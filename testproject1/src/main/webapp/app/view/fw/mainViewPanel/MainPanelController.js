Ext.define('Testproject1.view.fw.mainViewPanel.MainPanelController', {
	extend : 'Ext.app.ViewController',
	requires : ['Ext.util.Cookies',
	            'Testproject1.view.login.ChangePasswordScreen'],
	...
	afterRender:function()
	{
		...
		if(cookieChangePwd=="true"){
			 var component = Ext.create("Testproject1.view.login.ChangePasswordScreen",
							{
								modal:true,
							});
			 component.show();
