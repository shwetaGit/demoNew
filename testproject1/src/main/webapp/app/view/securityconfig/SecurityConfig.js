 ...
 * 
 */
Ext.define('Testproject1.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testproject1.view.securityconfig.SecurityConfigController',
			'Testproject1.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
