Ext.define('Testproject1.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Testproject1.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Testproject1.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Testproject1.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Testproject1.view.querybuildernewmodel.querydetail.QueryDetail');
