Ext.define('Testproject1.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Testproject1.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Testproject1.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Testproject1.view.querybuildernewmodel.floatingentity.EntitySprite',
