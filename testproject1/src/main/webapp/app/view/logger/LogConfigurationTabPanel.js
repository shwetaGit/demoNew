...
Ext
		.define(
				'Testproject1.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testproject1.view.logger.tabs.details.DetailsTab',
							'Testproject1.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testproject1.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testproject1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testproject1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testproject1.view.logger.LogConfigurationTabPanelController',
