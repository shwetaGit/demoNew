 ...
 * 
 */
Ext.define('Testproject1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testproject1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
