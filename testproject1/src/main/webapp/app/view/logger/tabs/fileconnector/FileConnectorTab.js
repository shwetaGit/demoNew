 ...
 * 
 */
Ext.define('Testproject1.view.logger.tabs.fileconnector.FileConnectorTab', {
	...
	requires : ['Testproject1.view.logger.tabs.fileconnector.FileConnectorTabController'],
