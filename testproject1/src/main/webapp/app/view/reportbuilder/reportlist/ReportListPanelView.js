Ext.define('Testproject1.view.reportbuilder.reportlist.ReportListPanelView', {
	extend : 'Ext.panel.Panel',
	requires:['Testproject1.view.reportbuilder.reportlist.ReportListPanelController'],
