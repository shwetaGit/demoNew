Ext.define('Testproject1.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Testproject1.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Testproject1.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Testproject1.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Testproject1.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
