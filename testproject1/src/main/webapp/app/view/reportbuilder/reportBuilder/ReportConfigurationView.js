Ext.define('Testproject1.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Testproject1.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Testproject1.view.reportbuilder.gridconfig.GridConfigView',
	           'Testproject1.view.reportbuilder.properties.PropertiesPanelView',
	           'Testproject1.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
