Ext.define('Testproject1.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Testproject1.view.reportbuilder.properties.RptDataEndPointGridController'],
