Ext.define('Testproject1.view.reportbuilder.properties.RptDrillDownGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Testproject1.view.reportbuilder.properties.RptDrillDownGridController'],
