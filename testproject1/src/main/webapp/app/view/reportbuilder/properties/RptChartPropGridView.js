Ext.define('Testproject1.view.reportbuilder.properties.RptChartPropGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Testproject1.view.reportbuilder.properties.RptChartPropGridController'],
