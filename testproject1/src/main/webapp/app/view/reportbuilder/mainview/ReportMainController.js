Ext.define('Testproject1.view.reportbuilder.mainview.ReportMainController',{
    	    		    	    		 ...
    	    		    	    		 var newReportName=this.up().up().down('#new-report-name').value;
        	    		    		   	 ...
        	    		    		   	 if(newReportName!="")
        	       		    	    		...
        	       		    	    		var tabs= view.down("#reportsTabPanel");     		    		    			   
        	       		   		    		var tab=Ext.create('Testproject1.view.reportbuilder.reportBuilder.ReportBuilderView',
        	       		   		    		{
        	       		   		    			closable:true,
        	       		   		    			title:newReportName,
        	       		   		    			iconCls:'newTabIcon',
