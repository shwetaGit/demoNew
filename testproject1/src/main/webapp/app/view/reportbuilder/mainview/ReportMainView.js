Ext.define('Testproject1.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Testproject1.view.reportbuilder.reportlist.ReportListPanelView',
             'Testproject1.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Testproject1.view.reportbuilder.mainview.ReportMainController'
             ],
