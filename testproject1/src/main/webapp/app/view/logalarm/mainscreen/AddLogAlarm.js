 ...
 * 
 */
Ext.define('Testproject1.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testproject1.view.logalarm.mainscreen.AddLogAlarmController',
			'Testproject1.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testproject1.view.logalarm.mainscreen.AppAlarmPanel',
