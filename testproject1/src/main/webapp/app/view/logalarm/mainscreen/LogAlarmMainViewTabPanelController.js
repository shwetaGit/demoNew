 ...
 * 
 */
Ext.define('Testproject1.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	init : function()
	{
		...
		var component = Ext.create("Testproject1.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
