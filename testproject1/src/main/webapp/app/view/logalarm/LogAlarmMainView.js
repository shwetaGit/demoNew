 ...
 * 
 */
Ext.define('Testproject1.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Testproject1.view.logalarm.LogAlarmMainViewController',
			'Testproject1.view.logalarm.tree.LogAlarmTreePanel',
			'Testproject1.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
