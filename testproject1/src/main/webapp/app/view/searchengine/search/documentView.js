Ext
		.define(
				'Testproject1.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Testproject1.view.searchengine.search.documentController',
							'Testproject1.view.searchengine.search.RowExpander' ],
