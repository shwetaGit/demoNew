Ext.define('Testproject1.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testproject1.view.searchengine.search.NorthPanel', 'Testproject1.view.searchengine.search.SearchResult','Testproject1.view.searchengine.search.SearchEngineMainPanelController'],
