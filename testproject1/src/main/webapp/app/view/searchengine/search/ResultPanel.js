Ext
		.define(
				'Testproject1.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testproject1.view.searchengine.search.SearchEngineMainPanelController','Testproject1.view.searchengine.search.PanelHeaderField' ,'Testproject1.view.searchengine.search.ReportGridView','Testproject1.view.searchengine.search.ReportChartView','Testproject1.view.searchengine.search.documentView','Testproject1.view.searchengine.search.DouMeanView','Testproject1.view.googlemaps.map.MapPanel'],
