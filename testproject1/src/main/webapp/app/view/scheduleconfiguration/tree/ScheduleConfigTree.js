 ...
 * 
 */
Ext.define("Testproject1.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Testproject1.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
