...
public class BrandTestCase {
    ...
    public void test1Save() {
        try {
            ...
            category.setCategory("A5HzgVT4ga1VVym2oj3GfsGggD6F77fWxi75osPhWS5fZ8VsEe");
            Category CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
            Brand brand = new Brand();
            brand.setBranddesc("DM7txr5wtQLKbAYRQ68gRzoD40dEe4b7QtzpofBEr36oXFL6jl");
    ...
    public void test2Update() {
        try {
            ...
            brand.setBranddesc("nI0Rw4fJqMyUZX7c6zqaPZNK2e48iz3pYsV0f1p5EqA0bJqMax");
