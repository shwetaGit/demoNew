...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("SKOrpxTdIsJaRr9NyhrfAd8OgYuAkZwX");
            country.setCapitalLatitude(6);
            country.setCapitalLongitude(6);
            country.setCountryCode1("jjw");
            country.setCountryCode2("SXY");
            country.setCountryFlag("PbS9H6tPJWuDFSEOIU7cp0tV0eE6hilGf4r7jUPVmQ7burZwOK");
            country.setCountryName("s7zIkqgw9eANfvKAwff1xD1hAS2SR1sWaoX5f830JhzjqbnLl8");
            country.setCurrencyCode("wbx");
            country.setCurrencyName("jhy4nveqXtIpT1kKdell64AhFNsEZ9zh31MxNkn0YYbGzzTaLW");
            country.setCurrencySymbol("TWYKeqFk2rfZ78dOtEVsVcGmks02gBuh");
            country.setIsoNumeric(7);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("ibwRfFan2vIdBXPzCEvNJZY08MlN0Zc61y2iFqSA8vmfKSBtHD");
            currency.setUnicodeDecimal("LOWiisYPkAdRHmk5yS1hl1YA08tw5ue2wnINvPKHOSs7QoaRnZ");
            currency.setUnicodeHex("9X2srypwMgJ9B0TKpOZCMGWZ83wB8JJ3L41Um2odjNF9cQREwN");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("bMeP3NI2RhKkmDiYzfjFrFbDqj1OudtGVG79IpNGwllnfjjAdB");
            currency.setUnicodeDecimal("cbHFwisYHK9q8wP3YFOZWX2yxup7EST0cl5L7GAQxVBicQxxyU");
            currency.setUnicodeHex("kaOCnpbS4Vts56uk6k2QC2Dk5J696ZHqE1sjq9WfXRSPpcQyox");
