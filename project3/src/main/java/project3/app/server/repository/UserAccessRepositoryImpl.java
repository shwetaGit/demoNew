...
public class UserAccessRepositoryImpl extends SearchInterfaceImpl implements UserAccessRepository<UserAccess> {
    ...
    public List<UserAccess> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<project3.app.shared.sales.UserAccess> query = emanager.createQuery("select u from UserAccess u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public UserAccess save(UserAccess entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<UserAccess> save(List<UserAccess> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                project3.app.shared.sales.UserAccess obj = entity.get(i);
    ...
    public void delete(Integer id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            project3.app.shared.sales.UserAccess s = emanager.find(project3.app.shared.sales.UserAccess.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(UserAccess entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<UserAccess> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                project3.app.shared.sales.UserAccess obj = entity.get(i);
    ...
    public List<UserAccess> findByUserId(String userId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<project3.app.shared.sales.UserAccess> listOfUserAccess = query.getResultList();
    ...
    public UserAccess findById(Integer userAccessId) throws Exception, SpartanPersistenceException {
        try {
            ...
            project3.app.shared.sales.UserAccess listOfUserAccess = (project3.app.shared.sales.UserAccess) query.getSingleResult();
            return listOfUserAccess;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
