 ...
 * 
 */
Ext.define('Project3.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Project3.view.logalarm.mainscreen.AddLogAlarmController',
			'Project3.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Project3.view.logalarm.mainscreen.AppAlarmPanel',
