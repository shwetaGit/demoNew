 ...
 * 
 */
Ext.define('Project3.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Project3.view.logalarm.LogAlarmMainViewController',
			'Project3.view.logalarm.tree.LogAlarmTreePanel',
			'Project3.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
