Ext.define('Project3.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Project3.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
