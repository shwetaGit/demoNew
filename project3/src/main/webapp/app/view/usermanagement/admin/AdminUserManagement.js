Ext.define('Project3.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Project3.view.usermanagement.admin.UserPasswordReset',
	            'Project3.view.usermanagement.admin.AddUserDetails',
	            'Project3.view.usermanagement.admin.ViewUser'],
