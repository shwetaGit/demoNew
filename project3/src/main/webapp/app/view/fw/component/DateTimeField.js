 ...
 */
Ext.define('Project3.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Project3.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Project3.view.fw.component.DateTimePicker(o);
    },
