...
Ext
		.define(
				'Project3.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Project3.view.logger.tabs.details.DetailsTab',
							'Project3.view.logger.tabs.fileconnector.FileConnectorTab',
							'Project3.view.logger.tabs.dbconnector.DBConnectorTab',
							'Project3.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Project3.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Project3.view.logger.LogConfigurationTabPanelController',
