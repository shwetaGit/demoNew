 ...
 * 
 */
Ext.define('Project3.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Project3.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
