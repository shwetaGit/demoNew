Ext.define('Project3.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Project3.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Project3.view.reportbuilder.gridconfig.GridConfigView',
	           'Project3.view.reportbuilder.properties.PropertiesPanelView',
	           'Project3.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
