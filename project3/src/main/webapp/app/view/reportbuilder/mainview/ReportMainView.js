Ext.define('Project3.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Project3.view.reportbuilder.reportlist.ReportListPanelView',
             'Project3.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Project3.view.reportbuilder.mainview.ReportMainController'
             ],
