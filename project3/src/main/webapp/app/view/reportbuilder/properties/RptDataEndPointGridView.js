Ext.define('Project3.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Project3.view.reportbuilder.properties.RptDataEndPointGridController'],
