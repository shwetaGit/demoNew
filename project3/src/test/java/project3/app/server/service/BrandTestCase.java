...
public class BrandTestCase {
    ...
    public void test1Save() {
        try {
            ...
            category.setCategory("GKXJMrOekFRqqnhPVQUW1DaoWirUDVKmWvPalA0SRYqVhGC7Zo");
            Category CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
            Brand brand = new Brand();
            brand.setBranddesc("PkkkrxpwgUAHwSwjgBLXjeoSWU2QSa60IJFywfRVFXeEXgruYx");
    ...
    public void test2Update() {
        try {
            ...
            brand.setBranddesc("uyhFYgz9IyTCPRmaMMQkVOxRpIVOiiSIyjNGn6qgSy7NUrOjJr");
