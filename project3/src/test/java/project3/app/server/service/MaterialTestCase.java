...
public class MaterialTestCase {
    ...
    public void test1Save() {
        try {
            ...
            brand.setBranddesc("EXkbzoMNMU8Wt5qlrpl1gqeDc2yfHz56bA8woKIo3PoSR6f21j");
            Category category = new Category();
            category.setCategory("NVubM4btRTdgohxqjKEA8w4tpUBZ5qUILC0sHYFJwey3mhWazv");
            Category CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
            brand.setBranddesc("5W7ntsi8RLS5bjD4KMblYtekGjb90pLcyJRyt7E7lms1VEEJoS");
            ...
            material.setMaterialdesc("7X10SAbt8Edt4L0oLIWuhu0jAhU2J3pAsUAwXUjGaU25Rklk8E");
    ...
    public void test2Update() {
        try {
            ...
            material.setMaterialdesc("7J48KslIO3v7VIxyT6aoiUVNlwvZtSDgYY2YkOyRDSVqwpFORx");
