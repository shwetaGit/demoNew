...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("BtfNgIXihR8ywlOtRneqzt1Lc2zoW6dUeCminO37s1JmbrRhI9");
            question.setQuestionDetails("r");
            question.setQuestionIcon("rTPh78njbsml0bFzblD4cpTxgeZ0SAqOwZFsslIUTXdrUmd74P");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("TVWIaPtDtBAPUXGS5gMGpNsNkew1N9TUZE7etrIzI85rAYse8N");
            question.setQuestionDetails("7");
            question.setQuestionIcon("DZ2lgd2geyyBDN1rBooW7YRFSJfZamULnlVvb9gG7Skn3XfRzi");
