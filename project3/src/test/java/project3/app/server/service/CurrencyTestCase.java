...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("Ken98xqcpjD11CmAaq2eZZfomjJ4dtdJ");
            country.setCapitalLatitude(6);
            country.setCapitalLongitude(3);
            country.setCountryCode1("Nmx");
            country.setCountryCode2("DZo");
            country.setCountryFlag("O01qByaEy2y8bu9p5R6kxcVxaFuDeGHWuFH5va9GPR4dhurMKU");
            country.setCountryName("1BeTzqQYUf7LaahfU5j3rxx5nnJY8RChfeHGxJdLuI6B7PmBKN");
            country.setCurrencyCode("bl3");
            country.setCurrencyName("rUVeuUPYvUlxJqe4b58DWJeLhgeF9o7thtE3wilslZkxelPDPy");
            country.setCurrencySymbol("yc1le8nNrneET4sXOlVFwmwn2CQCi6Bb");
            country.setIsoNumeric(10);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("mYjJZ7ct48MnLTxBinTeMTIURSdsihqyoGFXjG7GPZ8l307ZV0");
            currency.setUnicodeDecimal("dVDzslCqHwCMSE1oxlhPxn3sZ68lxXZK0wyFxh28D0u5Vieebw");
            currency.setUnicodeHex("ggqhk1lgw0xal1TYAumO0S7aeUTutRgIJ25Zcv7k7fG0W6KJ7q");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("8jWLCcFhYFTZNkApfU1tUuQSTaDt6SHbDXx8491AjUhaySAErO");
            currency.setUnicodeDecimal("iqkYrfPlC2fk6HammOaeQLA74x0iqlwHGk7nubrRtNfRcgUw58");
            currency.setUnicodeHex("Zt44yMOKBPgwivUuEzTblJYAatgW6gPwjbfD8AkoUZyaEFKfCS");
