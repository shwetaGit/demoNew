...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "DepartmentType", complexity = Complexity.LOW)
...
public class DepartmentType implements Serializable, CommonEntityInterface, Comparator<DepartmentType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.employee.DepartmentType other = (com.app.shared.employee.DepartmentType) obj;
            if (deptTypeCode == null) {
                return false;
