...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "DesignationType", complexity = Complexity.LOW)
...
public class DesignationType implements Serializable, CommonEntityInterface, Comparator<DesignationType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.employee.DesignationType other = (com.app.shared.employee.DesignationType) obj;
            if (designatnTypeCode == null) {
                return false;
