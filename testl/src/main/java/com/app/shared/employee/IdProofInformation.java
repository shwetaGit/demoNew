...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "IdProofInformation", complexity = Complexity.LOW)
...
public class IdProofInformation implements Serializable, CommonEntityInterface, Comparator<IdProofInformation> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.employee.IdProofInformation other = (com.app.shared.employee.IdProofInformation) obj;
            if (idCode == null) {
                return false;
