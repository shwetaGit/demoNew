...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "JobType", complexity = Complexity.LOW)
...
public class JobType implements Serializable, CommonEntityInterface, Comparator<JobType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.employee.JobType other = (com.app.shared.employee.JobType) obj;
            if (jobCode == null) {
                return false;
