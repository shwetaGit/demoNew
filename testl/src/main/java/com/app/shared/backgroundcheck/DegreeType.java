...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "DegreeType", complexity = Complexity.LOW)
...
public class DegreeType implements Serializable, CommonEntityInterface, Comparator<DegreeType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.backgroundcheck.DegreeType other = (com.app.shared.backgroundcheck.DegreeType) obj;
            if (degreeCode == null) {
                return false;
