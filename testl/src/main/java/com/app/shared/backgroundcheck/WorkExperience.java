...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "WorkExperience", complexity = Complexity.LOW)
...
public class WorkExperience implements Serializable, CommonEntityInterface, Comparator<WorkExperience> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.backgroundcheck.WorkExperience other = (com.app.shared.backgroundcheck.WorkExperience) obj;
            if (workPk == null) {
                return false;
