...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "shweta.zagade@algorhythm.co.in", versionNumber = "2", comments = "CostToCompany", complexity = Complexity.LOW)
...
public class CostToCompany implements Serializable, CommonEntityInterface, Comparator<CostToCompany> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.payroll.CostToCompany other = (com.app.shared.payroll.CostToCompany) obj;
            if (salaryId == null) {
                return false;
    ...
    public Double calculateSpecialAllowance() {
        return totalCTC - (perk + medicalAllowance + hra + educationalAllowance + convenceAllowance + basic);
    }
}
