...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "DocumentList", complexity = Complexity.LOW)
...
public class DocumentList implements Serializable, CommonEntityInterface, Comparator<DocumentList> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.documentmanager.DocumentList other = (com.app.shared.documentmanager.DocumentList) obj;
            if (docId == null) {
                return false;
