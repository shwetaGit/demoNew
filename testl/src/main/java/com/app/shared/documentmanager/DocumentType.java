package com.app.shared.documentmanager;
...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "DocumentType", complexity = Complexity.LOW)
...
public class DocumentType implements Serializable, CommonEntityInterface, Comparator<DocumentType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.documentmanager.DocumentType other = (com.app.shared.documentmanager.DocumentType) obj;
            if (docTypeCode == null) {
                return false;
