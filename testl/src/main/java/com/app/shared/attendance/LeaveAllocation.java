...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "LeaveAllocation", complexity = Complexity.LOW)
...
public class LeaveAllocation implements Serializable, CommonEntityInterface, Comparator<LeaveAllocation> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.attendance.LeaveAllocation other = (com.app.shared.attendance.LeaveAllocation) obj;
            if (leaveCategoryId == null) {
                return false;
