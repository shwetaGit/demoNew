...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "shweta.zagade@algorhythm.co.in", versionNumber = "2", comments = "Repository for SalStrucFinWise Master table Entity", complexity = Complexity.LOW)
public class SalStrucFinWiseRepositoryImpl extends SearchInterfaceImpl implements SalStrucFinWiseRepository<SalStrucFinWise> {
    ...
    @Override
    @Transactional
    public List<SalStrucFinWise> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<com.app.shared.payroll.SalStrucFinWise> query = emanager.createQuery("select u from SalStrucFinWise u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public SalStrucFinWise save(SalStrucFinWise entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<SalStrucFinWise> save(List<SalStrucFinWise> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.payroll.SalStrucFinWise obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.payroll.SalStrucFinWise s = emanager.find(com.app.shared.payroll.SalStrucFinWise.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(SalStrucFinWise entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<SalStrucFinWise> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.payroll.SalStrucFinWise obj = entity.get(i);
    ...
    @Transactional
    public List<SalStrucFinWise> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("SalStrucFinWise.findByEmpId");
            query.setParameter("empId", empId);
            java.util.List<com.app.shared.payroll.SalStrucFinWise> listOfSalStrucFinWise = query.getResultList();
            return listOfSalStrucFinWise;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public SalStrucFinWise findById(String salaryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("SalStrucFinWise.findById");
            query.setParameter("salaryId", salaryId);
            com.app.shared.payroll.SalStrucFinWise listOfSalStrucFinWise = (com.app.shared.payroll.SalStrucFinWise) query.getSingleResult();
            return listOfSalStrucFinWise;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
