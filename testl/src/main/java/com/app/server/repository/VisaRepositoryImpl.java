...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for Visa Master table Entity", complexity = Complexity.LOW)
public class VisaRepositoryImpl extends SearchInterfaceImpl implements VisaRepository<Visa> {
    ...
    public List<Visa> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.employee.Visa> query = emanager.createQuery("select u from Visa u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public Visa save(Visa entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<Visa> save(List<Visa> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.employee.Visa obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.employee.Visa s = emanager.find(com.app.shared.employee.Visa.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(Visa entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<Visa> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.employee.Visa obj = entity.get(i);
    ...
    public Visa findById(String visaCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.employee.Visa listOfVisa = (com.app.shared.employee.Visa) query.getSingleResult();
            return listOfVisa;
        } catch (javax.persistence.PersistenceException e) {
