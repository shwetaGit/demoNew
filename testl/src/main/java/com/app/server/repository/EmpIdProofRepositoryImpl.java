...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for EmpIdProof Master table Entity", complexity = Complexity.LOW)
public class EmpIdProofRepositoryImpl extends SearchInterfaceImpl implements EmpIdProofRepository<EmpIdProof> {
    ...
    public List<EmpIdProof> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.employee.EmpIdProof> query = emanager.createQuery("select u from EmpIdProof u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public EmpIdProof save(EmpIdProof entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<EmpIdProof> save(List<EmpIdProof> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.employee.EmpIdProof obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.employee.EmpIdProof s = emanager.find(com.app.shared.employee.EmpIdProof.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(EmpIdProof entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<EmpIdProof> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.employee.EmpIdProof obj = entity.get(i);
    ...
    public List<EmpIdProof> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.employee.EmpIdProof> listOfEmpIdProof = query.getResultList();
    ...
    public EmpIdProof findById(String empIdpk) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.employee.EmpIdProof listOfEmpIdProof = (com.app.shared.employee.EmpIdProof) query.getSingleResult();
            return listOfEmpIdProof;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
