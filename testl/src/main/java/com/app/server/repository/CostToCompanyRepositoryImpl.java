...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "shweta.zagade@algorhythm.co.in", versionNumber = "2", comments = "Repository for CostToCompany Master table Entity", complexity = Complexity.LOW)
public class CostToCompanyRepositoryImpl extends SearchInterfaceImpl implements CostToCompanyRepository<CostToCompany> {
    ...
    public List<CostToCompany> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.payroll.CostToCompany> query = emanager.createQuery("select u from CostToCompany u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public CostToCompany save(CostToCompany entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<CostToCompany> save(List<CostToCompany> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.payroll.CostToCompany obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.payroll.CostToCompany s = emanager.find(com.app.shared.payroll.CostToCompany.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(CostToCompany entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<CostToCompany> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.payroll.CostToCompany obj = entity.get(i);
    ...
    public List<CostToCompany> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.payroll.CostToCompany> listOfCostToCompany = query.getResultList();
    ...
    public CostToCompany findById(String salaryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.payroll.CostToCompany listOfCostToCompany = (com.app.shared.payroll.CostToCompany) query.getSingleResult();
            return listOfCostToCompany;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
