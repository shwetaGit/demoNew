...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for UniversityType Master table Entity", complexity = Complexity.LOW)
public class UniversityTypeRepositoryImpl extends SearchInterfaceImpl implements UniversityTypeRepository<UniversityType> {
    ...
    public List<UniversityType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.backgroundcheck.UniversityType> query = emanager.createQuery("select u from UniversityType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public UniversityType save(UniversityType entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<UniversityType> save(List<UniversityType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.backgroundcheck.UniversityType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.backgroundcheck.UniversityType s = emanager.find(com.app.shared.backgroundcheck.UniversityType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(UniversityType entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<UniversityType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.backgroundcheck.UniversityType obj = entity.get(i);
    ...
    public UniversityType findById(String unvCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.backgroundcheck.UniversityType listOfUniversityType = (com.app.shared.backgroundcheck.UniversityType) query.getSingleResult();
