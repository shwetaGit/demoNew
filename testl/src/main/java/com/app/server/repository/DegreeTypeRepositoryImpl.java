...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for DegreeType Master table Entity", complexity = Complexity.LOW)
public class DegreeTypeRepositoryImpl extends SearchInterfaceImpl implements DegreeTypeRepository<DegreeType> {
    ...
    public List<DegreeType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.backgroundcheck.DegreeType> query = emanager.createQuery("select u from DegreeType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public DegreeType save(DegreeType entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<DegreeType> save(List<DegreeType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.backgroundcheck.DegreeType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.backgroundcheck.DegreeType s = emanager.find(com.app.shared.backgroundcheck.DegreeType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(DegreeType entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<DegreeType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.backgroundcheck.DegreeType obj = entity.get(i);
    ...
    public DegreeType findById(String degreeCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.backgroundcheck.DegreeType listOfDegreeType = (com.app.shared.backgroundcheck.DegreeType) query.getSingleResult();
