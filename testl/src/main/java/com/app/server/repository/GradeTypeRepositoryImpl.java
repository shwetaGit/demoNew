...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for GradeType Master table Entity", complexity = Complexity.LOW)
public class GradeTypeRepositoryImpl extends SearchInterfaceImpl implements GradeTypeRepository<GradeType> {
    ...
    public List<GradeType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.backgroundcheck.GradeType> query = emanager.createQuery("select u from GradeType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public GradeType save(GradeType entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<GradeType> save(List<GradeType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.backgroundcheck.GradeType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.backgroundcheck.GradeType s = emanager.find(com.app.shared.backgroundcheck.GradeType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(GradeType entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<GradeType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.backgroundcheck.GradeType obj = entity.get(i);
    ...
    public GradeType findById(String grdCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.backgroundcheck.GradeType listOfGradeType = (com.app.shared.backgroundcheck.GradeType) query.getSingleResult();
