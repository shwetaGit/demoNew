...
public class IdProofInformationRepositoryImpl extends SearchInterfaceImpl implements IdProofInformationRepository<IdProofInformation> {
    ...
    public List<IdProofInformation> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.employee.IdProofInformation> query = emanager.createQuery("select u from IdProofInformation u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public IdProofInformation save(IdProofInformation entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<IdProofInformation> save(List<IdProofInformation> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.employee.IdProofInformation obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.employee.IdProofInformation s = emanager.find(com.app.shared.employee.IdProofInformation.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(IdProofInformation entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<IdProofInformation> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.employee.IdProofInformation obj = entity.get(i);
    ...
    public IdProofInformation findById(String idCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.employee.IdProofInformation listOfIdProofInformation = (com.app.shared.employee.IdProofInformation) query.getSingleResult();
