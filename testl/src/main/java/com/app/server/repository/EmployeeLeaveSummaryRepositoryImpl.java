...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for EmployeeLeaveSummary Transaction table", complexity = Complexity.MEDIUM)
public class EmployeeLeaveSummaryRepositoryImpl extends SearchInterfaceImpl implements EmployeeLeaveSummaryRepository<EmployeeLeaveSummary> {
    ...
    public List<EmployeeLeaveSummary> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.attendance.EmployeeLeaveSummary> query = emanager.createQuery("select u from EmployeeLeaveSummary u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public EmployeeLeaveSummary save(EmployeeLeaveSummary entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<EmployeeLeaveSummary> save(List<EmployeeLeaveSummary> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.attendance.EmployeeLeaveSummary obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.attendance.EmployeeLeaveSummary s = emanager.find(com.app.shared.attendance.EmployeeLeaveSummary.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(EmployeeLeaveSummary entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<EmployeeLeaveSummary> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.attendance.EmployeeLeaveSummary obj = entity.get(i);
    ...
    public List<EmployeeLeaveSummary> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.attendance.EmployeeLeaveSummary> listOfEmployeeLeaveSummary = query.getResultList();
    ...
    public EmployeeLeaveSummary findById(String empLeaveStatusId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.attendance.EmployeeLeaveSummary listOfEmployeeLeaveSummary = (com.app.shared.attendance.EmployeeLeaveSummary) query.getSingleResult();
            return listOfEmployeeLeaveSummary;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
