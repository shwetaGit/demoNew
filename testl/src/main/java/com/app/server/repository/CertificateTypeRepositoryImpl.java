...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for CertificateType Master table Entity", complexity = Complexity.LOW)
public class CertificateTypeRepositoryImpl extends SearchInterfaceImpl implements CertificateTypeRepository<CertificateType> {
    ...
    public List<CertificateType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.backgroundcheck.CertificateType> query = emanager.createQuery("select u from CertificateType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public CertificateType save(CertificateType entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<CertificateType> save(List<CertificateType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.backgroundcheck.CertificateType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.backgroundcheck.CertificateType s = emanager.find(com.app.shared.backgroundcheck.CertificateType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(CertificateType entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<CertificateType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.backgroundcheck.CertificateType obj = entity.get(i);
    ...
    public CertificateType findById(String certCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.backgroundcheck.CertificateType listOfCertificateType = (com.app.shared.backgroundcheck.CertificateType) query.getSingleResult();
