...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for DocumentType Master table Entity", complexity = Complexity.LOW)
public class DocumentTypeRepositoryImpl extends SearchInterfaceImpl implements DocumentTypeRepository<DocumentType> {
    ...
    public List<DocumentType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.documentmanager.DocumentType> query = emanager.createQuery("select u from DocumentType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public DocumentType save(DocumentType entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<DocumentType> save(List<DocumentType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.documentmanager.DocumentType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.documentmanager.DocumentType s = emanager.find(com.app.shared.documentmanager.DocumentType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(DocumentType entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<DocumentType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.documentmanager.DocumentType obj = entity.get(i);
    ...
    public DocumentType findById(String docTypeCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.documentmanager.DocumentType listOfDocumentType = (com.app.shared.documentmanager.DocumentType) query.getSingleResult();
