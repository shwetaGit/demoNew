...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for LeaveRequest Master table Entity", complexity = Complexity.LOW)
public class LeaveRequestRepositoryImpl extends SearchInterfaceImpl implements LeaveRequestRepository<LeaveRequest> {
    ...
    public List<LeaveRequest> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.attendance.LeaveRequest> query = emanager.createQuery("select u from LeaveRequest u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public LeaveRequest save(LeaveRequest entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<LeaveRequest> save(List<LeaveRequest> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.attendance.LeaveRequest obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.attendance.LeaveRequest s = emanager.find(com.app.shared.attendance.LeaveRequest.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(LeaveRequest entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<LeaveRequest> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.attendance.LeaveRequest obj = entity.get(i);
    ...
    public List<LeaveRequest> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.attendance.LeaveRequest> listOfLeaveRequest = query.getResultList();
    ...
    public LeaveRequest findById(String leaveRequestId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.attendance.LeaveRequest listOfLeaveRequest = (com.app.shared.attendance.LeaveRequest) query.getSingleResult();
            return listOfLeaveRequest;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
