...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for CertificationDetails Transaction table", complexity = Complexity.MEDIUM)
