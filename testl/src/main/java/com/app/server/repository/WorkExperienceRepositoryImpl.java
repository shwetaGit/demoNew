...
public class WorkExperienceRepositoryImpl extends SearchInterfaceImpl implements WorkExperienceRepository<WorkExperience> {
    ...
    public List<WorkExperience> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.backgroundcheck.WorkExperience> query = emanager.createQuery("select u from WorkExperience u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public WorkExperience save(WorkExperience entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<WorkExperience> save(List<WorkExperience> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.backgroundcheck.WorkExperience obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.backgroundcheck.WorkExperience s = emanager.find(com.app.shared.backgroundcheck.WorkExperience.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(WorkExperience entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<WorkExperience> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.backgroundcheck.WorkExperience obj = entity.get(i);
    ...
    public List<WorkExperience> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.backgroundcheck.WorkExperience> listOfWorkExperience = query.getResultList();
    ...
    public WorkExperience findById(String workPk) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.backgroundcheck.WorkExperience listOfWorkExperience = (com.app.shared.backgroundcheck.WorkExperience) query.getSingleResult();
            return listOfWorkExperience;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
