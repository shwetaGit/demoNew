...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for EmployeeDeclartion Master table Entity", complexity = Complexity.LOW)
public class EmployeeDeclartionRepositoryImpl extends SearchInterfaceImpl implements EmployeeDeclartionRepository<EmployeeDeclartion> {
    ...
    public List<EmployeeDeclartion> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.payroll.EmployeeDeclartion> query = emanager.createQuery("select u from EmployeeDeclartion u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public EmployeeDeclartion save(EmployeeDeclartion entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<EmployeeDeclartion> save(List<EmployeeDeclartion> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.payroll.EmployeeDeclartion obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.payroll.EmployeeDeclartion s = emanager.find(com.app.shared.payroll.EmployeeDeclartion.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(EmployeeDeclartion entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<EmployeeDeclartion> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.payroll.EmployeeDeclartion obj = entity.get(i);
    ...
    public List<EmployeeDeclartion> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.payroll.EmployeeDeclartion> listOfEmployeeDeclartion = query.getResultList();
    ...
    public EmployeeDeclartion findById(String empDecId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.payroll.EmployeeDeclartion listOfEmployeeDeclartion = (com.app.shared.payroll.EmployeeDeclartion) query.getSingleResult();
            return listOfEmployeeDeclartion;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
