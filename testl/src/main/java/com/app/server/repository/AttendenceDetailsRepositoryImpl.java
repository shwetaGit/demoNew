...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for AttendenceDetails Transaction table", complexity = Complexity.MEDIUM)
public class AttendenceDetailsRepositoryImpl extends SearchInterfaceImpl implements AttendenceDetailsRepository<AttendenceDetails> {
    ...
    public List<AttendenceDetails> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.attendance.AttendenceDetails> query = emanager.createQuery("select u from AttendenceDetails u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public AttendenceDetails save(AttendenceDetails entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<AttendenceDetails> save(List<AttendenceDetails> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.attendance.AttendenceDetails obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.attendance.AttendenceDetails s = emanager.find(com.app.shared.attendance.AttendenceDetails.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(AttendenceDetails entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<AttendenceDetails> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.attendance.AttendenceDetails obj = entity.get(i);
    ...
    public List<AttendenceDetails> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.attendance.AttendenceDetails> listOfAttendenceDetails = query.getResultList();
    ...
    public AttendenceDetails findById(String attendenceId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.attendance.AttendenceDetails listOfAttendenceDetails = (com.app.shared.attendance.AttendenceDetails) query.getSingleResult();
            return listOfAttendenceDetails;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
