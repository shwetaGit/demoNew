...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for PaySlip Transaction table", complexity = Complexity.MEDIUM)
public class PaySlipRepositoryImpl extends SearchInterfaceImpl implements PaySlipRepository<PaySlip> {
    ...
    public List<PaySlip> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.payroll.PaySlip> query = emanager.createQuery("select u from PaySlip u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public PaySlip save(PaySlip entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<PaySlip> save(List<PaySlip> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.payroll.PaySlip obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.payroll.PaySlip s = emanager.find(com.app.shared.payroll.PaySlip.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(PaySlip entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<PaySlip> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.payroll.PaySlip obj = entity.get(i);
    ...
    public List<PaySlip> findByEmpId(String empId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.payroll.PaySlip> listOfPaySlip = query.getResultList();
    ...
    public PaySlip findById(String salaryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.payroll.PaySlip listOfPaySlip = (com.app.shared.payroll.PaySlip) query.getSingleResult();
            return listOfPaySlip;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
