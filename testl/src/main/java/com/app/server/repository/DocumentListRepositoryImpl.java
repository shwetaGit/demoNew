...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for DocumentList Transaction table", complexity = Complexity.MEDIUM)
public class DocumentListRepositoryImpl extends SearchInterfaceImpl implements DocumentListRepository<DocumentList> {
    ...
    public List<DocumentList> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.documentmanager.DocumentList> query = emanager.createQuery("select u from DocumentList u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public DocumentList save(DocumentList entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<DocumentList> save(List<DocumentList> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.documentmanager.DocumentList obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.documentmanager.DocumentList s = emanager.find(com.app.shared.documentmanager.DocumentList.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(DocumentList entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<DocumentList> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.documentmanager.DocumentList obj = entity.get(i);
    ...
    public List<DocumentList> findByDocTypeCode(String docTypeCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.documentmanager.DocumentList> listOfDocumentList = query.getResultList();
    ...
    public DocumentList findById(String docId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.documentmanager.DocumentList listOfDocumentList = (com.app.shared.documentmanager.DocumentList) query.getSingleResult();
            return listOfDocumentList;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
