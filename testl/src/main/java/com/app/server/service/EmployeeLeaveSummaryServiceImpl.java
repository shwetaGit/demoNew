...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Service for EmployeeLeaveSummary Transaction table", complexity = Complexity.MEDIUM)
...
public class EmployeeLeaveSummaryServiceImpl extends EmployeeLeaveSummaryService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.attendance.EmployeeLeaveSummary> lstemployeeleavesummary = employeeLeaveSummaryrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByEmpId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.app.shared.attendance.EmployeeLeaveSummary> lstemployeeleavesummary = employeeLeaveSummaryrepo.findByEmpId((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstemployeeleavesummary);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.attendance.EmployeeLeaveSummary lstemployeeleavesummary = employeeLeaveSummaryrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstemployeeleavesummary);
        } catch (org.springframework.transaction.TransactionException e) {
