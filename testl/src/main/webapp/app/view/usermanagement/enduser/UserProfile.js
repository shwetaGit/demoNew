Ext.define('Testl.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Testl.view.usermanagement.enduser.UserProfileController', 'Testl.view.usermanagement.admin.AddUserDetailsViewModel', 'Testl.model.AddUserDataModel' ],
