...
Ext.define('Testl.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Testl.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Testl.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
