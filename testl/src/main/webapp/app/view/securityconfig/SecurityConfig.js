 ...
 * 
 */
Ext.define('Testl.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testl.view.securityconfig.SecurityConfigController',
			'Testl.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
