Ext.define("Testl.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Testl.view.clouddrive.CloudDriveController',
	             'Testl.view.clouddrive.documentview.DocumentsView',
	             'Testl.view.clouddrive.drivedetails.DriveDetails',
	             //'Testl.view.clouddrive.documentview.DocumentListView'
	             ],
