Ext.define('Testl.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testl.view.searchengine.search.NorthPanel', 'Testl.view.searchengine.search.SearchResult','Testl.view.searchengine.search.SearchEngineMainPanelController'],
