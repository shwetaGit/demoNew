Ext
		.define(
				'Testl.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testl.view.searchengine.search.SearchEngineMainPanelController','Testl.view.searchengine.search.PanelHeaderField' ,'Testl.view.searchengine.search.ReportGridView','Testl.view.searchengine.search.ReportChartView','Testl.view.searchengine.search.documentView','Testl.view.searchengine.search.DouMeanView','Testl.view.googlemaps.map.MapPanel'],
