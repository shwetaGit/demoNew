 ...
 * 
 */
Ext.define('Testl.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testl.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
