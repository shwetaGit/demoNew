 ...
 * 
 */
Ext.define('Testl.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Testl.view.logalarm.LogAlarmMainViewController',
			'Testl.view.logalarm.tree.LogAlarmTreePanel',
			'Testl.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
