 ...
 * 
 */
Ext.define('Testl.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testl.view.logalarm.mainscreen.AddLogAlarmController',
			'Testl.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testl.view.logalarm.mainscreen.AppAlarmPanel',
