Ext.define('Testl.testl.web.com.controller.organizationboundedcontext.contacts.CommunicationGroupMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#CommunicationGroup');
