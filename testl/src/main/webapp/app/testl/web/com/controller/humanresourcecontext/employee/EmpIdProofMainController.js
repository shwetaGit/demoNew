Ext.define('Testl.testl.web.com.controller.humanresourcecontext.employee.EmpIdProofMainController', {
     extend: 'Testl.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.EmpIdProofMainController',
     init: function() {
          var form = this.view.down('#EmpIdProof');
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#EmpIdProof');
