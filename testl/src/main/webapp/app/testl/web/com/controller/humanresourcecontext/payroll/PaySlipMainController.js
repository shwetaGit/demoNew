Ext.define('Testl.testl.web.com.controller.humanresourcecontext.payroll.PaySlipMainController', {
     extend: 'Testl.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.PaySlipMainController',
     init: function() {
          var form = this.view.down('#PaySlip');
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#PaySlip');
