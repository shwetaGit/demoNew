Ext.define('Testl.testl.web.com.controller.humanresourcecontext.backgroundcheck.CertificateTypeMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#CertificateType');
