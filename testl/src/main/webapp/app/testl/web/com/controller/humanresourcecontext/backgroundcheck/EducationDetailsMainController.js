Ext.define('Testl.testl.web.com.controller.humanresourcecontext.backgroundcheck.EducationDetailsMainController', {
     extend: 'Testl.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.EducationDetailsMainController',
     init: function() {
          var form = this.view.down('#EducationDetailsForm');
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#EducationDetailsForm');
