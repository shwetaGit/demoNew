Ext.define('Testl.testl.web.com.controller.humanresourcecontext.backgroundcheck.WorkExperienceMainController', {
     extend: 'Testl.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.WorkExperienceMainController',
     init: function() {
          var form = this.view.down('#WorkExperienceForm');
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#WorkExperienceForm');
