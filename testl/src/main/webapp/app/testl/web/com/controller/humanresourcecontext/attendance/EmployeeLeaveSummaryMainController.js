Ext.define('Testl.testl.web.com.controller.humanresourcecontext.attendance.EmployeeLeaveSummaryMainController', {
     ...
     init: function() {
          var form = this.view.down('#EmployeeLeaveSummary');
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#EmployeeLeaveSummary');
