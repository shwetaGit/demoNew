Ext.define('Testl.testl.web.com.controller.humanresourcecontext.employee.EmpInformationMainController', {
     extend: 'Testl.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.EmpInformationMainController',
     init: function() {
          var form = this.view.down('#EmpInformationForm');
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#EmpInformationForm');
