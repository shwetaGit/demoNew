Ext.define('Testl.testl.web.com.controller.humanresourcecontext.attendance.AttendenceSummaryMainController', {
     extend: 'Testl.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.AttendenceSummaryMainController',
     init: function() {
          var form = this.view.down('#AttendenceSummary');
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#AttendenceSummary');
