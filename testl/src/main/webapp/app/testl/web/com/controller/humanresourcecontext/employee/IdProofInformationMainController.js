Ext.define('Testl.testl.web.com.controller.humanresourcecontext.employee.IdProofInformationMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#IdProofInformation');
