Ext.define('Testl.testl.web.com.controller.humanresourcecontext.backgroundcheck.CertificationDetailsMainController', {
     extend: 'Testl.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.CertificationDetailsMainController',
     init: function() {
          var form = this.view.down('#CertificationDetailsForm');
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#CertificationDetailsForm');
     ...
     addDocumentList: function(but) {
          var formDocumentList = but.up().down('form');
          var gridDocumentList = but.up().up().down('#DocumentListGrid');
          if (formDocumentList.isValid()) {
               var values = this.getData(formDocumentList);
               values = values[gridDocumentList.bindable];
               ...
               if (!duplicateRecordFound) {
                    gridDocumentList.getStore().add(values);
               }
