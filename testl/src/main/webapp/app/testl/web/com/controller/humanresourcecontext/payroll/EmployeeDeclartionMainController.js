Ext.define('Testl.testl.web.com.controller.humanresourcecontext.payroll.EmployeeDeclartionMainController', {
     extend: 'Testl.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.EmployeeDeclartionMainController',
     init: function() {
          var form = this.view.down('#EmployeeDeclartion');
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#EmployeeDeclartion');
