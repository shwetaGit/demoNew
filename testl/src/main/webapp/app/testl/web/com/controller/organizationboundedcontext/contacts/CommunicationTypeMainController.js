Ext.define('Testl.testl.web.com.controller.organizationboundedcontext.contacts.CommunicationTypeMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#CommunicationType');
