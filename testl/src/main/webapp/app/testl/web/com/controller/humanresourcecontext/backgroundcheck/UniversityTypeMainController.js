Ext.define('Testl.testl.web.com.controller.humanresourcecontext.backgroundcheck.UniversityTypeMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#UniversityType');
