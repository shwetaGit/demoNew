Ext.define('Testl.testl.web.com.controller.humanresourcecontext.payroll.CostToCompanyMainController', {
     extend: 'Testl.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.CostToCompanyMainController',
     init: function() {
          var form = this.view.down('#CostToCompany');
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#CostToCompany');
