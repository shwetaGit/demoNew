Ext.define('Testl.testl.web.com.controller.humanresourcecontext.attendance.LeaveRequestMainController', {
     extend: 'Testl.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.LeaveRequestMainController',
     init: function() {
          var form = this.view.down('#LeaveRequest');
     ...
     refreshMainForm: function(but, data, method) {
          ...
          var formPanel = this.view.down('#LeaveRequest');
