...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionIcon("bPvY7ycbvkUWxxvSU85U2wBFrVM29GMbQmNmjpHuKDhjvMxq26");
        question.setLevelid(3);
        question.setQuestionDetails("KqVmpA82Mj");
        question.setQuestion("0hQwQrqtBe2NPM9VCrl00RviyOmJ9YCV9PArX4k7sGCYQ4mvwf");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("mHSAU5pfmEeLwDUwhMditq1ixV3kNxgyvQfF0vvlneVU9WrIb0");
            question.setVersionId(1);
            question.setLevelid(1);
            question.setQuestionDetails("tDaPPFcbDU");
            question.setQuestion("G7zRWmHehqQKE1PvisQsYR9nfypPktHsfECio6dM7EgA2UYeEI");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "grWwwNrDtXHuc0GZidrutPVFHZlr8sWo5ojtWo2N3yKOmGowtNgjp46XCU1X93kgH"));
