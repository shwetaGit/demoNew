...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccessdomain.setDomainIcon("6MeCW7ztU36EdRHSWwtNdjCPgDDwxVnhkzNGLdz9r4avU1x5sp");
        useraccessdomain.setDomainName("i564KKiShZOreFKG4fDjVnqoM8ACvtZWWnB6w9FeKZIEWrEfav");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainHelp("3k96rlmoighGZ73kAFsFyx1mIF4y8iavVYcgJMhWTJI0wCdXDW");
        useraccessdomain.setDomainDescription("ZpxHtnEbaARb8ay4vkg7JmyS0YjeRgm6HfRL0bdzObpkZtXV2O");
        ...
        useraccesslevel.setLevelHelp("48IqTXblgAEXCcI1ic5gSaUuMFY4KaUCrDgZTdfzHeqrdBqODg");
        useraccesslevel.setLevelDescription("PGTb81OzaLSl5P28gMdHCuQcvhVCzoejxKoZIaLzkjUFtGbtQe");
        useraccesslevel.setLevelIcon("f3TJYyazxaNldioPEPD8FVh5jH1ruCpjeW8EMrBu05wYtwOzrM");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelName("1wgc2hlsv6gSy9R6VOtP63jp7a0xQN6k4oBSzrpzPA1Hu7Is8P");
        ...
        User user = new User();
        user.setPasswordAlgo("r8WOTePHn9PRMr1XMoLDbhm7XlvwblXF1FmyC1PxiCC9vpueBW");
        user.setUserAccessCode(29710);
        user.setIsDeleted(1);
        user.setGenTempOneTimePassword(1);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setSessionTimeout(615);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1463133505184l));
        user.setAllowMultipleLogin(1);
        user.setMultiFactorAuthEnabled(1);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1463133505184l));
        user.setIsLocked(1);
        ...
        question.setQuestionIcon("Zp6vrRzBw8GgYxwyEzeYuh0pEpShAfEjg4mYDZ1k6qWK0lgAlL");
        question.setLevelid(4);
        question.setQuestionDetails("q4rDYAsRyN");
        question.setQuestion("vmq5hGzn1grOsVjopM9bLXxa9DG5JRAz6Jti6otxUQohxJsdVd");
        ...
        passrecovery.setAnswer("Rti427OpKgTdNMWElXJyiF9PXarwcnbBWz73SDNHneClw2pWba");
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setPassword("2ZPjqe2FsVXXJ6r6vm6UDjijYMuceF6WTehCwFy7Xm7DQBmwyb");
        userdata.setOneTimePasswordExpiry(2);
        userdata.setOneTimePassword("SDcYviZCe9BGYLCQCFB0fnoFMtFyPAWP");
        userdata.setPassword("btbHRpFdtTkB4aZrXhPKdtJiI49ZVWluouGS1a51eisgqIj9Ls");
        userdata.setOneTimePasswordExpiry(11);
        userdata.setOneTimePassword("l2rfCXUi5FeG4E3U1m7GUuKyPR4koQP4");
        userdata.setUser(user);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1463133505416l));
        userdata.setLast5Passwords("zrHn3UBuSHOUV3pfaDJOlO906d0o82KjRE7ZaTOPzGmjC5TTCa");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 89754));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "vEwRAH5qWWG7trtWthsqebUjbeGNgBPNlkMJXRjhZUKSWKK4lmHfCdV4n3YFNCXBg"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 3787));
