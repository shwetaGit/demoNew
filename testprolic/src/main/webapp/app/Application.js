 ...
 */
Ext.define('Testprolic.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Testprolic.view.databrowsercalendar.DBCalendar"],
	...
	stores : [ 'Testprolic.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Testprolic.view.login.SessionLogin').center();
