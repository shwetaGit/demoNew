Ext.define('Testprolic.testprolic.web.com.controller.appinsight.health.TestBMainController', {
     extend: 'Testprolic.view.fw.frameworkController.AggregateViewController',
     ...
     renderTreeGridData: function(responseData) {
          ...
          if (responseData.response.success) {
               ...
               var compRef = this.view.down('#TestBTree');
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, opts) {
                    ...
                    var compRef = currentView.down('#TestBTree');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          ...
          if (record.data.leaf) {
               var TestB = this.view.down('#TestBForm');
               TestB.reset();
               var gridPanel = this.view.down('#TestBGrid');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#TestB').down('#' + me.column.dataIndex + '').store;
