 ...
 * 
 */
Ext.define('Testprolic.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Testprolic.view.logalarm.LogAlarmMainViewController',
			'Testprolic.view.logalarm.tree.LogAlarmTreePanel',
			'Testprolic.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
