 ...
 * 
 */
Ext.define('Testprolic.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testprolic.view.logalarm.mainscreen.AddLogAlarmController',
			'Testprolic.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testprolic.view.logalarm.mainscreen.AppAlarmPanel',
