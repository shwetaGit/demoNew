...
Ext
		.define(
				'Testprolic.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testprolic.view.logger.tabs.details.DetailsTab',
							'Testprolic.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testprolic.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testprolic.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testprolic.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testprolic.view.logger.LogConfigurationTabPanelController',
