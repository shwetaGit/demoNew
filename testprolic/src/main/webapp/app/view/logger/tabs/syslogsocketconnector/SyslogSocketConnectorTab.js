 ...
 * 
 */
Ext.define('Testprolic.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testprolic.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
