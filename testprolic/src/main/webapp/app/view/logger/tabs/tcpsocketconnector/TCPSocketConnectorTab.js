...
Ext
		.define(
				'Testprolic.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Testprolic.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],
