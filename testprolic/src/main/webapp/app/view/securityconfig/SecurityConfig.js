 ...
 * 
 */
Ext.define('Testprolic.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testprolic.view.securityconfig.SecurityConfigController',
			'Testprolic.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
