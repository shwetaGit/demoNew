Ext.define('Testprolic.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Testprolic.view.usermanagement.enduser.UserProfileController', 'Testprolic.view.usermanagement.admin.AddUserDetailsViewModel', 'Testprolic.model.AddUserDataModel' ],
