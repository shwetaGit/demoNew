Ext.define('Testprolic.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testprolic.view.usermanagement.admin.AddUserDetailsViewModel', 'Testprolic.model.AddUserDataModel' ],
