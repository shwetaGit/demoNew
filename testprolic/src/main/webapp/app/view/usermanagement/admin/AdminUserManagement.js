Ext.define('Testprolic.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testprolic.view.usermanagement.admin.UserPasswordReset',
	            'Testprolic.view.usermanagement.admin.AddUserDetails',
	            'Testprolic.view.usermanagement.admin.ViewUser'],
