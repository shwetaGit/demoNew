 ...
 * 
 */
Ext.define("Testprolic.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Testprolic.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
