 ...
 */
Ext.define('Testprolic.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Testprolic.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Testprolic.view.fw.component.DateTimePicker(o);
    },
