Ext.define('Testprolic.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Testprolic.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Testprolic.view.console.ConsoleWindow');
