Ext.define('Testprolic.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testprolic.view.searchengine.search.NorthPanel', 'Testprolic.view.searchengine.search.SearchResult','Testprolic.view.searchengine.search.SearchEngineMainPanelController'],
