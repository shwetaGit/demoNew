Ext
		.define(
				'Testprolic.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testprolic.view.searchengine.search.SearchEngineMainPanelController','Testprolic.view.searchengine.search.PanelHeaderField' ,'Testprolic.view.searchengine.search.ReportGridView','Testprolic.view.searchengine.search.ReportChartView','Testprolic.view.searchengine.search.documentView','Testprolic.view.searchengine.search.DouMeanView','Testprolic.view.googlemaps.map.MapPanel'],
