...
folder are mapped to the application's root namespace, 'Testprolic'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Testprolic"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Testprolic' in the same way
as `"Testprolic/sass/src"`.
