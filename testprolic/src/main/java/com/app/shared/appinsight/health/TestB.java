...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "TestB", complexity = Complexity.LOW)
@NamedQueries({ @javax.persistence.NamedQuery(name = "TestB.findById", query = "select e from TestB e where e.systemInfo.activeStatus=1 and e.tidd =:tidd") })
public class TestB implements Serializable, CommonEntityInterface, Comparator<TestB> {
    ...
    public void setTnmm(String _tnmm) {
        if (_tnmm != null) {
            this.tnmm = _tnmm;
        }
    }
    ...
    public void setTidd(String _tidd) {
        this.tidd = _tidd;
    }
    ...
    public boolean equals(Object obj) {
        try {
            ...
            if (tidd == null) {
                return false;
            } else if (!tidd.equals(other.tidd)) {
                return false;
            }
