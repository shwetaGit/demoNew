...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "root", versionNumber = "4", comments = "TestA", complexity = Complexity.LOW)
@NamedQueries({ @javax.persistence.NamedQuery(name = "TestA.findById", query = "select e from TestA e where e.systemInfo.activeStatus=1 and e.tstid =:tstid") })
public class TestA implements Serializable, CommonEntityInterface, Comparator<TestA> {
    ...
    public void setTstid(String _tstid) {
        this.tstid = _tstid;
    }
    ...
    public boolean equals(Object obj) {
        try {
            ...
            if (tstid == null) {
                return false;
            } else if (!tstid.equals(other.tstid)) {
                return false;
            }
