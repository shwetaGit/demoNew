...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("l6mv23O7lqcMb7oQaZdRpQFrmiI9UR4HP4H3KK8PQzcPRAjhH5");
            question.setQuestionDetails("0");
            question.setLevelid(3);
            question.setQuestionIcon("e9I4DEguuzOLf4gvISWpUbP39dx0MXjsKfGkgYdS3h1beTGgPQ");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("3CWlKcd62twkkYKwoN6VzxNPTsC3eRREWVUa0fkANRBrxyWJam");
            question.setQuestionDetails("0");
            question.setLevelid(9);
            question.setQuestionIcon("aVScl9THh3l7ZEGAz6RA5voFdotF2reUJMFbfJoM7PFwrrqrnZ");
