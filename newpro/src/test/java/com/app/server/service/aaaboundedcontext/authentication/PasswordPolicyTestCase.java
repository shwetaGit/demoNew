...
public class PasswordPolicyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            passwordpolicy.setPolicyDescription("Ol2KnKGKkqBiCUTnNDbD1qwrqhUAzg41a7qzP73k1TEL13gXO9");
            passwordpolicy.setMaxPwdLength(4);
            passwordpolicy.setPolicyName("xxzJpIie5IEsnUKifz0XQIOHDewCjSBeYffXXHpBNYk8dvoEde");
            passwordpolicy.setMinPwdLength(6);
            passwordpolicy.setMinNumericValues(2);
            passwordpolicy.setAllowedSpecialLetters("HfJPxME57jbderMdiNpqHczauoU1ZRQYecbqKyAGzdfliYRhpy");
    ...
    public void test2Update() {
        try {
            ...
            passwordpolicy.setPolicyDescription("VQgrpUNYrHlgEnyyzy5IdYetJ47XbHHgytMn3VYTFEKQ9RvlTu");
            passwordpolicy.setMaxPwdLength(11);
            passwordpolicy.setPolicyName("iaRQCurv7L5BMIb2Hx8WdeNHyxECwE8F3O7stkVqoAxNvPIrnn");
            passwordpolicy.setMinPwdLength(7);
            passwordpolicy.setMinNumericValues(7);
            passwordpolicy.setVersionId(1);
            passwordpolicy.setAllowedSpecialLetters("e9HR5B14IKq4T07NbP33B1sLTFXfM29VlFTFIF73J3JRAwYggI");
