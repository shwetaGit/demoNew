...
public class ServicetestingAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.app.server.service.testbc.testing..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.testbc.testing..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
