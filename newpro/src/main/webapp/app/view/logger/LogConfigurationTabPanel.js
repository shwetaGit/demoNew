...
Ext
		.define(
				'Newpro.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Newpro.view.logger.tabs.details.DetailsTab',
							'Newpro.view.logger.tabs.fileconnector.FileConnectorTab',
							'Newpro.view.logger.tabs.dbconnector.DBConnectorTab',
							'Newpro.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Newpro.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Newpro.view.logger.LogConfigurationTabPanelController',
