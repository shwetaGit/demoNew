 ...
 * 
 */
Ext.define('Newpro.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Newpro.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
