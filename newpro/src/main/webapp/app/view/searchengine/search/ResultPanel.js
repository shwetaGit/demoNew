Ext
		.define(
				'Newpro.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Newpro.view.searchengine.search.SearchEngineMainPanelController','Newpro.view.searchengine.search.PanelHeaderField' ,'Newpro.view.searchengine.search.ReportGridView','Newpro.view.searchengine.search.ReportChartView','Newpro.view.searchengine.search.documentView','Newpro.view.searchengine.search.DouMeanView','Newpro.view.googlemaps.map.MapPanel'],
