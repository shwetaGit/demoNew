 ...
 * 
 */
Ext.define('Newpro.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Newpro.view.securityconfig.SecurityConfigController',
			'Newpro.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
