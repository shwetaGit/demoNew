Ext.define("Newpro.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Newpro.view.clouddrive.CloudDriveController',
	             'Newpro.view.clouddrive.documentview.DocumentsView',
	             'Newpro.view.clouddrive.drivedetails.DriveDetails',
	             //'Newpro.view.clouddrive.documentview.DocumentListView'
	             ],
