Ext.define('Newpro.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Newpro.view.usermanagement.admin.UserPasswordReset',
	            'Newpro.view.usermanagement.admin.AddUserDetails',
	            'Newpro.view.usermanagement.admin.ViewUser'],
