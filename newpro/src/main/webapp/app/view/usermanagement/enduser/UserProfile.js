Ext.define('Newpro.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Newpro.view.usermanagement.enduser.UserProfileController', 'Newpro.view.usermanagement.admin.AddUserDetailsViewModel', 'Newpro.model.AddUserDataModel' ],
