Ext.define('Newpro.newpro.web.com.controller.testbc.testing.TestEntityMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#TestEntityForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#TestEntityForm');
          var grid = this.view.down('#TestEntityGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#TestEntityForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#TestEntityForm').down('#' + me.column.dataIndex + '').store;
