 ...
 * 
 */
Ext.define('Testbp.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testbp.view.logalarm.mainscreen.AddLogAlarmController',
			'Testbp.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testbp.view.logalarm.mainscreen.AppAlarmPanel',
