Ext.define('Testbp.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testbp.view.usermanagement.admin.UserPasswordReset',
	            'Testbp.view.usermanagement.admin.AddUserDetails',
	            'Testbp.view.usermanagement.admin.ViewUser'],
