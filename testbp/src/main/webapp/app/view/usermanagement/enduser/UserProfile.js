Ext.define('Testbp.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Testbp.view.usermanagement.enduser.UserProfileController', 'Testbp.view.usermanagement.admin.AddUserDetailsViewModel', 'Testbp.model.AddUserDataModel' ],
