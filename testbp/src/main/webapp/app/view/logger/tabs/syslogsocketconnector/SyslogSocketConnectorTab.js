 ...
 * 
 */
Ext.define('Testbp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testbp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
