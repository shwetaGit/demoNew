Ext.define('Testbp.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testbp.view.searchengine.search.NorthPanel', 'Testbp.view.searchengine.search.SearchResult','Testbp.view.searchengine.search.SearchEngineMainPanelController'],
