Ext
		.define(
				'Testbp.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testbp.view.searchengine.search.SearchEngineMainPanelController','Testbp.view.searchengine.search.PanelHeaderField' ,'Testbp.view.searchengine.search.ReportGridView','Testbp.view.searchengine.search.ReportChartView','Testbp.view.searchengine.search.documentView','Testbp.view.searchengine.search.DouMeanView','Testbp.view.googlemaps.map.MapPanel'],
