Ext.define('Testbp.view.desktop.design.drawer.main.MainPanelController', {
    ...
    loadLangCombo : function(){
     ...
     onSearchClick : function(searchBtn){
        ...
        var searchView = this.pushViewInMainTab("Testbp.view.searchengine.search.SearchEngineMainPanel","Search Result","isSearchCmp","true");
