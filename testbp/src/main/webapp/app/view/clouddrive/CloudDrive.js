Ext.define("Testbp.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Testbp.view.clouddrive.CloudDriveController',
	             'Testbp.view.clouddrive.documentview.DocumentsView',
	             'Testbp.view.clouddrive.drivedetails.DriveDetails',
	             //'Testbp.view.clouddrive.documentview.DocumentListView'
	             ],
