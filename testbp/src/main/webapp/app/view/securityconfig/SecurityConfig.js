 ...
 * 
 */
Ext.define('Testbp.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testbp.view.securityconfig.SecurityConfigController',
			'Testbp.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
