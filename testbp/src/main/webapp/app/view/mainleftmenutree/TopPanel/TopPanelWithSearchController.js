Ext.define('Testbp.view.mainleftmenutree.TopPanel.TopPanelController', {
	...
	doVoiceSearch:function(btn){
		...
		if(searchTab.length==0){
			 component = Ext.create(
					"Testbp.view.searchengine.search.SearchEngineMainPanel", {
						closable : true,
						title : "Search Engine",
						refId : "-1",
						isSearchCmp:true
	...
	onCloudClick : function()
	{
		var component = Ext.create(
				"Testbp.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					menuId:'cloudtab'
				});
	...
	{
		var component = Ext.create(
				"Testbp.view.usermanagement.enduser.UserProfile", {
					closable : true,
					title : "My Profile",
					menuId:'myprofiletab'
				});
	...
	{
		var component = Ext.create(
				"Testbp.view.usermanagement.enduser.ChangePwd", {
					closable : true,
