package com.app.server.businessservice.appinsight.alarms.aspect;
...
public class BusinessServicealarmsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.appinsight.alarms..*(..)) && !alarmOperation()")
    protected void allOperation() {
    }

    @Pointcut("execution(* com.app.server.businessservice.appinsight.alarms.AppLogAlarmGenerationBizService..*(..))")
