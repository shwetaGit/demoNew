...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionDetails("5zvmvJxl3d");
        question.setQuestionIcon("0L1iJNkm8ARqsdt8XJ1UuJq5SRm9bNlj2ugf5e0aUQhqIf7Itl");
        question.setQuestion("FmoLxQ9E5TopU1EiR4754nBbVNgiiKGA4OGjsVEbAK3EOuzNB1");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("UhmJj4jY3e");
            question.setQuestionIcon("Km2M5juLB0FV1nHJ1g7UZQ3d7cBr2kvMdiN4QTwgDixDX2dmf9");
            question.setVersionId(1);
            question.setQuestion("shQviC1rZBtC52Bmj4hUhOKpKJCfMb7OrdZMEhlUXbkw2Rp0xv");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "PtwoiJO2OYBpkSG20Na8Xt61wKOXoOdsbtpH6sm5ne2FOuNyfukTf1E1JgmOVXoWJ"));
