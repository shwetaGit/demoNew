Ext
		.define(
				'Issuetracker.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Issuetracker.view.searchengine.search.documentController',
							'Issuetracker.view.searchengine.search.RowExpander' ],
