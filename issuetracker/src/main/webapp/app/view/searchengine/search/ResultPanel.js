Ext
		.define(
				'Issuetracker.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Issuetracker.view.searchengine.search.SearchEngineMainPanelController','Issuetracker.view.searchengine.search.PanelHeaderField' ,'Issuetracker.view.searchengine.search.ReportGridView','Issuetracker.view.searchengine.search.ReportChartView','Issuetracker.view.searchengine.search.documentView','Issuetracker.view.searchengine.search.DouMeanView','Issuetracker.view.googlemaps.map.MapPanel'],
