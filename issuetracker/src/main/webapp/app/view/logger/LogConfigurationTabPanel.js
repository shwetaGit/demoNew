...
Ext
		.define(
				'Issuetracker.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Issuetracker.view.logger.tabs.details.DetailsTab',
							'Issuetracker.view.logger.tabs.fileconnector.FileConnectorTab',
							'Issuetracker.view.logger.tabs.dbconnector.DBConnectorTab',
							'Issuetracker.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Issuetracker.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Issuetracker.view.logger.LogConfigurationTabPanelController',
