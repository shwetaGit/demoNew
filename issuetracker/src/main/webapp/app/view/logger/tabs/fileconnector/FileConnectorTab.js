 ...
 * 
 */
Ext.define('Issuetracker.view.logger.tabs.fileconnector.FileConnectorTab', {
	...
	requires : ['Issuetracker.view.logger.tabs.fileconnector.FileConnectorTabController'],
