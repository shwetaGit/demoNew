 ...
 * 
 */
Ext.define('Issuetracker.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Issuetracker.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
