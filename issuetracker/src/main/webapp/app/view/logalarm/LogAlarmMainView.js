 ...
 * 
 */
Ext.define('Issuetracker.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Issuetracker.view.logalarm.LogAlarmMainViewController',
			'Issuetracker.view.logalarm.tree.LogAlarmTreePanel',
			'Issuetracker.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
