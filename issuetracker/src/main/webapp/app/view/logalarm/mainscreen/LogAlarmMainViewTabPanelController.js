 ...
 * 
 */
Ext.define('Issuetracker.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	init : function()
	{
		...
		var component = Ext.create("Issuetracker.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
