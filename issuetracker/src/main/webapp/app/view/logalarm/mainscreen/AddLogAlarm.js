 ...
 * 
 */
Ext.define('Issuetracker.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Issuetracker.view.logalarm.mainscreen.AddLogAlarmController',
			'Issuetracker.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Issuetracker.view.logalarm.mainscreen.AppAlarmPanel',
