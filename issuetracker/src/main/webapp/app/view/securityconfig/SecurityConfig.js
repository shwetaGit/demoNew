 ...
 * 
 */
Ext.define('Issuetracker.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Issuetracker.view.securityconfig.SecurityConfigController',
			'Issuetracker.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
