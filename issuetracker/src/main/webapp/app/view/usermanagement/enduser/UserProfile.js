Ext.define('Issuetracker.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Issuetracker.view.usermanagement.enduser.UserProfileController', 'Issuetracker.view.usermanagement.admin.AddUserDetailsViewModel', 'Issuetracker.model.AddUserDataModel' ],
