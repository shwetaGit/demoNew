...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "shweta.zagade@algorhythm.co.in", versionNumber = "3", comments = "AddWatchers", complexity = Complexity.LOW)
public class AddWatchers implements Serializable, CommonEntityInterface, Comparator<AddWatchers> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.issuetrackerboundedcontext.issuetracker.AddWatchers other = (com.app.shared.issuetrackerboundedcontext.issuetracker.AddWatchers) obj;
            if (watchId == null) {
                return false;
