...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "RoleUserMapping", complexity = Complexity.LOW)
...
public class RoleUserMapping implements Serializable, CommonEntityInterface, Comparator<RoleUserMapping> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.issuetrackerboundedcontext.projectmanager.RoleUserMapping other = (com.app.shared.issuetrackerboundedcontext.projectmanager.RoleUserMapping) obj;
            if (roleUserId == null) {
                return false;
