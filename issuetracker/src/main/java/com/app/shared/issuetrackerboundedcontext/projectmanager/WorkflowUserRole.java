...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "WorkflowUserRole", complexity = Complexity.LOW)
...
public class WorkflowUserRole implements Serializable, CommonEntityInterface, Comparator<WorkflowUserRole> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.issuetrackerboundedcontext.projectmanager.WorkflowUserRole other = (com.app.shared.issuetrackerboundedcontext.projectmanager.WorkflowUserRole) obj;
            if (workUserRoleId == null) {
                return false;
