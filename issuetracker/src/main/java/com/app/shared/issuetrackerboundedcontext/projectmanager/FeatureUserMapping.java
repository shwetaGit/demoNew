...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "shweta.zagade@algorhythm.co.in", versionNumber = "3", comments = "FeatureUserMapping", complexity = Complexity.LOW)
...
public class FeatureUserMapping implements Serializable, CommonEntityInterface, Comparator<FeatureUserMapping> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.issuetrackerboundedcontext.projectmanager.FeatureUserMapping other = (com.app.shared.issuetrackerboundedcontext.projectmanager.FeatureUserMapping) obj;
            if (feaUserId == null) {
                return false;
