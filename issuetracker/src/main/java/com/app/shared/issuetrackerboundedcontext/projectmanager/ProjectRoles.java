...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "ProjectRoles", complexity = Complexity.LOW)
...
public class ProjectRoles implements Serializable, CommonEntityInterface, Comparator<ProjectRoles> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.issuetrackerboundedcontext.projectmanager.ProjectRoles other = (com.app.shared.issuetrackerboundedcontext.projectmanager.ProjectRoles) obj;
            if (prjRoleId == null) {
                return false;
