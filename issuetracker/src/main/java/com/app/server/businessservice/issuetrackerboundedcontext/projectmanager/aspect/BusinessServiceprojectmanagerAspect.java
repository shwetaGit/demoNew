package com.app.server.businessservice.issuetrackerboundedcontext.projectmanager.aspect;
...
public class BusinessServiceprojectmanagerAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.issuetrackerboundedcontext.projectmanager..*(..))")
