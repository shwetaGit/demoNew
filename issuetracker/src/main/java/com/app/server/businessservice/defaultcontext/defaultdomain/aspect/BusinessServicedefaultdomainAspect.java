package com.app.server.businessservice.defaultcontext.defaultdomain.aspect;
...
public class BusinessServicedefaultdomainAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.defaultcontext.defaultdomain..*(..))")
