package com.app.server.businessservice.issuetrackerboundedcontext.issuetracker.aspect;
...
public class BusinessServiceissuetrackerAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.issuetrackerboundedcontext.issuetracker..*(..))")
