...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for FeatureCategory Master table Entity", complexity = Complexity.LOW)
public class FeatureCategoryRepositoryImpl extends SearchInterfaceImpl implements FeatureCategoryRepository<FeatureCategory> {
    ...
    public List<FeatureCategory> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory> query = emanager.createQuery("select u from FeatureCategory u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<FeatureCategory> save(List<FeatureCategory> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory s = emanager.find(com.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public FeatureCategory findById(String featureCategoryCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory listOfFeatureCategory = (com.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory) query.getSingleResult();
