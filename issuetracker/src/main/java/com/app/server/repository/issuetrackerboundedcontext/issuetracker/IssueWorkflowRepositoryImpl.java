...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for IssueWorkflow Transaction table", complexity = Complexity.MEDIUM)
public class IssueWorkflowRepositoryImpl extends SearchInterfaceImpl implements IssueWorkflowRepository<IssueWorkflow> {
    ...
    public List<IssueWorkflow> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.issuetrackerboundedcontext.issuetracker.IssueWorkflow> query = emanager.createQuery("select u from IssueWorkflow u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<IssueWorkflow> save(List<IssueWorkflow> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.issuetrackerboundedcontext.issuetracker.IssueWorkflow obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.issuetrackerboundedcontext.issuetracker.IssueWorkflow s = emanager.find(com.app.shared.issuetrackerboundedcontext.issuetracker.IssueWorkflow.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public void deleteAddWatchers(List<AddWatchers> addwatchers) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (com.app.shared.issuetrackerboundedcontext.issuetracker.AddWatchers _addwatchers : addwatchers) {
                com.app.shared.issuetrackerboundedcontext.issuetracker.AddWatchers s = emanager.find(com.app.shared.issuetrackerboundedcontext.issuetracker.AddWatchers.class, _addwatchers.getWatchId());
                emanager.remove(s);
            }
        } catch (javax.persistence.PersistenceException e) {
            throw new SpartanPersistenceException("Error in deleting entity", e);
    ...
    public List<IssueWorkflow> findByCreatorContactId(String creatorContactId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.issuetrackerboundedcontext.issuetracker.IssueWorkflow> listOfIssueWorkflow = query.getResultList();
    ...
    public IssueWorkflow findById(String issueId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.issuetrackerboundedcontext.issuetracker.IssueWorkflow listOfIssueWorkflow = (com.app.shared.issuetrackerboundedcontext.issuetracker.IssueWorkflow) query.getSingleResult();
            return listOfIssueWorkflow;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
