package com.app.server.repository.issuetrackerboundedcontext.issuetracker.aspect;
...
public class RepositoryissuetrackerAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.app.server.repository.issuetrackerboundedcontext.issuetracker..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.issuetrackerboundedcontext.issuetracker..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.issuetrackerboundedcontext.issuetracker..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.issuetrackerboundedcontext.issuetracker..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.issuetrackerboundedcontext.issuetracker..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.issuetrackerboundedcontext.issuetracker..*(..))")
