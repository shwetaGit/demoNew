...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for Workflow Master table Entity", complexity = Complexity.LOW)
public class WorkflowRepositoryImpl extends SearchInterfaceImpl implements WorkflowRepository<Workflow> {
    ...
    public List<Workflow> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.issuetrackerboundedcontext.projectmanager.Workflow> query = emanager.createQuery("select u from Workflow u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Workflow> save(List<Workflow> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.issuetrackerboundedcontext.projectmanager.Workflow obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.issuetrackerboundedcontext.projectmanager.Workflow s = emanager.find(com.app.shared.issuetrackerboundedcontext.projectmanager.Workflow.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Workflow findById(String workflowId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.issuetrackerboundedcontext.projectmanager.Workflow listOfWorkflow = (com.app.shared.issuetrackerboundedcontext.projectmanager.Workflow) query.getSingleResult();
