...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for IssueFlag Master table Entity", complexity = Complexity.LOW)
public class IssueFlagRepositoryImpl extends SearchInterfaceImpl implements IssueFlagRepository<IssueFlag> {
    ...
    public List<IssueFlag> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.issuetrackerboundedcontext.issuetracker.IssueFlag> query = emanager.createQuery("select u from IssueFlag u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<IssueFlag> save(List<IssueFlag> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.issuetrackerboundedcontext.issuetracker.IssueFlag obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.issuetrackerboundedcontext.issuetracker.IssueFlag s = emanager.find(com.app.shared.issuetrackerboundedcontext.issuetracker.IssueFlag.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public IssueFlag findById(String issueFlagCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.issuetrackerboundedcontext.issuetracker.IssueFlag listOfIssueFlag = (com.app.shared.issuetrackerboundedcontext.issuetracker.IssueFlag) query.getSingleResult();
