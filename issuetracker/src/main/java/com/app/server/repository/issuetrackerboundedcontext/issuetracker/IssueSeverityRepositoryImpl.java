...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for IssueSeverity Master table Entity", complexity = Complexity.LOW)
public class IssueSeverityRepositoryImpl extends SearchInterfaceImpl implements IssueSeverityRepository<IssueSeverity> {
    ...
    public List<IssueSeverity> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.issuetrackerboundedcontext.issuetracker.IssueSeverity> query = emanager.createQuery("select u from IssueSeverity u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<IssueSeverity> save(List<IssueSeverity> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.issuetrackerboundedcontext.issuetracker.IssueSeverity obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.issuetrackerboundedcontext.issuetracker.IssueSeverity s = emanager.find(com.app.shared.issuetrackerboundedcontext.issuetracker.IssueSeverity.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public IssueSeverity findById(String issueSeverityCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.issuetrackerboundedcontext.issuetracker.IssueSeverity listOfIssueSeverity = (com.app.shared.issuetrackerboundedcontext.issuetracker.IssueSeverity) query.getSingleResult();
