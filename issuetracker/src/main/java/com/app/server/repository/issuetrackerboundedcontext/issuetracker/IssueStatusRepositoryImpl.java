...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for IssueStatus Master table Entity", complexity = Complexity.LOW)
public class IssueStatusRepositoryImpl extends SearchInterfaceImpl implements IssueStatusRepository<IssueStatus> {
    ...
    public List<IssueStatus> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.issuetrackerboundedcontext.issuetracker.IssueStatus> query = emanager.createQuery("select u from IssueStatus u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<IssueStatus> save(List<IssueStatus> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.issuetrackerboundedcontext.issuetracker.IssueStatus obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.issuetrackerboundedcontext.issuetracker.IssueStatus s = emanager.find(com.app.shared.issuetrackerboundedcontext.issuetracker.IssueStatus.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<IssueStatus> findByIssueStageCode(String issueStageCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.issuetrackerboundedcontext.issuetracker.IssueStatus> listOfIssueStatus = query.getResultList();
    ...
    public IssueStatus findById(String issueStatusCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.issuetrackerboundedcontext.issuetracker.IssueStatus listOfIssueStatus = (com.app.shared.issuetrackerboundedcontext.issuetracker.IssueStatus) query.getSingleResult();
            return listOfIssueStatus;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
