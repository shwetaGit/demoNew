...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for IssuePriority Master table Entity", complexity = Complexity.LOW)
public class IssuePriorityRepositoryImpl extends SearchInterfaceImpl implements IssuePriorityRepository<IssuePriority> {
    ...
    public List<IssuePriority> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.issuetrackerboundedcontext.issuetracker.IssuePriority> query = emanager.createQuery("select u from IssuePriority u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<IssuePriority> save(List<IssuePriority> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.issuetrackerboundedcontext.issuetracker.IssuePriority obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.issuetrackerboundedcontext.issuetracker.IssuePriority s = emanager.find(com.app.shared.issuetrackerboundedcontext.issuetracker.IssuePriority.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public IssuePriority findById(String issuePriorityCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.issuetrackerboundedcontext.issuetracker.IssuePriority listOfIssuePriority = (com.app.shared.issuetrackerboundedcontext.issuetracker.IssuePriority) query.getSingleResult();
