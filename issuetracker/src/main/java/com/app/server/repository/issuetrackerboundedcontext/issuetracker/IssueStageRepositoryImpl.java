...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for IssueStage Master table Entity", complexity = Complexity.LOW)
public class IssueStageRepositoryImpl extends SearchInterfaceImpl implements IssueStageRepository<IssueStage> {
    ...
    public List<IssueStage> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.issuetrackerboundedcontext.issuetracker.IssueStage> query = emanager.createQuery("select u from IssueStage u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<IssueStage> save(List<IssueStage> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.issuetrackerboundedcontext.issuetracker.IssueStage obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.issuetrackerboundedcontext.issuetracker.IssueStage s = emanager.find(com.app.shared.issuetrackerboundedcontext.issuetracker.IssueStage.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public IssueStage findById(String issueStageCode) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.issuetrackerboundedcontext.issuetracker.IssueStage listOfIssueStage = (com.app.shared.issuetrackerboundedcontext.issuetracker.IssueStage) query.getSingleResult();
