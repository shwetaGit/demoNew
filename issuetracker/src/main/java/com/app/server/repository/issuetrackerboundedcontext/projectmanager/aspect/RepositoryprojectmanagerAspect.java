package com.app.server.repository.issuetrackerboundedcontext.projectmanager.aspect;
...
public class RepositoryprojectmanagerAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.app.server.repository.issuetrackerboundedcontext.projectmanager..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.issuetrackerboundedcontext.projectmanager..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.issuetrackerboundedcontext.projectmanager..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.issuetrackerboundedcontext.projectmanager..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.issuetrackerboundedcontext.projectmanager..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.issuetrackerboundedcontext.projectmanager..*(..))")
