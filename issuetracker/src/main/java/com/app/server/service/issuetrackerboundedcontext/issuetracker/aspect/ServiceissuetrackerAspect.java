package com.app.server.service.issuetrackerboundedcontext.issuetracker.aspect;
...
public class ServiceissuetrackerAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.app.server.service.issuetrackerboundedcontext.issuetracker..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.service.issuetrackerboundedcontext.issuetracker..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.service.issuetrackerboundedcontext.issuetracker..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.service.issuetrackerboundedcontext.issuetracker..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.service.issuetrackerboundedcontext.issuetracker..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.issuetrackerboundedcontext.issuetracker..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
