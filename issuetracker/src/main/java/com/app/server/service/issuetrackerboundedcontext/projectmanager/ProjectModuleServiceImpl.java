...
import com.app.server.businessservice.issuetrackerboundedcontext.projectmanager.ProjectModuleBusinessService;
...
public class ProjectModuleServiceImpl extends ProjectModuleService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.issuetrackerboundedcontext.projectmanager.ProjectModule> lstprojectmodule = projectModulerepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByProjectId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.app.shared.issuetrackerboundedcontext.projectmanager.ProjectModule> lstprojectmodule = projectModulerepo.findByProjectId((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstprojectmodule);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.issuetrackerboundedcontext.projectmanager.ProjectModule lstprojectmodule = projectModulerepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstprojectmodule);
        } catch (org.springframework.transaction.TransactionException e) {
