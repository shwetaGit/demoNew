package com.app.server.service.issuetrackerboundedcontext.projectmanager.aspect;
...
public class ServiceprojectmanagerAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.app.server.service.issuetrackerboundedcontext.projectmanager..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.service.issuetrackerboundedcontext.projectmanager..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.service.issuetrackerboundedcontext.projectmanager..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.service.issuetrackerboundedcontext.projectmanager..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.service.issuetrackerboundedcontext.projectmanager..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.issuetrackerboundedcontext.projectmanager..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
