...
import com.app.server.businessservice.issuetrackerboundedcontext.projectmanager.ProjectFeatureBusinessService;
...
public class ProjectFeatureServiceImpl extends ProjectFeatureService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.issuetrackerboundedcontext.projectmanager.ProjectFeature> lstprojectfeature = projectFeaturerepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByModuleId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.app.shared.issuetrackerboundedcontext.projectmanager.ProjectFeature> lstprojectfeature = projectFeaturerepo.findByModuleId((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstprojectfeature);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findByProjectId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.app.shared.issuetrackerboundedcontext.projectmanager.ProjectFeature> lstprojectfeature = projectFeaturerepo.findByProjectId((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstprojectfeature);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.issuetrackerboundedcontext.projectmanager.ProjectFeature lstprojectfeature = projectFeaturerepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstprojectfeature);
        } catch (org.springframework.transaction.TransactionException e) {
