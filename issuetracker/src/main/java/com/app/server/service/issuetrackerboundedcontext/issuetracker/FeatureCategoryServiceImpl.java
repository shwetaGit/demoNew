...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Service for FeatureCategory Master table Entity", complexity = Complexity.LOW)
...
public class FeatureCategoryServiceImpl extends FeatureCategoryService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory> lstfeaturecategory = featureCategoryrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory lstfeaturecategory = featureCategoryrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstfeaturecategory);
        } catch (org.springframework.transaction.TransactionException e) {
