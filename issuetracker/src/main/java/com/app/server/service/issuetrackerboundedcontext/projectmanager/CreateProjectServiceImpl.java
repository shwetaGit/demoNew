...
import com.app.server.businessservice.issuetrackerboundedcontext.projectmanager.CreateProjectBusinessService;
...
public class CreateProjectServiceImpl extends CreateProjectService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.issuetrackerboundedcontext.projectmanager.CreateProject> lstcreateproject = createProjectrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByProjectAccessCode(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.app.shared.issuetrackerboundedcontext.projectmanager.CreateProject> lstcreateproject = createProjectrepo.findByProjectAccessCode((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstcreateproject);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.issuetrackerboundedcontext.projectmanager.CreateProject lstcreateproject = createProjectrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstcreateproject);
        } catch (org.springframework.transaction.TransactionException e) {
