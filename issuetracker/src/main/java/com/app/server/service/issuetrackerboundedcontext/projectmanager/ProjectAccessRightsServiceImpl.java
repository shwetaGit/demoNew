...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Service for ProjectAccessRights Master table Entity", complexity = Complexity.LOW)
...
public class ProjectAccessRightsServiceImpl extends ProjectAccessRightsService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.issuetrackerboundedcontext.projectmanager.ProjectAccessRights> lstprojectaccessrights = projectAccessRightsrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.issuetrackerboundedcontext.projectmanager.ProjectAccessRights lstprojectaccessrights = projectAccessRightsrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstprojectaccessrights);
        } catch (org.springframework.transaction.TransactionException e) {
