...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion() throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        question.setQuestionDetails("uRx5hVcrzJ");
        question.setQuestionIcon("dnBxXZfXKWvpcD4sefHeLb200x6XqRevE3kKGE9R64PG3xtY6P");
        question.setQuestion("OCtILkATAqOMLzDl3mVNPnzPN8pUxLzbCzrpTg1u4bLFk7Ej1r");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("fD5Pmghy5t");
            question.setVersionId(1);
            question.setQuestionIcon("UYSxyPAx3n0mFl2lbq6T6Dd4TrxkYlUj5JVp5CrVknRAPsT22y");
            question.setQuestion("LPWGLodSG9RHnzPmkRmNdAN2EebUFfynvHhWVGtHyicrM8O7vv");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "JeAQ2kpGyZ5CLq9uKyDKe1b35Tchxa5hnqvsBeVAp0PAQlD0EuG3z16MHuceSNtdD"));
