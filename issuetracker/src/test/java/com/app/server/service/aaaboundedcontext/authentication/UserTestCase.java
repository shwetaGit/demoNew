...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser() throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        useraccessdomain.setDomainName("UJf1loTDoJo1mnMtTAZcJnUTFODmE0uEgw04ggeaYy9EFLOuIE");
        useraccessdomain.setDomainDescription("mscxLLpZQZQB5bq4DBiuj1pgSd146Gv412M5DUad7HJi5kXLwc");
        useraccessdomain.setDomainHelp("WpGYAV5kxHk0h0mYEyUQqusgwqNjGZwo5zBtlTZ6qTmMa0dTgr");
        useraccessdomain.setDomainIcon("Jsy0pPipuUsqpv8ZhfyHV3GEW6IkuK4bQUR3nrH2N28kIcPcuq");
        UserAccessDomain UserAccessDomainTest = useraccessdomainRepository.save(useraccessdomain);
        map.put("UserAccessDomainPrimaryKey", useraccessdomain._getPrimarykey());
        UserAccessLevel useraccesslevel = new UserAccessLevel();
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelName("5zWZge6NNI8EbQd4oG0omlKBpda6GLpoks923o9Sek19akghVr");
        useraccesslevel.setLevelDescription("juyFg4MsUxaTVoqS76XRDbaSQ7GSvZ4dehgT9lMyl3llt1ve7f");
        useraccesslevel.setLevelIcon("le4u47Y3mQuKfS2d5svUHvx3vQ5n9oJfEFAc2RE78Q1Vyhe4B5");
        useraccesslevel.setLevelHelp("NvfMl6UvgelPE8EfU1W1hyzGHLyMkRNbrActaKdHejxODCsfku");
        UserAccessLevel UserAccessLevelTest = useraccesslevelRepository.save(useraccesslevel);
        map.put("UserAccessLevelPrimaryKey", useraccesslevel._getPrimarykey());
        User user = new User();
        user.setPasswordAlgo("2EjISw65kIgccPpxCemPSAoXA98FMtGHjjoumkMMKm83b8p3Ri");
        user.setChangePasswordNextLogin(1);
        user.setMultiFactorAuthEnabled(1);
        user.setAllowMultipleLogin(1);
        user.setUserAccessCode(39267);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setSessionTimeout(1334);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1458211483451l));
        user.setGenTempOneTimePassword(1);
        user.setIsDeleted(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1458211483498l));
        user.setIsLocked(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("WBvRbDmSQJRs9LoUsChGFBAabfdAnkzpRUzyJ1SKJMG8eFZE0Q");
        Question question = new Question();
        question.setLevelid(7);
        question.setQuestionDetails("urghW6kEOg");
        question.setQuestionIcon("tZOiVqYlLP9gc3KIs4RVZmTpPrG1lFQuj5tPRT5wOHmRjTqjC4");
        question.setQuestion("5tC7pLryQY2GgD2N1mJjsPo6jitQIwzuG6br0ConXlZttOY9rp");
        Question QuestionTest = questionRepository.save(question);
        map.put("QuestionPrimaryKey", question._getPrimarykey());
        passrecovery.setAnswer("r9zOlK2GHObAUYMAcmiseMtxAghZuJCL8FhvrngldfVk6cO2zV");
        ...
        userdata.setOneTimePassword("yKlW96YmrcTKffaGPJzzIUS1tWL3nITc");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1458211483721l));
        userdata.setOneTimePasswordExpiry(11);
        userdata.setOneTimePassword("wh1mSxQ8146wAfO5F7JL8ztD1EVx5NRR");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1458211483736l));
        userdata.setUser(user);
        userdata.setLast5Passwords("sr0TCej84SKSLBAx4cN3SF6zFuEzSMx8Xoue7RFjhXpn234eZc");
        userdata.setPassword("1qHBxOkUM4ddBL4OQogNrTNRxJ2hXBy1aOz97sw00OQXzpyIH6");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 86535));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "nYjXP7btqk9piwVWiRYojNbzvCDkCnBzHS7vdq0UYWVcQePm3HQITk1iySAzphhmA"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 5806));
