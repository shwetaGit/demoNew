...
public class AuthenticateService {
	...
	public HttpEntity<ResponseBean> reauthenticate(@RequestBody final TokenCredential toknBean, final HttpServletRequest request, final HttpServletResponse response, final HttpSession session) {
