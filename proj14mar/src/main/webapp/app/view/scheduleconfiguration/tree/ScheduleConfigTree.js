 ...
 * 
 */
Ext.define("Proj14mar.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Proj14mar.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
