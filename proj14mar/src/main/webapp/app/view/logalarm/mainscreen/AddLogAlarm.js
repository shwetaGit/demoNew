 ...
 * 
 */
Ext.define('Proj14mar.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Proj14mar.view.logalarm.mainscreen.AddLogAlarmController',
			'Proj14mar.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Proj14mar.view.logalarm.mainscreen.AppAlarmPanel',
