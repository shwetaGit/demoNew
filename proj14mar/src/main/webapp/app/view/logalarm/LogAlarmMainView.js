 ...
 * 
 */
Ext.define('Proj14mar.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Proj14mar.view.logalarm.LogAlarmMainViewController',
			'Proj14mar.view.logalarm.tree.LogAlarmTreePanel',
			'Proj14mar.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
