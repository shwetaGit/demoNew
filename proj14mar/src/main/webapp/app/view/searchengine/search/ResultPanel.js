Ext
		.define(
				'Proj14mar.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Proj14mar.view.searchengine.search.SearchEngineMainPanelController','Proj14mar.view.searchengine.search.PanelHeaderField' ,'Proj14mar.view.searchengine.search.ReportGridView','Proj14mar.view.searchengine.search.ReportChartView','Proj14mar.view.searchengine.search.documentView','Proj14mar.view.searchengine.search.DouMeanView','Proj14mar.view.googlemaps.map.MapPanel'],
