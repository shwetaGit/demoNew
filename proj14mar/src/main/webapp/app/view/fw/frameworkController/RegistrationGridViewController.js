Ext.define('Proj14mar.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Proj14mar.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Proj14mar.view.console.ConsoleWindow');
