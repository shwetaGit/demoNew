 ...
 */
Ext.define('Proj14mar.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Proj14mar.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Proj14mar.view.fw.component.DateTimePicker(o);
    },
