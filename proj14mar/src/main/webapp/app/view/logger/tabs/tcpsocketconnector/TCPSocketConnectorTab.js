...
Ext
		.define(
				'Proj14mar.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Proj14mar.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],
