 ...
 * 
 */
Ext.define('Proj14mar.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Proj14mar.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
