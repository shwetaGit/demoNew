...
Ext
		.define(
				'Proj14mar.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Proj14mar.view.logger.tabs.details.DetailsTab',
							'Proj14mar.view.logger.tabs.fileconnector.FileConnectorTab',
							'Proj14mar.view.logger.tabs.dbconnector.DBConnectorTab',
							'Proj14mar.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Proj14mar.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Proj14mar.view.logger.LogConfigurationTabPanelController',
