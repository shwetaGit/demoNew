Ext.define('Proj14mar.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Proj14mar.view.usermanagement.admin.UserPasswordReset',
	            'Proj14mar.view.usermanagement.admin.AddUserDetails',
	            'Proj14mar.view.usermanagement.admin.ViewUser'],
