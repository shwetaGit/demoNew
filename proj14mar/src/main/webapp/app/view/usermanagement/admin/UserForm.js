Ext.define('Proj14mar.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Proj14mar.view.usermanagement.admin.AddUserDetailsViewModel', 'Proj14mar.model.AddUserDataModel' ],
