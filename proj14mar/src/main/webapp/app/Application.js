 ...
 */
Ext.define('Proj14mar.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Proj14mar.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Proj14mar.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Proj14mar.view.login.SessionLogin').center();
