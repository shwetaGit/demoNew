...
public class PasswordPolicyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            passwordpolicy.setPolicyDescription("WaWeq37FuQjLTbw3gboJFWc9At9AKFYxqo8FGuGTYBinNlDndV");
            passwordpolicy.setMinCapitalLetters(2);
            passwordpolicy.setMinSmallLetters(9);
            passwordpolicy.setPolicyName("mc3uipdY8jmpcUCelOqbBRnMjK7e02odRoWJ05dsxLwOYhkUPb");
            passwordpolicy.setAllowedSpecialLetters("oa8MKq9PnDKrx3g1bCeT8FjVNZM0UzOUpSdfHvGCHylpB56dSf");
    ...
    public void test2Update() {
        try {
            ...
            passwordpolicy.setPolicyDescription("voXsBX9SW3NzVhvvEcHE49e761NOES7emr8rtHEt4kG4GwIHHG");
            passwordpolicy.setMinCapitalLetters(5);
            passwordpolicy.setMinSmallLetters(8);
            passwordpolicy.setPolicyName("QKM1jFKWi6HZvtICTZWoSTgKvuH4HPE8PD5SgineRhyMupGSV3");
            passwordpolicy.setAllowedSpecialLetters("AMemwysGrt7zPPXMgYlqlsbz0JIyKtVjAPV9Iu7hCdopieuAq5");
