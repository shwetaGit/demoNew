...
echo $PATH
OSNAME=`uname -s`
DB_PATH=/tmp/applifire/db/Q0NGP3LI6CWCOJQZOW2SGA/6BE6DB6D-9D38-4A34-8DE5-68F3A79FF98C
ART_CREATE_PATH=/tmp/applifire/db/Q0NGP3LI6CWCOJQZOW2SGA/6BE6DB6D-9D38-4A34-8DE5-68F3A79FF98C/art/create
AST_CREATE_PATH=/tmp/applifire/db/Q0NGP3LI6CWCOJQZOW2SGA/6BE6DB6D-9D38-4A34-8DE5-68F3A79FF98C/ast/create
MYSQL=/usr/bin
APPLFIREUSER=root
...
$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "SOURCE $AST_CREATE_PATH/alter_ast_PersonalInfo_M.sql"; 
