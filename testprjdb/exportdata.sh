...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/Q0NGP3LI6CWCOJQZOW2SGA/6BE6DB6D-9D38-4A34-8DE5-68F3A79FF98C/art/data
AST_DATA_PATH=/tmp/applifire/db/Q0NGP3LI6CWCOJQZOW2SGA/6BE6DB6D-9D38-4A34-8DE5-68F3A79FF98C/ast/data
DB_NAME=applifire
USER=root
PASSWORD=root
PORT=3306
HOST=localhost
MYSQL=/usr/bin
PROJECT_ID=Q0NGP3LI6CWCOJQZOW2SGA
