...
public class PasswordPolicyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            passwordpolicy.setPolicyName("uwp1X2p1Y14WxJ91Mnb8amtgUrrx2j2opQR4ttJ1tmzlhQSJrU");
            passwordpolicy.setMinSmallLetters(3);
            passwordpolicy.setMinNumericValues(3);
            passwordpolicy.setMinCapitalLetters(7);
            passwordpolicy.setAllowedSpecialLetters("ONJL28qEtghCZxcFdc8aAbCVA0GNZHxyhHJnaxtTpIyEPw4aIS");
            passwordpolicy.setMinPwdLength(8);
            passwordpolicy.setMaxPwdLength(20);
            passwordpolicy.setMinSpecialLetters(6);
            passwordpolicy.setPolicyDescription("9vCAJp1lKnVjoyQlD95JGbED03wShyipBWNpcDeR3Wdx8aRGJb");
    ...
    public void test2Update() {
        try {
            ...
            passwordpolicy.setPolicyName("9VdF8lmWegTGJp1TrMXdsvGbl1eT1FynGlFr7a8DRa5PnPOchv");
            passwordpolicy.setMinSmallLetters(9);
            passwordpolicy.setMinNumericValues(3);
            passwordpolicy.setMinCapitalLetters(3);
            passwordpolicy.setAllowedSpecialLetters("pgeHaWTaOgTjcc7tm50UlAUET8G6zUSUkxpmfu24JkdGeyvEVA");
            passwordpolicy.setMinPwdLength(4);
            passwordpolicy.setMaxPwdLength(19);
            passwordpolicy.setMinSpecialLetters(10);
            passwordpolicy.setVersionId(1);
            passwordpolicy.setPolicyDescription("8v99PKoDKAxtWdb9PzN36d1sWEeVySakTm2GA8gtOGVlZdnDEG");
