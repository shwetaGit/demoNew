...
public class CommunicationTypeTestCase {
    ...
    public void test1Save() {
        try {
            ...
            communicationgroup.setCommGroupName("6hRWaHRBXgxbGfOh7ztVg5hYonTcRYKSIIGU3LiIGa8r1jK0u7");
            communicationgroup.setCommGroupDescription("Jm6HwltdghkzxTToLavi1RqP1qOhAAxCvMzAIyogvUvdZWpHZw");
            CommunicationGroup CommunicationGroupTest = communicationgroupRepository.save(communicationgroup);
            map.put("CommunicationGroupPrimaryKey", communicationgroup._getPrimarykey());
            CommunicationType communicationtype = new CommunicationType();
            communicationtype.setCommTypeName("FAFnda4sDPL7lPE9CucUoqrGqCbQGlcLQJuOcrknBG823SenWj");
            communicationtype.setCommTypeDescription("ZsvgU0aJ8IY0jYhTvphg9p9hqebM4I6k9jcL0IAaNiNv5p9q7g");
    ...
    public void test2Update() {
        try {
            ...
            communicationtype.setCommTypeName("UoaodbmmEbL5cGWJAl08BHkICaBXseAgrcQmvGeQC89sB2rU0P");
            communicationtype.setCommTypeDescription("gZ9yznEXIumCeXKOUVxK8azLkWMmmUgMJ1K4CBneB0lYqoG8ar");
