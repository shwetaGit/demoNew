...
public class ContactTypeTestCase {
    ...
    public void test1Save() {
        try {
            ...
            contacttype.setContactType("BU3OvK0VyCzdEMFKNKGuBYL2hRzLeT3DEXUz5tH71BnWXy2Qdl");
            contacttype.setContactTypeIcon("ZH9hotKGUdcXMbwcCK5iexdt2pIrKkFOHsVEzbDmTy2XK3anQn");
            contacttype.setContactTypeDesc("U7owxjLCyDDxTHccPloJ206iBJD00BuqKWmZ0St8ZXqlTNcuu6");
    ...
    public void test2Update() {
        try {
            ...
            contacttype.setContactType("HNlSsrf8paqkXrVbenaxICcgCGvz3X0jk3SDKxA0R18JsnaE6C");
            contacttype.setVersionId(1);
            contacttype.setContactTypeIcon("C7x2e0sup3VdMxRY97YQbuxkuWtvb0QMf2HbSSzirIAgFiIIQd");
            contacttype.setContactTypeDesc("kh2PV31zg1IJuBHB4ABWWb02Ld8y7yJwW9nes60DEoBLJVAvUH");
