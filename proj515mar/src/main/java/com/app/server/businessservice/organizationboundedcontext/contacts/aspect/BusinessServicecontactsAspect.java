package com.app.server.businessservice.organizationboundedcontext.contacts.aspect;
...
public class BusinessServicecontactsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.organizationboundedcontext.contacts..*(..))")
