...
folder are mapped to the application's root namespace, 'Proj515mar'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Proj515mar"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Proj515mar' in the same way
as `"Proj515mar/sass/src"`.
