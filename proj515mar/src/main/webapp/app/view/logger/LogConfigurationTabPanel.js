...
Ext
		.define(
				'Proj515mar.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Proj515mar.view.logger.tabs.details.DetailsTab',
							'Proj515mar.view.logger.tabs.fileconnector.FileConnectorTab',
							'Proj515mar.view.logger.tabs.dbconnector.DBConnectorTab',
							'Proj515mar.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Proj515mar.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Proj515mar.view.logger.LogConfigurationTabPanelController',
