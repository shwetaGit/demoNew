 ...
 * 
 */
Ext.define('Proj515mar.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Proj515mar.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
