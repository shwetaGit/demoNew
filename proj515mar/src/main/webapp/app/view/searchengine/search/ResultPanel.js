Ext
		.define(
				'Proj515mar.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Proj515mar.view.searchengine.search.SearchEngineMainPanelController','Proj515mar.view.searchengine.search.PanelHeaderField' ,'Proj515mar.view.searchengine.search.ReportGridView','Proj515mar.view.searchengine.search.ReportChartView','Proj515mar.view.searchengine.search.documentView','Proj515mar.view.searchengine.search.DouMeanView','Proj515mar.view.googlemaps.map.MapPanel'],
