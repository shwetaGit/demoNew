Ext.define('Proj515mar.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Proj515mar.view.searchengine.search.NorthPanel', 'Proj515mar.view.searchengine.search.SearchResult','Proj515mar.view.searchengine.search.SearchEngineMainPanelController'],
