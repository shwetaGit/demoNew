 ...
 * 
 */
Ext.define('Proj515mar.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Proj515mar.view.securityconfig.SecurityConfigController',
			'Proj515mar.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
