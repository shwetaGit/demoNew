 ...
 * 
 */
Ext.define('Proj515mar.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Proj515mar.view.logalarm.mainscreen.AddLogAlarmController',
			'Proj515mar.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Proj515mar.view.logalarm.mainscreen.AppAlarmPanel',
