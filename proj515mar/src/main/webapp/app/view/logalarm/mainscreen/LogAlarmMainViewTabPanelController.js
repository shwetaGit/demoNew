 ...
 * 
 */
Ext.define('Proj515mar.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	init : function()
	{
		...
		var component = Ext.create("Proj515mar.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
