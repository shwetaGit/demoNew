 ...
 * 
 */
Ext.define('Proj515mar.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Proj515mar.view.logalarm.LogAlarmMainViewController',
			'Proj515mar.view.logalarm.tree.LogAlarmTreePanel',
			'Proj515mar.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
