Ext.define('Proj515mar.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Proj515mar.view.usermanagement.admin.UserPasswordReset',
	            'Proj515mar.view.usermanagement.admin.AddUserDetails',
	            'Proj515mar.view.usermanagement.admin.ViewUser'],
