Ext.define('Proj515mar.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Proj515mar.view.usermanagement.admin.AddUserDetailsViewModel', 'Proj515mar.model.AddUserDataModel' ],
