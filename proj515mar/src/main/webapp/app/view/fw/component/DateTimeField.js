 ...
 */
Ext.define('Proj515mar.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Proj515mar.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Proj515mar.view.fw.component.DateTimePicker(o);
    },
