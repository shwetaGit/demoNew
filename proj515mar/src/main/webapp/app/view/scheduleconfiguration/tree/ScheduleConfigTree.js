 ...
 * 
 */
Ext.define("Proj515mar.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Proj515mar.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
