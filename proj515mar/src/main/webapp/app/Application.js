 ...
 */
Ext.define('Proj515mar.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Proj515mar.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Proj515mar.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Proj515mar.view.login.SessionLogin').center();
