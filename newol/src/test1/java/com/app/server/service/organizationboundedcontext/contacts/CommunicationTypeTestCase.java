...
public class CommunicationTypeTestCase extends EntityTestCriteria {
    ...
    private CommunicationType createCommunicationType(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        communicationgroup.setCommGroupDescription("TWQnYYaOCtJ43GV5osXRCyiXyTUCH1mL1MiUn1GdTKqvwzVt8L");
        communicationgroup.setCommGroupName("bHTYXYAP83JAC3F8tDSGTmLumqxhZWLOJTF7LHS59MYZnE0Fjp");
        ...
        communicationtype.setCommTypeName("UR92hysOPGcqGxixEGzat9OxnhupMvNAS4p07vcownMtySVuGM");
        communicationtype.setCommGroupId((java.lang.String) CommunicationGroupTest._getPrimarykey());
        communicationtype.setCommTypeDescription("giFh8BJkcunzGJEEeHfOrytQUqcFKEyFgRhsBGN4Lcr9Jz49JI");
    ...
    public void test2Update() {
        try {
            ...
            communicationtype.setCommTypeName("13ZMZ6uFxzYayy3F4JzNn752sBbk6T68R395e2chgE4CzSsjId");
            communicationtype.setVersionId(1);
            communicationtype.setCommTypeDescription("eQKGvdvXVoRHimJQfmC6r8tAEZAnytVjpIlzZHkPrOjLhwxjQr");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "commTypeName", "DhRT3BmyM8yOQVGOmDFcBpzBdiW8Z2Y7g0znxveNjeJDeUlqpyUw201NJcv88ZK42KcR7b21JACIfHmin7luIULWGQNmWoHyR6p9Tbu5v5fPhxC8hHhowh1UbPv6bdrWk"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "commTypeDescription", ""));
