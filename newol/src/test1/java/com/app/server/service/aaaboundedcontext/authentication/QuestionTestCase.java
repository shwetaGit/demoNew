...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        question.setQuestionIcon("ZVevLK5eTnqKGNuDQ69laulZoKzVEmCg800XQPhPGib2zJ26X8");
        question.setQuestionDetails("");
        question.setQuestion("i3Ggch8QEn1j3uY9SxPibQ8PW9R01wYjbBuDY5ripnRTyGe0lr");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("MgFTOujOrQCPxI7Aq4Dy5mVcC8M8buvfxV86yUSVPBTvUTYsDE");
            question.setQuestionDetails("");
            question.setQuestion("rUmfchL961GreU9CKMNXbQ0VjJZ0wNTNx1C88qWK1xmo47aRSm");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "DZuQrBfVmr9pevVEw5MRy99zw7FQAjgEG5EsrBmuHUhLesPHzmJ8VOXpUUw9lg8iD"));
