Ext.define('Newol.newol.web.com.controller.multitenant.customers.AppCustomerCategoryMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#AppCustomerCategoryForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#AppCustomerCategoryForm');
          var grid = this.view.down('#AppCustomerCategoryGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#AppCustomerCategoryForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#AppCustomerCategoryForm').down('#' + me.column.dataIndex + '').store;
