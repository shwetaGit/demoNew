Ext.define('Newol.newol.web.com.controller.multitenant.customers.AppCustomerMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#AppCustomerForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#AppCustomerForm');
          var grid = this.view.down('#AppCustomerGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#AppCustomerForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#AppCustomerForm').down('#' + me.column.dataIndex + '').store;
