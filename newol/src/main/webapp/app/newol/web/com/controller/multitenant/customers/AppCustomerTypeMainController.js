Ext.define('Newol.newol.web.com.controller.multitenant.customers.AppCustomerTypeMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#AppCustomerTypeForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#AppCustomerTypeForm');
          var grid = this.view.down('#AppCustomerTypeGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#AppCustomerTypeForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#AppCustomerTypeForm').down('#' + me.column.dataIndex + '').store;
