Ext.define('Newol.newol.web.com.controller.shoppingcontext.onlineshopping.ItemMainController', {
     ...
     onProductIdChange: function(me, newValue, oldValue, eOpts) {
          this.onProductIdChangeCategoryId(me, newValue, oldValue, eOpts);
          this.onProductIdChangeBrandId(me, newValue, oldValue, eOpts);
     },
     onCategoryIdChange: function(me, newValue, oldValue, eOpts) {
          this.onCategoryIdChangeBrandId(me, newValue, oldValue, eOpts);
     },
     onProductIdChangeCategoryId: function(me, newValue, oldValue, eOpts) {
          var scope = this.getView();
          Ext.Ajax.request({
               async: false,
               url: 'secure/Category/findByProductId',
               method: 'POST',
               jsonData: {
                    findKey: newValue
               },
               ...
               element: me,
               success: function(response, scope) {
                    var categoryIdCombo = scope.element.up('form').down('#categoryId');
                    scope.sender.controller.assignComboData(categoryIdCombo, response.responseText);
                    scope.sender.controller.addCommunicationLog(response, true, categoryIdCombo);
               },
               failure: function(response, scope) {
     ...
     onProductIdChangeBrandId: function(me, newValue, oldValue, eOpts) {
          var scope = this.getView();
          Ext.Ajax.request({
               async: false,
               url: 'secure/Brand/findByProductId',
               method: 'POST',
               jsonData: {
                    findKey: newValue
               },
               ...
               element: me,
               success: function(response, scope) {
                    var brandIdCombo = scope.element.up('form').down('#brandId');
                    scope.sender.controller.assignComboData(brandIdCombo, response.responseText);
                    scope.sender.controller.addCommunicationLog(response, true, brandIdCombo);
               },
               failure: function(response, scope) {
                    scope.sender.controller.addCommunicationLog(response, false);
               }
     ...
     onCategoryIdChangeBrandId: function(me, newValue, oldValue, eOpts) {
          var scope = this.getView();
          Ext.Ajax.request({
               async: false,
