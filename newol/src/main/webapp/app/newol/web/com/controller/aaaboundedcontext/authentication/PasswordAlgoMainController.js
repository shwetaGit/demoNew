Ext.define('Newol.newol.web.com.controller.aaaboundedcontext.authentication.PasswordAlgoMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#PasswordAlgoForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#PasswordAlgoForm');
          var grid = this.view.down('#PasswordAlgoGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#PasswordAlgoForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#PasswordAlgoForm').down('#' + me.column.dataIndex + '').store;
