Ext.define('Newol.newol.web.com.controller.shoppingcontext.onlineshopping.CartMainController', {
     extend: 'Newol.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.CartMainController',
     init: function() {
          var form = this.view.down('#CartForm');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#CartForm');
