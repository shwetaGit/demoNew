Ext.define('Newol.newol.web.com.controller.aaaboundedcontext.authentication.PasswordPolicyMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#PasswordPolicyForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#PasswordPolicyForm');
          var grid = this.view.down('#PasswordPolicyGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#PasswordPolicyForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#PasswordPolicyForm').down('#' + me.column.dataIndex + '').store;
