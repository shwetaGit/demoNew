Ext.define('Newol.newol.web.com.controller.shoppingcontext.onlineshopping.OrderTransactionMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#OrderTransactionForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#OrderTransactionForm');
          var grid = this.view.down('#OrderTransactionGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#OrderTransactionForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#OrderTransactionForm').down('#' + me.column.dataIndex + '').store;
