Ext
		.define(
				'Newol.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Newol.view.searchengine.search.SearchEngineMainPanelController','Newol.view.searchengine.search.PanelHeaderField' ,'Newol.view.searchengine.search.ReportGridView','Newol.view.searchengine.search.ReportChartView','Newol.view.searchengine.search.documentView','Newol.view.searchengine.search.DouMeanView','Newol.view.googlemaps.map.MapPanel'],
