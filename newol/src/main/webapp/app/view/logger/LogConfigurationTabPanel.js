...
Ext
		.define(
				'Newol.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Newol.view.logger.tabs.details.DetailsTab',
							'Newol.view.logger.tabs.fileconnector.FileConnectorTab',
							'Newol.view.logger.tabs.dbconnector.DBConnectorTab',
							'Newol.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Newol.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Newol.view.logger.LogConfigurationTabPanelController',
