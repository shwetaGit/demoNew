 ...
 * 
 */
Ext.define('Newol.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Newol.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
