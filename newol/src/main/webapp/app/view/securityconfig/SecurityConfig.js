 ...
 * 
 */
Ext.define('Newol.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Newol.view.securityconfig.SecurityConfigController',
			'Newol.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
