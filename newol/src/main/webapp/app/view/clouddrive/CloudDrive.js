Ext.define("Newol.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Newol.view.clouddrive.CloudDriveController',
	             'Newol.view.clouddrive.documentview.DocumentsView',
	             'Newol.view.clouddrive.drivedetails.DriveDetails',
	             //'Newol.view.clouddrive.documentview.DocumentListView'
	             ],
