...
Ext.define('Newol.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Newol.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Newol.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
