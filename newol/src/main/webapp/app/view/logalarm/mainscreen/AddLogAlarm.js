 ...
 * 
 */
Ext.define('Newol.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Newol.view.logalarm.mainscreen.AddLogAlarmController',
			'Newol.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Newol.view.logalarm.mainscreen.AppAlarmPanel',
