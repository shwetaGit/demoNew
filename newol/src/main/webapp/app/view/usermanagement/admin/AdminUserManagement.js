Ext.define('Newol.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Newol.view.usermanagement.admin.UserPasswordReset',
	            'Newol.view.usermanagement.admin.AddUserDetails',
	            'Newol.view.usermanagement.admin.ViewUser'],
