...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "District", complexity = Complexity.LOW)
...
public class District implements Serializable, CommonEntityInterface, Comparator<District> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.organizationboundedcontext.location.District other = (com.app.shared.organizationboundedcontext.location.District) obj;
            if (districtId == null) {
                return false;
