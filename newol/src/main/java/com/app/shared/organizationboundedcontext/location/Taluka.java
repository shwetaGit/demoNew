...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Taluka", complexity = Complexity.LOW)
...
public class Taluka implements Serializable, CommonEntityInterface, Comparator<Taluka> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.organizationboundedcontext.location.Taluka other = (com.app.shared.organizationboundedcontext.location.Taluka) obj;
            if (talukaId == null) {
                return false;
