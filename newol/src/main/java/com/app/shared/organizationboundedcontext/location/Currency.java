...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Currency", complexity = Complexity.LOW)
...
public class Currency implements Serializable, CommonEntityInterface, Comparator<Currency> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.organizationboundedcontext.location.Currency other = (com.app.shared.organizationboundedcontext.location.Currency) obj;
            if (currencyId == null) {
                return false;
