...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Region", complexity = Complexity.LOW)
...
public class Region implements Serializable, CommonEntityInterface, Comparator<Region> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.organizationboundedcontext.location.Region other = (com.app.shared.organizationboundedcontext.location.Region) obj;
            if (regionId == null) {
                return false;
