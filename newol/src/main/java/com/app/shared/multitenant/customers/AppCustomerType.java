...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "AppCustomerType", complexity = Complexity.LOW)
...
public class AppCustomerType implements Serializable, CommonEntityInterface, Comparator<AppCustomerType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.multitenant.customers.AppCustomerType other = (com.app.shared.multitenant.customers.AppCustomerType) obj;
            if (appcustTypeId == null) {
                return false;
