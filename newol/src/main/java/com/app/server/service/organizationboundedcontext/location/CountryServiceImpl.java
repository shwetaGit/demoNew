...
import com.app.server.businessservice.defaultcontext.defaultdomain.TestC;
...
public class CountryServiceImpl extends CountryService {
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody Country entity) throws Exception, SpartanBusinessValidationFailedException, SpartanDataNotFoundException, SpartanIncorrectDataException, SpartanPersistenceException {
        com.athena.framework.server.bean.ResponseBean responseBean = new com.athena.framework.server.bean.ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        testc.proTestC(entity);
        responseBean.add("success", true);
