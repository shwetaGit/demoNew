package com.app.server.service.multitenant.customers.aspect;
...
@Aspect
@Component
public class ServicecustomersAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.app.server.service.multitenant.customers..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.service.multitenant.customers..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.service.multitenant.customers..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.service.multitenant.customers..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.service.multitenant.customers..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.multitenant.customers..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
