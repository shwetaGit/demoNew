...
public class FetchItemDetailsServiceWS {
    ...
    public HttpEntity<ResponseBean> fetchItemDetails() throws Exception, SpartanBusinessValidationFailedException, SpartanDataNotFoundException, SpartanIncorrectDataException, SpartanPersistenceException {
