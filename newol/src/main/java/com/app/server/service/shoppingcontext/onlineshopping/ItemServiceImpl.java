...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Service for Item Master table Entity", complexity = Complexity.LOW)
@RequestMapping("/Item")
public class ItemServiceImpl extends ItemService {
    ...
    @Override
    public HttpEntity<ResponseBean> findByBrandId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
