package com.app.server.service.shoppingcontext.onlineshopping.aspect;
...
@Aspect
@Component
public class ServiceonlineshoppingAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.app.server.service.shoppingcontext.onlineshopping..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.service.shoppingcontext.onlineshopping..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.service.shoppingcontext.onlineshopping..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.service.shoppingcontext.onlineshopping..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.service.shoppingcontext.onlineshopping..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.shoppingcontext.onlineshopping..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
