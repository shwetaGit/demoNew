package com.app.server.businessservice.multitenant.customers.aspect;
...
@Aspect
@Component
public class BusinessServicecustomersAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.multitenant.customers..*(..))")
