package com.app.server.businessservice.shoppingcontext.onlineshopping.aspect;
...
@Aspect
@Component
public class BusinessServiceonlineshoppingAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.shoppingcontext.onlineshopping..*(..))")
