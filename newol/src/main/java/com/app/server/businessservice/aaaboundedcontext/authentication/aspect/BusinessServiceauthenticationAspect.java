package com.app.server.businessservice.aaaboundedcontext.authentication.aspect;
...
public class BusinessServiceauthenticationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.aaaboundedcontext.authentication..*(..))")
