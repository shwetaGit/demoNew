package com.app.server.repository.multitenant.customers.aspect;
...
@Aspect
@Component
public class RepositorycustomersAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.app.server.repository.multitenant.customers..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.multitenant.customers..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.multitenant.customers..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.multitenant.customers..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.multitenant.customers..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.multitenant.customers..*(..))")
