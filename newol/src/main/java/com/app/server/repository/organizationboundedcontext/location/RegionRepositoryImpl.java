...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for Region Master table Entity", complexity = Complexity.LOW)
public class RegionRepositoryImpl extends SearchInterfaceImpl implements RegionRepository<Region> {
    ...
    public List<Region> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.organizationboundedcontext.location.Region> query = emanager.createQuery("select u from Region u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public Region save(Region entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<Region> save(List<Region> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.organizationboundedcontext.location.Region obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.organizationboundedcontext.location.Region s = emanager.find(com.app.shared.organizationboundedcontext.location.Region.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(Region entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<Region> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.organizationboundedcontext.location.Region obj = entity.get(i);
    ...
    public List<Region> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.organizationboundedcontext.location.Region> listOfRegion = query.getResultList();
            return listOfRegion;
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Region findById(String regionId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.organizationboundedcontext.location.Region listOfRegion = (com.app.shared.organizationboundedcontext.location.Region) query.getSingleResult();
            return listOfRegion;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
