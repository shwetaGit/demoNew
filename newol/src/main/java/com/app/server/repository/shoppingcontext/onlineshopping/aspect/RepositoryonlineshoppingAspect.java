package com.app.server.repository.shoppingcontext.onlineshopping.aspect;
...
@Aspect
@Component
public class RepositoryonlineshoppingAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.app.server.repository.shoppingcontext.onlineshopping..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.shoppingcontext.onlineshopping..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.shoppingcontext.onlineshopping..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.shoppingcontext.onlineshopping..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.shoppingcontext.onlineshopping..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.shoppingcontext.onlineshopping..*(..))")
