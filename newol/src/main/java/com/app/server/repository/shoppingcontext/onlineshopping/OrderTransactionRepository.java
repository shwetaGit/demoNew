...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for OrderTransaction Master table Entity", complexity = Complexity.LOW)
public interface OrderTransactionRepository<T> extends SearchInterface {
    ...
    public T findById(String orderTransactionId) throws Exception, SpartanPersistenceException;
}
