Ext.define('Testbp.view.smartdevice.design.drawer.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Testbp.view.smartdevice.design.drawer.main.MainPanelController','Testbp.view.smartdevice.design.resource.AppFormsList'],
    userinfo:{},
    id:'mainPanel',
