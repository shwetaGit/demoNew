Ext.define('Testbp.view.smartdevice.reportview.querycriteria.QueryCriteria', {
	extend : 'Ext.panel.Panel',
	requires:['Testbp.view.smartdevice.reportview.querycriteria.QueryCriteriaController'],
