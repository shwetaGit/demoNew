Ext.define('Testbp.view.smartdevice.reportview.datapointview.DataPointView', {
	extend : 'Ext.panel.Panel',
	requires:['Testbp.view.smartdevice.reportview.datapointview.DataPointViewController'],
