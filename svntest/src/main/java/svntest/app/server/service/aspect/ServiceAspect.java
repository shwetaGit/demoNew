package svntest.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* svntest.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* svntest.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* svntest.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* svntest.app.server.service..*..*(..)) && !within(svntest.app.server.service.sessionmgt.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* svntest.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* svntest.app.server.service..get*(..))")
