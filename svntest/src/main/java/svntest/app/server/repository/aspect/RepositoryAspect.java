package svntest.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* svntest.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* svntest.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* svntest.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* svntest.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* svntest.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* svntest.app.server.repository..*(..))")
