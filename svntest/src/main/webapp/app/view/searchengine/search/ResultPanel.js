Ext
		.define(
				'Buzzor.view.searchengine.search.ResultPanel',
				{
					...
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Buzzor.view.searchengine.search.SearchEngineMainPanelController','Buzzor.view.searchengine.search.PanelHeaderField' ,'Buzzor.view.searchengine.search.ReportGridView','Buzzor.view.searchengine.search.ReportChartView','Buzzor.view.searchengine.search.documentView','Buzzor.view.searchengine.search.DouMeanView','Buzzor.view.googlemaps.map.MapPanel'],
