Ext.define('Buzzor.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Buzzor.view.usermanagement.enduser.UserProfileController', 'Buzzor.view.usermanagement.admin.AddUserDetailsViewModel', 'Buzzor.model.AddUserDataModel' ],
