 ...
 */
Ext.define('Testpro3.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Testpro3.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Testpro3.store.QueryCriteriaWidgetsStore' ],
...
Ext.Ajax.on('requestcomplete', function(conn, response, options, eOpts) {
	...
	if (responseData.response) {
		if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
			...
			var loginWindow = Ext.create('Testpro3.view.login.SessionLogin')
					.center();
