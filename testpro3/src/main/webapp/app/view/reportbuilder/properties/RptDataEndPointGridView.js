Ext.define('Testpro3.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Testpro3.view.reportbuilder.properties.RptDataEndPointGridController'],
