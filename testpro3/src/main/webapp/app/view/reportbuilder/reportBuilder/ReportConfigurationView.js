Ext.define('Testpro3.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Testpro3.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Testpro3.view.reportbuilder.gridconfig.GridConfigView',
	           'Testpro3.view.reportbuilder.properties.PropertiesPanelView',
	           'Testpro3.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
