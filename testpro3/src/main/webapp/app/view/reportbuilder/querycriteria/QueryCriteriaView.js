Ext.define('Testpro3.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Testpro3.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Testpro3.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Testpro3.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Testpro3.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
