Ext.define('Testpro3.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Testpro3.view.reportbuilder.reportlist.ReportListPanelView',
             'Testpro3.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Testpro3.view.reportbuilder.mainview.ReportMainController'
             ],
