Ext.define('Testpro3.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Testpro3.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Testpro3.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Testpro3.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Testpro3.view.querybuildernewmodel.querydetail.QueryDetail');
