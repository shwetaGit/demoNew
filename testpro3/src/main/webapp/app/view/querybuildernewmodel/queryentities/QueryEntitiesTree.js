Ext.define('Testpro3.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testpro3.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
