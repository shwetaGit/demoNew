Ext.define('Testpro3.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Testpro3.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Testpro3.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Testpro3.view.querybuildernewmodel.floatingentity.EntitySprite',
