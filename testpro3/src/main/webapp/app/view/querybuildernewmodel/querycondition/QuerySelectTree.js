Ext.define('Testpro3.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testpro3.view.querybuildernewmodel.querycondition.QuerySelectController',
