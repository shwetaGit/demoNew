 ...
 * 
 */
Ext.define('Testpro3.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Testpro3.view.logalarm.LogAlarmMainViewController',
			'Testpro3.view.logalarm.tree.LogAlarmTreePanel',
			'Testpro3.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
