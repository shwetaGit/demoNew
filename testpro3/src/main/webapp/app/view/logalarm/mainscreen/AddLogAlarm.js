 ...
 * 
 */
Ext.define('Testpro3.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testpro3.view.logalarm.mainscreen.AddLogAlarmController',
			'Testpro3.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testpro3.view.logalarm.mainscreen.AppAlarmPanel',
