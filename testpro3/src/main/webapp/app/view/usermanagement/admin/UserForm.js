Ext.define('Testpro3.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testpro3.view.usermanagement.admin.AddUserDetailsViewModel', 'Testpro3.model.AddUserDataModel' ],
