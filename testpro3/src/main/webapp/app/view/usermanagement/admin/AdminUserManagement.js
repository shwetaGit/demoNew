Ext.define('Testpro3.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testpro3.view.usermanagement.admin.UserPasswordReset',
	            'Testpro3.view.usermanagement.admin.AddUserDetails',
	            'Testpro3.view.usermanagement.admin.ViewUser'],
