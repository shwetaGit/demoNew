 ...
 * 
 */
Ext.define('Testpro3.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testpro3.view.securityconfig.SecurityConfigController',
			'Testpro3.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
