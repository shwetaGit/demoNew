Ext
		.define(
				'Testpro3.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testpro3.view.searchengine.search.SearchEngineMainPanelController','Testpro3.view.searchengine.search.PanelHeaderField' ,'Testpro3.view.searchengine.search.ReportGridView','Testpro3.view.searchengine.search.ReportChartView','Testpro3.view.searchengine.search.documentView','Testpro3.view.searchengine.search.DouMeanView','Testpro3.view.googlemaps.map.MapPanel'],
