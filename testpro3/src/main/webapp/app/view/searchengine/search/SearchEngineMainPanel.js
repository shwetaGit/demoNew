Ext.define('Testpro3.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testpro3.view.searchengine.search.NorthPanel', 'Testpro3.view.searchengine.search.SearchResult','Testpro3.view.searchengine.search.SearchEngineMainPanelController'],
