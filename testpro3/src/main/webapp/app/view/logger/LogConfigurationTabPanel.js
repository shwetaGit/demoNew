...
Ext
		.define(
				'Testpro3.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testpro3.view.logger.tabs.details.DetailsTab',
							'Testpro3.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testpro3.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testpro3.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testpro3.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testpro3.view.logger.LogConfigurationTabPanelController',
