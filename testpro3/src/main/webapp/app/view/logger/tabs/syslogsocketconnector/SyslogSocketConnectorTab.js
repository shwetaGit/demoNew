 ...
 * 
 */
Ext.define('Testpro3.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testpro3.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
