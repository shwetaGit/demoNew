Ext.define('Testpro3.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Testpro3.view.reportui.datachart.chart.RatingField','Testpro3.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
