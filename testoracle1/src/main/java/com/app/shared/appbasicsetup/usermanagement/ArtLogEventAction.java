...
public class ArtLogEventAction implements Serializable {
	...
	public ArtLogEventAction(String id, Integer eventActionId, String eventAction) {
		super();
		this.id = id;
	...
	public String toString() {
		return "ArtLogEventAction [id=" + id + ", eventActionId=" + eventActionId + ", eventAction=" + eventAction + "]";
	}
