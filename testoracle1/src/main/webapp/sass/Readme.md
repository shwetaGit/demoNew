...
folder are mapped to the application's root namespace, 'Testoracle1'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Testoracle1"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Testoracle1' in the same way
as `"Testoracle1/sass/src"`.
