 ...
 * 
 */
Ext.define('Testoracle1.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Testoracle1.view.logalarm.LogAlarmMainViewController',
			'Testoracle1.view.logalarm.tree.LogAlarmTreePanel',
			'Testoracle1.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
