 ...
 * 
 */
Ext.define('Testoracle1.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testoracle1.view.logalarm.mainscreen.AddLogAlarmController',
			'Testoracle1.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testoracle1.view.logalarm.mainscreen.AppAlarmPanel',
