...
Ext
		.define(
				'Testoracle1.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testoracle1.view.logger.tabs.details.DetailsTab',
							'Testoracle1.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testoracle1.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testoracle1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testoracle1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testoracle1.view.logger.LogConfigurationTabPanelController',
