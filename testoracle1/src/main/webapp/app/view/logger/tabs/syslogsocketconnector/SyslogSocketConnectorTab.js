 ...
 * 
 */
Ext.define('Testoracle1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testoracle1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
