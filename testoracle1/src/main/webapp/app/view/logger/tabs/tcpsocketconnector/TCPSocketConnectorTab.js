...
Ext
		.define(
				'Testoracle1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Testoracle1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],
