 ...
 * 
 */
Ext.define("Testoracle1.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Testoracle1.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
