 ...
 */
Ext.define('Testoracle1.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Testoracle1.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Testoracle1.view.fw.component.DateTimePicker(o);
    },
