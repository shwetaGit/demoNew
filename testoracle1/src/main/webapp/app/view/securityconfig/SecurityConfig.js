 ...
 * 
 */
Ext.define('Testoracle1.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testoracle1.view.securityconfig.SecurityConfigController',
			'Testoracle1.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
