Ext.define('Testoracle1.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testoracle1.view.usermanagement.admin.AddUserDetailsViewModel', 'Testoracle1.model.AddUserDataModel' ],
