Ext.define('Testoracle1.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testoracle1.view.usermanagement.admin.UserPasswordReset',
	            'Testoracle1.view.usermanagement.admin.AddUserDetails',
	            'Testoracle1.view.usermanagement.admin.ViewUser'],
