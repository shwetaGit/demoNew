Ext
		.define(
				'Testoracle1.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Testoracle1.view.searchengine.search.documentController',
							'Testoracle1.view.searchengine.search.RowExpander' ],
