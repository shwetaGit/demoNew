Ext
		.define(
				'Testoracle1.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testoracle1.view.searchengine.search.SearchEngineMainPanelController','Testoracle1.view.searchengine.search.PanelHeaderField' ,'Testoracle1.view.searchengine.search.ReportGridView','Testoracle1.view.searchengine.search.ReportChartView','Testoracle1.view.searchengine.search.documentView','Testoracle1.view.searchengine.search.DouMeanView','Testoracle1.view.googlemaps.map.MapPanel'],
