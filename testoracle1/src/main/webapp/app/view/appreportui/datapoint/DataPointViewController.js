Ext.define('Testoracle1.view.appreportui.datapoint.DataPointViewController', {
		...
		for(var dpCounter = 0,j=0; dpCounter < datapoints.length; dpCounter++){
			...
			if(datapoints[dpCounter].value.length!=0){
				...
				dpPanel.add({
							...
							tbar:[{xtype:'displayfield',height:18,value:datapoints[dpCounter].label,fieldStyle:{fontColor:"#424242",fontWeight:'bold'}}],
