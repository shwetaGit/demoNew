Ext.define('Testoracle1.view.appreportui.querycriteria.QueryCriteriaView',{
	extend : 'Ext.panel.Panel',
	requires : [ 'Testoracle1.view.appreportui.querycriteria.QueryCriteriaViewController' ],
