 ...
 */
Ext.define('Testoracle1.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Testoracle1.view.databrowsercalendar.DBCalendar"],
	...
	stores : [ 'Testoracle1.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Testoracle1.view.login.SessionLogin').center();
