...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionId("Q3tTtdKGgdqCLoglLlzkzx6Nt46Z27Uiy4YRhF238eTKQe6ED3");
        question.setQuestion("jGNvSwqvxmWLp3YMstCKOTqW0NinEHnHF6t7bLdDFMQfpxwSzH");
        question.setLevelid(10);
        question.setQuestionIcon("OjTJQbfRCmIFmg4uBkPXPmKjX5ce3SMf2G1sQcXeiSFpg40iGr");
        question.setQuestionDetails("d48rca0p0j");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("lW5TL3rJJJ5CHTqIprxMX20v0dpdJ0z6aFKVJZAXjWdZT3bNXi");
            question.setVersionId(1);
            question.setLevelid(4);
            question.setQuestionIcon("IgTdS4VUoK8ndMzEeou9R329AN1ft5v83n1rK8r0Tg6b6tZEN3");
            question.setQuestionDetails("y1WOPO7wkA");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "HwIuFbKNOIyWVG5MeXXmnog5UUvVg0C86xfBCbpKppYPIi2W6dudN9roYptsXyEAI"));
