...
import testprj.app.server.repository.UserAccessRepository;
import testprj.app.shared.sales.UserAccess;
...
public class UserAccessTestCase {
    ...
    public void test1Save() {
        try {
            ...
            salesregion.setRegionname("WVQbaOe2RLFQoC0MbHrxYvxezLiH4kSSYP6PKoc8MY6EU8FWy3");
            ...
            user.setPasswordAlgo("zqUpYxFP9n0qWQLstX1bHilQbbCnV99fARNkl4KoKOIMEVy9H7");
            user.setPasswordExpiryDate(new java.sql.Timestamp(123456789));
            user.setSessionTimeout(2227);
            user.setUserAccessCode(11);
            UserAccessDomain useraccessdomain = new UserAccessDomain();
            useraccessdomain.setDomainDescription("QRs6aLXpCXcyiN23JlA6IdGlFhVyqYGjkQRoyEyEJCWFtb1WQE");
            useraccessdomain.setDomainHelp("VCFq2yXankBW35x6cpxyEWaQtEhY5vJax6GHmhb3Dz5sks7Wvc");
            useraccessdomain.setDomainIcon("pQPCD4KZElMGSdjwBLc0HxOb6B3Zqv3bpUTqX3vTG7q0QKWesG");
            useraccessdomain.setDomainName("E405yO8ZFv1hRWOms9sLR63xVd7X5HUiSKTYLfq0SX1YiMqqMa");
            useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
            UserAccessDomain UserAccessDomainTest = useraccessdomainRepository.save(useraccessdomain);
            map.put("UserAccessDomainPrimaryKey", useraccessdomain._getPrimarykey());
            UserAccessLevel useraccesslevel = new UserAccessLevel();
            useraccesslevel.setLevelDescription("1dSJvqYx0IDXdVWMzVk639EzqRCvbrdQdklfF5hmSBNdTQEeKg");
            useraccesslevel.setLevelHelp("dHlwc825InDQ8Kgcjs5hpICIFRJAUaanUW2RKnNziQXyc9kAj0");
            useraccesslevel.setLevelIcon("rYSidFkNua6eGzoFLanZL1t2Og9L6jmK8ebyFms94mvqEOX94b");
            useraccesslevel.setLevelName("yFSm29IOYjtGxODGSL8VEEPhx5ZKYGxX999FVb3SOe7FB0mGjK");
            ...
            user.setPasswordAlgo("X5VxXFWdW0Nwm1CvzntOskRypioVnlgJwrLvvtnmESTa6rXbUz");
            user.setPasswordExpiryDate(new java.sql.Timestamp(123456789));
            user.setSessionTimeout(2506);
