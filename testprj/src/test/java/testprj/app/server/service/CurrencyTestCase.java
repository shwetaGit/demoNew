...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("H4rKMzElFN2CZYDfOKoPZdeEIN4T1Eja");
            country.setCapitalLatitude(8);
            country.setCapitalLongitude(7);
            country.setCountryCode1("Lih");
            country.setCountryCode2("Ubo");
            country.setCountryFlag("T4TB9HwCBIZ7KOOOqbgFN02YiVyjdoIwH6vGFeBfRYF25FS34a");
            country.setCountryName("XfCAWFe7Vvir8aVZlPzr70XIXBFr7tOSrhKx9tfOWHxdxfq00O");
            country.setCurrencyCode("EDw");
            country.setCurrencyName("4CAiNpAZwiCV2Sj3BDhhkV2yiVGugp9d2Gq5gs1YzFKI1FAbGY");
            country.setCurrencySymbol("TliSbeiOxp2mN1aydSPbJB0DW046kIZI");
            country.setIsoNumeric(10);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("kAepjE8Q7Y0CNmdotyGvEbK703gyOhHEawmJK4rBj1DWi33Ph6");
            currency.setUnicodeDecimal("oqctvOVhgfUJg4I2XDvUOY1v2bPJuIdW3ZWRExEciI1scObwRk");
            currency.setUnicodeHex("xhuy2Kt4TeFNVaYzxlybzNU28P4oT4X2oxdd8MURK3uMMdOHpy");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("gOog0U3T1w0v5K0qq0BvFbGXrAXIpopKALdSQjzY8xwD9bsudW");
            currency.setUnicodeDecimal("2Hm388txcatmmfci3N4NfSXjM6NqfPvruvYStdpErAKwurgPfr");
            currency.setUnicodeHex("GLxmDWloPU3NKpbAgz79QbNhsDRIIWJjpMlasUTwlP9WL5p4w2");
