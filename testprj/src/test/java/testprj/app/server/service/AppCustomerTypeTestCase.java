...
public class AppCustomerTypeTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomertype.setCustomerType("BzJPh7FHCtLiHLVOVHomAKIX1t0XNcCKXWXCTtoGxOGPutiiGh");
    ...
    public void test2Update() {
        try {
            ...
            appcustomertype.setCustomerType("X9tLckykgTpC0rcRjV6cPGTjk8oKniGuOCDg0rRsslkPyQmr27");
