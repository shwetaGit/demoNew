...
public class BrandTestCase {
    ...
    public void test1Save() {
        try {
            ...
            category.setCategory("8v4lF8UEdVVtX7zCOHGOvkrnEuKF2MUQbtcP4Dco7lTnuaEMfo");
            Category CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
            Brand brand = new Brand();
            brand.setBranddesc("DhwzVH6zevoYyf1Prz9gkFTR6JAdHxpZQkHUycZPSPl6rWZC8E");
    ...
    public void test2Update() {
        try {
            ...
            brand.setBranddesc("TA8b7eV9mi156gKA0HfpEa09QRVrZmsjyVFT4AwLKcM1Mml01c");
