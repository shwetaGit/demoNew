...
public class BrandTestCase {
    ...
    public void test1Save() {
        try {
            ...
            category.setCategory("kYV6DttuoQ36iiQaJsEvV6smSxX1KM92W2lgW1BWsvMXOMdfmj");
            Category CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
            Brand brand = new Brand();
            brand.setBranddesc("qEMK6n1OmVp2IujIrX1OXfbI4wtxifPN6K7DuFncUMvPY7xB6f");
    ...
    public void test2Update() {
        try {
            ...
            brand.setBranddesc("RafZpUZoRh4IoSFszpo2aHe3VSvafJDq2l1MYRvBXYZqpVzubV");
