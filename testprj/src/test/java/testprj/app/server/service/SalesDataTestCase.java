...
public class SalesDataTestCase {
    ...
    public void test1Save() {
        try {
            ...
            brand.setBranddesc("xj0cNsGo7DKtoM7s5ZxLjiCXdyzKXEgjzkHFzoPsZMlFIRzdq2");
            Category category = new Category();
            category.setCategory("lv6h9NMEdNW1uu9W3GSxbLHxsKESXytj1qooZ0gwLxMCyfI5Mt");
            Category CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
            brand.setBranddesc("6Rw0Uu4fC7XK3Xn25xP47xghaGFLoptjsFJEcu1XFRQFhUplNh");
            ...
            channel.setChannel("Nl1qkYYl9J9oegBf9h8BbHf2U0h31HGLivSbvXHTSi3dbZ8uji");
            ...
            material.setMaterialdesc("ERNXriq6cxldiIys1ZCUD6OKwKJEDsRQ3KTpASNbpVsZkTFHdN");
            Material MaterialTest = materialRepository.save(material);
            map.put("MaterialPrimaryKey", material._getPrimarykey());
            Retailer retailer = new Retailer();
            Distributor distributor = new Distributor();
            distributor.setDistributorname("Oqi2ufOtik2KPo4il44M3Cz5GXdaeLubShzrXaXQZ9AG5teTAe");
            distributor.setLattitude(12.34);
            distributor.setLongitude(12.34);
            SalesRegion salesregion = new SalesRegion();
            salesregion.setRegionname("hZ39jh3Ti6xxJ87JAVQU3OjQHMCXtxSB1WZRUdJMIIY0lIJm1Q");
            ...
            distributor.setDistributorname("BBnwudyLpgABGSqxMT3x2o4ckpRMbBqPoLpOw6hqKdSaxjppoF");
            distributor.setLattitude(12.34);
            distributor.setLongitude(12.34);
            ...
            retailer.setRetailername("YZxAWg3kpMUR9wXNugEnEx1Bi1OTS4ImAIdarWVyVbEk5bohKC");
            ...
            salesdata.setBranddesc("kJofngl29ufOk7kLEQXkUhnvagqEf9NrPs4ia9ZFKwIwXm2uUl");
            ...
            salesdata.setMaterialdesc("TneINFvJemu5dnPBcziEMcBnRhDIhXS4rtOHy04TRLpNSrRVOa");
            salesdata.setNetsalesamt(12.34);
            salesdata.setReatilercode((java.lang.String) RetailerTest._getPrimarykey());
            salesdata.setRetailername("WXdE2ZWfgKGoapahC2YmadHo52v6unrRsb4sESUbI30v2l2xUY");
            salesdata.setSalesdate(new java.sql.Date(123456789));
            salesdata.setSalesinvoicenbr("aswqX1ckWOVxZjoZcIMT8oFUC9u7kdpmP5KqLVaRV7FnVQkzE0");
    ...
    public void test2Update() {
        try {
            ...
            salesdata.setBranddesc("bHyAabB2i3nUpwSXrc2NXpT8X05IglMRnx6gROn7Bz3TG0ZZFv");
            salesdata.setGrosssalesamt(12.34);
            salesdata.setMaterialdesc("KFf6eP8ahlTxVwJHhWSVld124vp2giFEf7aYh1n5H83rlxIuZ2");
            salesdata.setNetsalesamt(12.34);
            salesdata.setRetailername("PIAo8ikB7WMCu4xMcJfDWNv9Qhqsik0blBqHeWhkKvRypOkimZ");
            salesdata.setSalesdate(new java.sql.Date(123456789));
            salesdata.setSalesinvoicenbr("znOcHSHKCUuqc8xqaxnlEzQGiEcTgQJowcilCscdnXbaElabLa");
            salesdata.setSalesmonth(2147483647);
            salesdata.setSalesqty(12.34);
            salesdata.setSalesyear(2147483647);
