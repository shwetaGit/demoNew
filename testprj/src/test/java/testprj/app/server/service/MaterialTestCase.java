...
public class MaterialTestCase {
    ...
    public void test1Save() {
        try {
            ...
            brand.setBranddesc("pSguEAfV7fwYy0uL2r4VgMPSppKmWoj6872ro8kM6X1nozFuLA");
            Category category = new Category();
            category.setCategory("RWmMxtG2l157h06rtaNnZwqf3yZlYTE0priAIqhxUbRiEQypPz");
            Category CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
            brand.setBranddesc("6oJE07CR7DTn7edMxi294Td0YJeoibhUwy3onWAdnXFfmF1jVs");
            ...
            material.setMaterialdesc("bSPBMJq67WjeVBMzRaZ85q40qd1Js7Pra7DLlH7OAvfkFxZ55Q");
    ...
    public void test2Update() {
        try {
            ...
            material.setMaterialdesc("3bsHnj6bght3IjdFQt9MlEJvBneIMphlueDWTmYi6LHiGpoTha");
