...
public class UserTestCase {
    ...
    public void test1Save() {
        try {
            ...
            useraccessdomain.setDomainDescription("O2MGcVOmhI4FLDFPKDsRElLIn15iLqhYEfzJBq0H82bWTxpoBj");
            useraccessdomain.setDomainHelp("2DhiKJY2vnkbGO924gTYuWjJDeV2FibdZBJM3aZnsRgckjVhRS");
            useraccessdomain.setDomainIcon("UyygVIBPgt9JeIgA0P1APLTIqJLSm4934AmzytEyCgy0gWgyiK");
            useraccessdomain.setDomainName("MKMZW64joWwWiXCwVuyAEwDDmB3z4f8cJ7opb50w9ExIbCTzN6");
            useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
            UserAccessDomain UserAccessDomainTest = useraccessdomainRepository.save(useraccessdomain);
            map.put("UserAccessDomainPrimaryKey", useraccessdomain._getPrimarykey());
            UserAccessLevel useraccesslevel = new UserAccessLevel();
            useraccesslevel.setLevelDescription("ekEf6eOxXUxVbr7zOhRpf6TC8FUQd536eQwC37EXgYGCnXmN3w");
            useraccesslevel.setLevelHelp("b9CgflcRINMYfNhBHYct7hhwsHEsf29UALZiTsoTvIsoWdouPt");
            useraccesslevel.setLevelIcon("eTokWBaeZWMXFBLZw1ly4sSxs7mDBL5VcTbNAZPrzEPL0pMdTT");
            useraccesslevel.setLevelName("Zd8zbmTMiQ1TI4m3iRKVIC88xK0NDgjMjen0pvJ4tjUh7coVVV");
            ...
            user.setPasswordAlgo("0nfRElUsQ3STc2qivaDFmxH1yA12R40n6BJ5QJShHs9ThRzd0W");
            user.setPasswordExpiryDate(new java.sql.Timestamp(123456789));
            user.setSessionTimeout(284);
            user.setUserAccessCode(3);
            user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
            user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
            java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
            PassRecovery passrecovery = new PassRecovery();
            passrecovery.setAnswer("SvD92Omd9gjgFc9zTfZEYbf9tx7ij9gtnmrTvFdxarMU15hW7k");
            Question question = new Question();
            question.setLevelid(1);
            question.setQuestion("wZdMHK4RISZQUPDtHKT34EleLJ2lE7KL3NQcaAWS1JS4Gv90YK");
            question.setQuestionDetails("zd6");
            question.setQuestionIcon("YldHid84mQtdJ9umkLVI4rxenYOljMgto1XGbksgl52rsFbJvm");
            Question QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
            passrecovery.setAnswer("eqJNCk0olStQI86NcEqJOLoSRhx4pXWeh7uGSncZUc8OaQBOBr");
