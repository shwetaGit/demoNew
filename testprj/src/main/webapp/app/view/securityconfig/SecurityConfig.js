 ...
 * 
 */
Ext.define('Testprj.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testprj.view.securityconfig.SecurityConfigController',
			'Testprj.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
