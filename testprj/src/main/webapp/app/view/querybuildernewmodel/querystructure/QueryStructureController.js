Ext.define('Testprj.view.querybuildernewmodel.querystructure.QueryStructureController', {
	...
	init:function(){
		...
		this.queryStructreStore = Ext.create('Testprj.view.querybuildernewmodel.querystructure.QueryStructureStore');
	...
	afterrender :function( tree,eOpts ){
		...
		var rootChildNodes = root.childNodes;
				...
				for (var q = 0; q < rootChildNodes.length; q++) {
					...
					var model = Ext.create('Testprj.view.querybuildernewmodel.querystructure.QueryStructureModel');
