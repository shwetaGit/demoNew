Ext.define('Testprj.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Testprj.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Testprj.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Testprj.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Testprj.view.querybuildernewmodel.querydetail.QueryDetail');
