Ext.define('Testprj.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Testprj.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Testprj.view.querybuildernewmodel.queryentitiesjoins.Query',
