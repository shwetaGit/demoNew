Ext.define('Testprj.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testprj.view.querybuildernewmodel.querycondition.QuerySelectController',
