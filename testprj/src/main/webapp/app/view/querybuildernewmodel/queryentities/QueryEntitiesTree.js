Ext.define('Testprj.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testprj.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
