 ...
 */
Ext.define('Testprj.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Testprj.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Testprj.view.fw.component.DateTimePicker(o);
    },
