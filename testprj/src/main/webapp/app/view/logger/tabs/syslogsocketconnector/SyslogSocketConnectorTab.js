 ...
 * 
 */
Ext.define('Testprj.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testprj.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
