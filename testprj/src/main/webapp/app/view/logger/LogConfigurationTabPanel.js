...
Ext
		.define(
				'Testprj.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testprj.view.logger.tabs.details.DetailsTab',
							'Testprj.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testprj.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testprj.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testprj.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testprj.view.logger.LogConfigurationTabPanelController',
