Ext.define('Testprj.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testprj.view.searchengine.search.NorthPanel', 'Testprj.view.searchengine.search.SearchResult','Testprj.view.searchengine.search.SearchEngineMainPanelController'],
