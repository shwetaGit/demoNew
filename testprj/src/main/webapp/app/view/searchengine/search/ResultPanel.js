Ext
		.define(
				'Testprj.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testprj.view.searchengine.search.SearchEngineMainPanelController','Testprj.view.searchengine.search.PanelHeaderField' ,'Testprj.view.searchengine.search.ReportGridView','Testprj.view.searchengine.search.ReportChartView','Testprj.view.searchengine.search.documentView','Testprj.view.searchengine.search.DouMeanView','Testprj.view.googlemaps.map.MapPanel'],
