Ext.define('Testprj.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Testprj.view.reportui.datachart.chart.RatingField','Testprj.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
