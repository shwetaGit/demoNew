Ext.define('Testprj.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Testprj.view.usermanagement.enduser.UserProfileController', 'Testprj.view.usermanagement.admin.AddUserDetailsViewModel', 'Testprj.model.AddUserDataModel' ],
