Ext.define('Testprj.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testprj.view.usermanagement.admin.AddUserDetailsViewModel', 'Testprj.model.AddUserDataModel' ],
