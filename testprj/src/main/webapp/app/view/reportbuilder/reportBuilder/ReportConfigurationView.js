Ext.define('Testprj.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Testprj.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Testprj.view.reportbuilder.gridconfig.GridConfigView',
	           'Testprj.view.reportbuilder.properties.PropertiesPanelView',
	           'Testprj.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
