Ext.define("Testprj.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Testprj.view.clouddrive.CloudDriveController',
	             'Testprj.view.clouddrive.documentview.DocumentsView',
	             'Testprj.view.clouddrive.drivedetails.DriveDetails',
	             //'Testprj.view.clouddrive.documentview.DocumentListView'
	             ],
