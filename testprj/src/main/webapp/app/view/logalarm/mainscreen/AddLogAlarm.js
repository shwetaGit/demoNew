 ...
 * 
 */
Ext.define('Testprj.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testprj.view.logalarm.mainscreen.AddLogAlarmController',
			'Testprj.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testprj.view.logalarm.mainscreen.AppAlarmPanel',
