 ...
 * 
 */
Ext.define('Testprj.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Testprj.view.logalarm.LogAlarmMainViewController',
			'Testprj.view.logalarm.tree.LogAlarmTreePanel',
			'Testprj.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
