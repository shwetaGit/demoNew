package testprj.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* testprj.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* testprj.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* testprj.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* testprj.app.server.service..*..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* testprj.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* testprj.app.server.service..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
