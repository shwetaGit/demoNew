package testprj.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* testprj.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* testprj.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* testprj.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* testprj.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* testprj.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* testprj.app.server.repository..*(..))")
