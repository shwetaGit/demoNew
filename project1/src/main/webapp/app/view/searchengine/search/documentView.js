Ext
		.define(
				'Project1.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Project1.view.searchengine.search.documentController',
							'Project1.view.searchengine.search.RowExpander' ],
					...
					titleTpl : '<div class="text-wrapper">'
							...
							+ '<div class="news-small"> <span class="news-author">{author}</span>'
