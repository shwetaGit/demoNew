Ext
		.define(
				'Project1.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Project1.view.searchengine.search.SearchEngineMainPanelController','Project1.view.searchengine.search.PanelHeaderField' ,'Project1.view.searchengine.search.ReportGridView','Project1.view.searchengine.search.ReportChartView','Project1.view.searchengine.search.documentView','Project1.view.searchengine.search.DouMeanView','Project1.view.googlemaps.map.MapPanel'],
