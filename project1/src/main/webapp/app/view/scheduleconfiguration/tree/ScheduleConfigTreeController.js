 ...
 * 
 */
Ext.define("Project1.view.scheduleconfiguration.tree.ScheduleConfigTreeController", {
	...
	onItemClick : function(view, record, item, index, e) {
		if (index > 0) {
			...
			if (!isPresent) {
				var component = Ext.create("Project1.view.scheduleconfiguration.panel.ScheduleConfig", {
