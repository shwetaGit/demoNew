Ext.define('Project1.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Project1.view.reportui.datachart.chart.RatingField','Project1.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
