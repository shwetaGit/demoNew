 ...
 * 
 */
Ext.define('Project1.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Project1.view.securityconfig.SecurityConfigController',
			'Project1.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
