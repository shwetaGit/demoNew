Ext.define('Project1.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Project1.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Project1.view.reportbuilder.gridconfig.GridConfigView',
	           'Project1.view.reportbuilder.properties.PropertiesPanelView',
	           'Project1.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
