Ext.define('Project1.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Project1.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Project1.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Project1.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Project1.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
