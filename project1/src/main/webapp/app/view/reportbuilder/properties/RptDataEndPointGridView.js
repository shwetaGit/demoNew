Ext.define('Project1.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Project1.view.reportbuilder.properties.RptDataEndPointGridController'],
