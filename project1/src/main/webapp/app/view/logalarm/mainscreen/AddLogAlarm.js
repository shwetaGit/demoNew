 ...
 * 
 */
Ext.define('Project1.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Project1.view.logalarm.mainscreen.AddLogAlarmController',
			'Project1.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Project1.view.logalarm.mainscreen.AppAlarmPanel',
