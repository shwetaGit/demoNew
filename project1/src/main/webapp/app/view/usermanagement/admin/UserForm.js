Ext.define('Project1.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Project1.view.usermanagement.admin.AddUserDetailsViewModel', 'Project1.model.AddUserDataModel' ],
