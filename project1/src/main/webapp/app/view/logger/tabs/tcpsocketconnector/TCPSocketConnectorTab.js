...
Ext
		.define(
				'Project1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Project1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],
