 ...
 * 
 */
Ext.define('Project1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Project1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
