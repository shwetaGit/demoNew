...
Ext
		.define(
				'Project1.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Project1.view.logger.tabs.details.DetailsTab',
							'Project1.view.logger.tabs.fileconnector.FileConnectorTab',
							'Project1.view.logger.tabs.dbconnector.DBConnectorTab',
							'Project1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Project1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Project1.view.logger.LogConfigurationTabPanelController',
