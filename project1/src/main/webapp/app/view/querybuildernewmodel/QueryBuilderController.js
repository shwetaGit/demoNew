Ext.define('Project1.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Project1.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Project1.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Project1.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Project1.view.querybuildernewmodel.querydetail.QueryDetail');
