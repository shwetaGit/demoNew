Ext.define('Project1.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Project1.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Project1.view.querybuildernewmodel.queryentitiesjoins.Query',
