Ext.define('Project1.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Project1.view.querybuildernewmodel.querycondition.QuerySelectController',
