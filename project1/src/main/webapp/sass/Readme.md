...
folder are mapped to the application's root namespace, 'Ext.theme.crisp'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Ext.theme.crisp"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Ext.theme.crisp' in the same way
as `"Ext.theme.crisp/sass/src"`.
