...
@SourceCodeAuthorClass(createdBy = "sagar.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Login", complexity = Complexity.LOW)
...
@Entity
@Cache(type = CacheType.CACHE, isolation = CacheIsolationType.ISOLATED)
@SourceCodeAuthorClass(createdBy = "sagarjdhv2014@gmail.com", updatedBy = "", versionNumber = "1", comments = "Login", complexity = Complexity.LOW)
@NamedNativeQuery(name = "complexQuery", query = "SELECT login.appCreatorId FROM ast_Login_T AS login,`ast_CoreContacts_T` AS corecontact,`ast_User_T` AS userinfo, `ast_UserData_TP` AS userdata WHERE loginId=? AND login.`contactId`=corecontact.`contactId` AND login.`userId`=userinfo.`userId` AND userinfo.`userId`=userdata.userId")
...
>>>>>>> branch 'master' of https://github.com/applifireAlgo/DefaultRepo.git
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.aaaboundedcontext.authentication.Login other = (com.project1.app.shared.aaaboundedcontext.authentication.Login) obj;
            if (loginPk == null) {
                return false;
