...
<<<<<<< HEAD
@SourceCodeAuthorClass(createdBy = "sagar.jadhav@algorhythm.co.in", updatedBy = "sagar.jadhav@algorhythm.co.in", versionNumber = "2", comments = "UserData", complexity = Complexity.LOW)
=======
@SourceCodeAuthorClass(createdBy = "sagarjdhv2014@gmail.com", updatedBy = "sagarjdhv2014@gmail.com", versionNumber = "2", comments = "UserData", complexity = Complexity.LOW)
...
public class UserData implements Serializable, CommonEntityInterface, UserDataInterface, Comparator<UserData> {
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.aaaboundedcontext.authentication.UserData other = (com.project1.app.shared.aaaboundedcontext.authentication.UserData) obj;
            if (userDataId == null) {
                return false;
