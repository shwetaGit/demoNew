...
public class AddressType implements Serializable, CommonEntityInterface, Comparator<AddressType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.organizationboundedcontext.location.AddressType other = (com.project1.app.shared.organizationboundedcontext.location.AddressType) obj;
            if (addressTypeId == null) {
                return false;
