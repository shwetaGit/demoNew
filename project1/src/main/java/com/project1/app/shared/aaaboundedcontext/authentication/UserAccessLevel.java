...
<<<<<<< HEAD
@SourceCodeAuthorClass(createdBy = "sagar.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "UserAccessLevel", complexity = Complexity.LOW)
=======
@SourceCodeAuthorClass(createdBy = "sagarjdhv2014@gmail.com", updatedBy = "", versionNumber = "1", comments = "UserAccessLevel", complexity = Complexity.LOW)
...
public class UserAccessLevel implements Serializable, CommonEntityInterface, Comparator<UserAccessLevel> {
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.aaaboundedcontext.authentication.UserAccessLevel other = (com.project1.app.shared.aaaboundedcontext.authentication.UserAccessLevel) obj;
            if (userAccessLevelId == null) {
                return false;
