...
public class CommunicationType implements Serializable, CommonEntityInterface, Comparator<CommunicationType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.organizationboundedcontext.contacts.CommunicationType other = (com.project1.app.shared.organizationboundedcontext.contacts.CommunicationType) obj;
            if (commType == null) {
                return false;
