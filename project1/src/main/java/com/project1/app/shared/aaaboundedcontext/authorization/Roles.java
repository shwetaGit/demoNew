package com.project1.app.shared.aaaboundedcontext.authorization;
...
<<<<<<< HEAD
@SourceCodeAuthorClass(createdBy = "sagar.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Roles", complexity = Complexity.LOW)
=======
@SourceCodeAuthorClass(createdBy = "sagarjdhv2014@gmail.com", updatedBy = "", versionNumber = "1", comments = "Roles", complexity = Complexity.LOW)
...
public class Roles implements Serializable, CommonEntityInterface, Comparator<Roles> {
    ...
    public Roles addRoleMenuBridge(RoleMenuBridge _roleMenuBridge) {
        if (this.roleMenuBridge == null) {
            this.roleMenuBridge = new java.util.ArrayList<com.project1.app.shared.aaaboundedcontext.authorization.RoleMenuBridge>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.aaaboundedcontext.authorization.Roles other = (com.project1.app.shared.aaaboundedcontext.authorization.Roles) obj;
            if (roleId == null) {
                return false;
