...
<<<<<<< HEAD
@SourceCodeAuthorClass(createdBy = "sagar.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "LoginSession", complexity = Complexity.LOW)
...
=======
@SourceCodeAuthorClass(createdBy = "sagarjdhv2014@gmail.com", updatedBy = "", versionNumber = "1", comments = "LoginSession", complexity = Complexity.LOW)
public class LoginSession implements Serializable, CommonEntityInterface, LoginSessionInterface, Comparator<LoginSession> {
...
>>>>>>> branch 'master' of https://github.com/applifireAlgo/DefaultRepo.git
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.aaaboundedcontext.authentication.LoginSession other = (com.project1.app.shared.aaaboundedcontext.authentication.LoginSession) obj;
            if (appSessionId == null) {
                return false;
