...
import com.project1.app.shared.aaaboundedcontext.authentication.PasswordAlgo;
...
=======
@SourceCodeAuthorClass(createdBy = "sagarjdhv2014@gmail.com", updatedBy = "", versionNumber = "1", comments = "Repository for PasswordAlgo Master table Entity", complexity = Complexity.LOW)
...
public class PasswordAlgoRepositoryImpl extends SearchInterfaceImpl implements PasswordAlgoRepository<PasswordAlgo> {
    ...
    public List<PasswordAlgo> save(List<PasswordAlgo> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.project1.app.shared.aaaboundedcontext.authentication.PasswordAlgo obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.project1.app.shared.aaaboundedcontext.authentication.PasswordAlgo s = emanager.find(com.project1.app.shared.aaaboundedcontext.authentication.PasswordAlgo.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public PasswordAlgo findById(String algoId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.project1.app.shared.aaaboundedcontext.authentication.PasswordAlgo listOfPasswordAlgo = (com.project1.app.shared.aaaboundedcontext.authentication.PasswordAlgo) query.getSingleResult();
