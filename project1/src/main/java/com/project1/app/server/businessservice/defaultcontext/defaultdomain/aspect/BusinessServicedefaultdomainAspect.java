package com.project1.app.server.businessservice.defaultcontext.defaultdomain.aspect;
...
public class BusinessServicedefaultdomainAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.project1.app.server.businessservice.defaultcontext.defaultdomain..*(..))")
