package com.project1.app.server.businessservice.aaaboundedcontext.authentication.aspect;
...
public class BusinessServiceauthenticationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.project1.app.server.businessservice.aaaboundedcontext.authentication..*(..))")
