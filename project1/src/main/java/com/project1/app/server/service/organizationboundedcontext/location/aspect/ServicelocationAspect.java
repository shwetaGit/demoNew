package com.project1.app.server.service.organizationboundedcontext.location.aspect;
...
public class ServicelocationAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.project1.app.server.service.organizationboundedcontext.location..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.service.organizationboundedcontext.location..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.service.organizationboundedcontext.location..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.service.organizationboundedcontext.location..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.service.organizationboundedcontext.location..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.service.organizationboundedcontext.location..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
