package com.project1.app.server.service.organizationboundedcontext.contacts.aspect;
import com.project1.app.server.service.aspect.ServiceAspect;
...
public class ServicecontactsAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.project1.app.server.service.organizationboundedcontext.contacts..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.service.organizationboundedcontext.contacts..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.service.organizationboundedcontext.contacts..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.service.organizationboundedcontext.contacts..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.service.organizationboundedcontext.contacts..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.service.organizationboundedcontext.contacts..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
