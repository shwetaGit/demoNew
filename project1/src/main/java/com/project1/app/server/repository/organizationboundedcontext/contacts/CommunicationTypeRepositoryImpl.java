...
<<<<<<< HEAD
@SourceCodeAuthorClass(createdBy = "sagar.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for CommunicationType Master table Entity", complexity = Complexity.LOW)
=======
@SourceCodeAuthorClass(createdBy = "sagarjdhv2014@gmail.com", updatedBy = "", versionNumber = "1", comments = "Repository for CommunicationType Master table Entity", complexity = Complexity.LOW)
...
public class CommunicationTypeRepositoryImpl extends SearchInterfaceImpl implements CommunicationTypeRepository<CommunicationType> {
    ...
    public List<CommunicationType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.project1.app.shared.organizationboundedcontext.contacts.CommunicationType> query = emanager.createQuery("select u from CommunicationType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<CommunicationType> save(List<CommunicationType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.project1.app.shared.organizationboundedcontext.contacts.CommunicationType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.project1.app.shared.organizationboundedcontext.contacts.CommunicationType s = emanager.find(com.project1.app.shared.organizationboundedcontext.contacts.CommunicationType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<CommunicationType> findByCommGroupId(String commGroupId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.project1.app.shared.organizationboundedcontext.contacts.CommunicationType> listOfCommunicationType = query.getResultList();
    ...
    public CommunicationType findById(String commType) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.project1.app.shared.organizationboundedcontext.contacts.CommunicationType listOfCommunicationType = (com.project1.app.shared.organizationboundedcontext.contacts.CommunicationType) query.getSingleResult();
            return listOfCommunicationType;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
