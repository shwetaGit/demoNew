package com.project1.app.server.repository.organizationboundedcontext.contacts.aspect;
import com.project1.app.server.repository.aspect.RepositoryAspect;
...
public class RepositorycontactsAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.project1.app.server.repository.organizationboundedcontext.contacts..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.repository.organizationboundedcontext.contacts..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.repository.organizationboundedcontext.contacts..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.repository.organizationboundedcontext.contacts..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.repository.organizationboundedcontext.contacts..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.repository.organizationboundedcontext.contacts..*(..))")
