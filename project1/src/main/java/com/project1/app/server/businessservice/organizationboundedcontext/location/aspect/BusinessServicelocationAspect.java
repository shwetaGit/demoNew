package com.project1.app.server.businessservice.organizationboundedcontext.location.aspect;
...
public class BusinessServicelocationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.project1.app.server.businessservice.organizationboundedcontext.location..*(..))")
