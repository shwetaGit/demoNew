...
import com.project1.app.server.businessservice.organizationboundedcontext.contacts.CoreContactsBusinessService;
...
public class CoreContactsServiceImpl extends CoreContactsService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.project1.app.shared.organizationboundedcontext.contacts.CoreContacts> lstcorecontacts = coreContactsrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByTitleId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.project1.app.shared.organizationboundedcontext.contacts.CoreContacts> lstcorecontacts = coreContactsrepo.findByTitleId((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstcorecontacts);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findByNativeLanguageCode(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.project1.app.shared.organizationboundedcontext.contacts.CoreContacts> lstcorecontacts = coreContactsrepo.findByNativeLanguageCode((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstcorecontacts);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findByGenderId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.project1.app.shared.organizationboundedcontext.contacts.CoreContacts> lstcorecontacts = coreContactsrepo.findByGenderId((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstcorecontacts);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findByTimeZoneId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.project1.app.shared.organizationboundedcontext.contacts.CoreContacts> lstcorecontacts = coreContactsrepo.findByTimeZoneId((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstcorecontacts);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.project1.app.shared.organizationboundedcontext.contacts.CoreContacts lstcorecontacts = coreContactsrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstcorecontacts);
        } catch (org.springframework.transaction.TransactionException e) {
