package com.project1.app.server.repository.aaaboundedcontext.authentication.aspect;
...
public class RepositoryauthenticationAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.project1.app.server.repository.aaaboundedcontext.authentication..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.repository.aaaboundedcontext.authentication..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.repository.aaaboundedcontext.authentication..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.repository.aaaboundedcontext.authentication..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.repository.aaaboundedcontext.authentication..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.repository.aaaboundedcontext.authentication..*(..))")
