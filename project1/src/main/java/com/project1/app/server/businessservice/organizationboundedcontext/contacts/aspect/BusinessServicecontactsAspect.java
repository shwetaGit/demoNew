package com.project1.app.server.businessservice.organizationboundedcontext.contacts.aspect;
import com.project1.app.server.businessservice.aspect.BusinessAspect;
...
public class BusinessServicecontactsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.project1.app.server.businessservice.organizationboundedcontext.contacts..*(..))")
