package com.project1.app.server.businessservice.aaaboundedcontext.authorization.aspect;
...
public class BusinessServiceauthorizationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.project1.app.server.businessservice.aaaboundedcontext.authorization..*(..))")
