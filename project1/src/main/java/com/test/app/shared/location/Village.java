...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Village", complexity = Complexity.LOW)
...
public class Village implements Serializable, CommonEntityInterface, Comparator<Village> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.location.Village other = (com.test.app.shared.location.Village) obj;
            if (villageId == null) {
                return false;
