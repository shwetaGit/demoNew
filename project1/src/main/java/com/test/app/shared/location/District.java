...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "District", complexity = Complexity.LOW)
...
public class District implements Serializable, CommonEntityInterface, Comparator<District> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.location.District other = (com.test.app.shared.location.District) obj;
            if (districtId == null) {
                return false;
