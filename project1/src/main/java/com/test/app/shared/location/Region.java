...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Region", complexity = Complexity.LOW)
...
public class Region implements Serializable, CommonEntityInterface, Comparator<Region> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.location.Region other = (com.test.app.shared.location.Region) obj;
            if (regionId == null) {
                return false;
