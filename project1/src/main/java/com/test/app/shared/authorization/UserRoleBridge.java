...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "UserRoleBridge", complexity = Complexity.LOW)
...
public class UserRoleBridge implements Serializable, CommonEntityInterface, Comparator<UserRoleBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.authorization.UserRoleBridge other = (com.test.app.shared.authorization.UserRoleBridge) obj;
            if (roleUserMapId == null) {
                return false;
