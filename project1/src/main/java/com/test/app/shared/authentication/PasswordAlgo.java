...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "PasswordAlgo", complexity = Complexity.LOW)
...
public class PasswordAlgo implements Serializable, CommonEntityInterface, PasswordAlgoInterface, Comparator<PasswordAlgo> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.authentication.PasswordAlgo other = (com.test.app.shared.authentication.PasswordAlgo) obj;
            if (algoId == null) {
                return false;
