...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "ashutosh.jadhav@algorhythm.co.in", versionNumber = "3", comments = "PassRecovery", complexity = Complexity.LOW)
...
public class PassRecovery implements Serializable, CommonEntityInterface, PassRecoveryInterface, Comparator<PassRecovery> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.authentication.PassRecovery other = (com.test.app.shared.authentication.PassRecovery) obj;
            if (passRecoveryId == null) {
                return false;
