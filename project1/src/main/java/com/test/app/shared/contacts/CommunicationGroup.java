...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "CommunicationGroup", complexity = Complexity.LOW)
...
public class CommunicationGroup implements Serializable, CommonEntityInterface, Comparator<CommunicationGroup> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.contacts.CommunicationGroup other = (com.test.app.shared.contacts.CommunicationGroup) obj;
            if (commGroupId == null) {
                return false;
