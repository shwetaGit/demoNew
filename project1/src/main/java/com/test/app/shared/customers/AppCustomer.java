...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "AppCustomer", complexity = Complexity.LOW)
...
public class AppCustomer implements Serializable, CommonEntityInterface, Comparator<AppCustomer> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.customers.AppCustomer other = (com.test.app.shared.customers.AppCustomer) obj;
            if (appCustomerId == null) {
                return false;
