...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Currency", complexity = Complexity.LOW)
...
public class Currency implements Serializable, CommonEntityInterface, Comparator<Currency> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.location.Currency other = (com.test.app.shared.location.Currency) obj;
            if (currencyId == null) {
                return false;
