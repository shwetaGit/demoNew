...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "AppCustomerType", complexity = Complexity.LOW)
...
public class AppCustomerType implements Serializable, CommonEntityInterface, Comparator<AppCustomerType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.customers.AppCustomerType other = (com.test.app.shared.customers.AppCustomerType) obj;
            if (appcustTypeId == null) {
                return false;
