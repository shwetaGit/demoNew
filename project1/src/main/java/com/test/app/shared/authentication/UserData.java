...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "ashutosh.jadhav@algorhythm.co.in", versionNumber = "2", comments = "UserData", complexity = Complexity.LOW)
...
public class UserData implements Serializable, CommonEntityInterface, UserDataInterface, Comparator<UserData> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.authentication.UserData other = (com.test.app.shared.authentication.UserData) obj;
            if (userDataId == null) {
                return false;
