...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Gender", complexity = Complexity.LOW)
...
public class Gender implements Serializable, CommonEntityInterface, Comparator<Gender> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.contacts.Gender other = (com.test.app.shared.contacts.Gender) obj;
            if (genderId == null) {
                return false;
