...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "UserAccessLevel", complexity = Complexity.LOW)
...
public class UserAccessLevel implements Serializable, CommonEntityInterface, Comparator<UserAccessLevel> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.authentication.UserAccessLevel other = (com.test.app.shared.authentication.UserAccessLevel) obj;
            if (userAccessLevelId == null) {
                return false;
