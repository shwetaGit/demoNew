...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "AppMenus", complexity = Complexity.LOW)
...
public class AppMenus implements Serializable, CommonEntityInterface, Comparator<AppMenus> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.authorization.AppMenus other = (com.test.app.shared.authorization.AppMenus) obj;
            if (menuId == null) {
                return false;
