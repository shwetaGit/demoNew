...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "ashutosh.jadhav@algorhythm.co.in", versionNumber = "3", comments = "RoleMenuBridge", complexity = Complexity.LOW)
...
public class RoleMenuBridge implements Serializable, CommonEntityInterface, Comparator<RoleMenuBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.authorization.RoleMenuBridge other = (com.test.app.shared.authorization.RoleMenuBridge) obj;
            if (roleMenuMapId == null) {
                return false;
