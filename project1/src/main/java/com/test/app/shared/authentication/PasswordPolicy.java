...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "PasswordPolicy", complexity = Complexity.LOW)
...
public class PasswordPolicy implements Serializable, CommonEntityInterface, PasswordPolicyInterface, Comparator<PasswordPolicy> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.authentication.PasswordPolicy other = (com.test.app.shared.authentication.PasswordPolicy) obj;
            if (policyId == null) {
                return false;
