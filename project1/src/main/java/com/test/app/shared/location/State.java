...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "State", complexity = Complexity.LOW)
...
public class State implements Serializable, CommonEntityInterface, Comparator<State> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.location.State other = (com.test.app.shared.location.State) obj;
            if (stateId == null) {
                return false;
