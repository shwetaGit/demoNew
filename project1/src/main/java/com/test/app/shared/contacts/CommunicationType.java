...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "CommunicationType", complexity = Complexity.LOW)
...
public class CommunicationType implements Serializable, CommonEntityInterface, Comparator<CommunicationType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.contacts.CommunicationType other = (com.test.app.shared.contacts.CommunicationType) obj;
            if (commType == null) {
                return false;
