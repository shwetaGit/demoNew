...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Taluka", complexity = Complexity.LOW)
...
public class Taluka implements Serializable, CommonEntityInterface, Comparator<Taluka> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.location.Taluka other = (com.test.app.shared.location.Taluka) obj;
            if (talukaId == null) {
                return false;
