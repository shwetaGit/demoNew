package com.test.app.shared.customers;
...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "AppCustomerCategory", complexity = Complexity.LOW)
...
public class AppCustomerCategory implements Serializable, CommonEntityInterface, Comparator<AppCustomerCategory> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.customers.AppCustomerCategory other = (com.test.app.shared.customers.AppCustomerCategory) obj;
            if (appcustCategoryId == null) {
                return false;
