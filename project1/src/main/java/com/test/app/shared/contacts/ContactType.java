...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "ContactType", complexity = Complexity.LOW)
...
public class ContactType implements Serializable, CommonEntityInterface, Comparator<ContactType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.contacts.ContactType other = (com.test.app.shared.contacts.ContactType) obj;
            if (contactTypeId == null) {
                return false;
