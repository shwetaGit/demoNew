...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Country", complexity = Complexity.LOW)
...
public class Country implements Serializable, CommonEntityInterface, Comparator<Country> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.location.Country other = (com.test.app.shared.location.Country) obj;
            if (countryId == null) {
                return false;
