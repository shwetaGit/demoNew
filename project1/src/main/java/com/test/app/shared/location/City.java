...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "City", complexity = Complexity.LOW)
...
public class City implements Serializable, CommonEntityInterface, Comparator<City> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.location.City other = (com.test.app.shared.location.City) obj;
            if (cityId == null) {
                return false;
