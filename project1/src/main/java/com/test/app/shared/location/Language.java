...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Language", complexity = Complexity.LOW)
...
public class Language implements Serializable, CommonEntityInterface, Comparator<Language> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.location.Language other = (com.test.app.shared.location.Language) obj;
            if (languageId == null) {
                return false;
