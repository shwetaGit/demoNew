...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Question", complexity = Complexity.LOW)
...
public class Question implements Serializable, CommonEntityInterface, Comparator<Question> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.authentication.Question other = (com.test.app.shared.authentication.Question) obj;
            if (questionId == null) {
                return false;
