package com.test.app.shared.location;
...
@SourceCodeAuthorClass(createdBy = "ashutosh.jadhav@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "AddressExtended", complexity = Complexity.LOW)
...
public class AddressExtended implements Serializable, CommonEntityInterface, Comparator<AddressExtended> {
    ...
    public boolean equals(Object obj) {
        try {
            com.test.app.shared.location.AddressExtended other = (com.test.app.shared.location.AddressExtended) obj;
            if (addExtId == null) {
                return false;
