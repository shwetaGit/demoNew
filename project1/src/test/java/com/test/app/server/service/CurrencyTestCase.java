...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("qTxyZdB4yFLecy8Ry5tONX31iwyatoMz");
            country.setCapitalLatitude(2);
            country.setCapitalLongitude(9);
            country.setCountryCode1("Ljc");
            country.setCountryCode2("xeR");
            country.setCountryFlag("mUTYRom99B8Dqr5gjE41TXE2u7oyFE8scUuoNQnPchrwdmqsoK");
            country.setCountryName("uyU4hjbYrcuzDsix6qsHWMTOp8xGWkPuSI1eN7LQelSpE8r9UW");
            country.setCurrencyCode("St1");
            country.setCurrencyName("nCGRrIXileJXLoTlOyeZsMjvjn7wKTF5iWIxo9kglHErjkvX1e");
            country.setCurrencySymbol("eQTA5GiLIiol2HNAFsD4xHfg5fmwbVsK");
            country.setIsoNumeric(2);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("FssAaUmeMfomIhNmlbwrCR2wjSki55AnuRDXrFZwC8M41Vqjbv");
            currency.setUnicodeDecimal("5plVLDjFI6h5EulvMb1OEd7KGAVhWwcMyMUM1utFg6djymrJMp");
            currency.setUnicodeHex("W3c2SLZMA7CxY0A9WAkVKLMtSHRvNtKf6oY2xYlOxOtiiwV5ex");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("98DasScwaw4GCFbR5tr3Q571FmTnliS1IdgTYBb5a7mIsyiERY");
            currency.setUnicodeDecimal("nx37auuASPGA70dJAlYnq4MpquEwRhDE90KQ0S3WyoQxWdCWcX");
            currency.setUnicodeHex("IkV2Fhr0T4sw7nS5681Om9ZHy2aNZmgiXO0a8NF5FLCP5xBrRp");
