 ...
 * 
 */
Ext.define('Salespro.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Salespro.view.securityconfig.SecurityConfigController',
			'Salespro.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
