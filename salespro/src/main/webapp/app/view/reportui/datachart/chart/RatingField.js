...
Ext.define('Salespro.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Salespro.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Salespro.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
