 ...
 */
Ext.define('Salespro.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Salespro.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Salespro.view.fw.component.DateTimePicker(o);
    },
