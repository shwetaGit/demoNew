Ext
		.define(
				'Salespro.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Salespro.view.searchengine.search.SearchEngineMainPanelController','Salespro.view.searchengine.search.PanelHeaderField' ,'Salespro.view.searchengine.search.ReportGridView','Salespro.view.searchengine.search.ReportChartView','Salespro.view.searchengine.search.documentView','Salespro.view.searchengine.search.DouMeanView','Salespro.view.googlemaps.map.MapPanel'],
