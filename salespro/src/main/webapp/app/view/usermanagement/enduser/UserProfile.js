Ext.define('Salespro.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Salespro.view.usermanagement.enduser.UserProfileController', 'Salespro.view.usermanagement.admin.AddUserDetailsViewModel', 'Salespro.model.AddUserDataModel' ],
