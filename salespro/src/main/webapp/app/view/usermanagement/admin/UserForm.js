Ext.define('Salespro.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Salespro.view.usermanagement.admin.AddUserDetailsViewModel', 'Salespro.model.AddUserDataModel' ],
