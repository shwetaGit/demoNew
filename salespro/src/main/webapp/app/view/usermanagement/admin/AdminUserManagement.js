Ext.define('Salespro.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Salespro.view.usermanagement.admin.UserPasswordReset',
	            'Salespro.view.usermanagement.admin.AddUserDetails',
	            'Salespro.view.usermanagement.admin.ViewUser'],
