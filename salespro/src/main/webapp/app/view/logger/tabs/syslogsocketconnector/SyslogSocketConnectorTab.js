 ...
 * 
 */
Ext.define('Salespro.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Salespro.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
