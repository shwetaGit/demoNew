 ...
 * 
 */
Ext.define('Salespro.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Salespro.view.logalarm.mainscreen.AddLogAlarmController',
			'Salespro.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Salespro.view.logalarm.mainscreen.AppAlarmPanel',
