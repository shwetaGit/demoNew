 ...
 * 
 */
Ext.define('Salespro.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Salespro.view.logalarm.LogAlarmMainViewController',
			'Salespro.view.logalarm.tree.LogAlarmTreePanel',
			'Salespro.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
