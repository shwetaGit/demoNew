package com.app.server.businessservice.aaaboundedcontext.authorization.aspect;
...
public class BusinessServiceauthorizationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.aaaboundedcontext.authorization..*(..))")
