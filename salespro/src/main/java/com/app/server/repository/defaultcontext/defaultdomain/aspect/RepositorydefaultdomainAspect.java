package com.app.server.repository.defaultcontext.defaultdomain.aspect;
...
public class RepositorydefaultdomainAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.app.server.repository.defaultcontext.defaultdomain..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.defaultcontext.defaultdomain..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.defaultcontext.defaultdomain..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.defaultcontext.defaultdomain..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.defaultcontext.defaultdomain..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.defaultcontext.defaultdomain..*(..))")
