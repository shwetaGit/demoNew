package com.app.server.repository.defaultcontext.defaultdomain;
...
@SourceCodeAuthorClass(createdBy = "sagarjdhv968@gmail.com", updatedBy = "", versionNumber = "1", comments = "Repository for LoginPageEn Master table Entity", complexity = Complexity.LOW)
public interface LoginPageEnRepository<T> extends SearchInterface {
    ...
    public T findById(String loginUuid) throws Exception, SpartanPersistenceException;
}
