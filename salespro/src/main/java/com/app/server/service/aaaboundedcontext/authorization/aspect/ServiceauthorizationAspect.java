package com.app.server.service.aaaboundedcontext.authorization.aspect;
...
public class ServiceauthorizationAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.app.server.service.aaaboundedcontext.authorization..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.service.aaaboundedcontext.authorization..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.service.aaaboundedcontext.authorization..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.service.aaaboundedcontext.authorization..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.service.aaaboundedcontext.authorization..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.aaaboundedcontext.authorization..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
