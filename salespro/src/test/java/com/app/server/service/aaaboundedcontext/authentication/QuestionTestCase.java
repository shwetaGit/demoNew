...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        question.setQuestionDetails("Hc9urxNpRk");
        question.setQuestion("XXzDo8iyCrByTktCGCwGChvMoLwe5dB7K0RWi625ZdAlVzpWHt");
        question.setQuestionIcon("1AwzF3JfnJEgHUBNpqJuMnRID9Xrc04mWINUBtylteHgKtSZuk");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("o366E3DSU8");
            question.setQuestion("RH13pfAeF5rA8rOPWAObuREflosRF9RG8U5dU9FtGzSKHt8Uvo");
            question.setQuestionIcon("iNSMSkFk15xXfaZrx5w5nh7rh2301y2v8GIcKTh8JG05nAtUNf");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "UTaqL02nGwEZsacxS5KEbwZYP5WFdp0FNIPbkoqJUUYuJeDqlNJW1DOg0KdVG1XmD"));
