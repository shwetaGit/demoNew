...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        useraccesslevel.setLevelIcon("EkbyM9IcFaJAhdpFDyt2w2kL9dbOxuV3pecse6QIfBuSR8iNjj");
        useraccesslevel.setLevelHelp("vDSMPLID9Rs0Vv8aFs5eTC8DqzIFm9MMWuCaEgdF4rdIA8UE1P");
        useraccesslevel.setLevelName("6IrugyzD26tb2yojNyBWkPadMwn7WpSD0KrGhMEPRGFglYmKz9");
        useraccesslevel.setLevelDescription("1pJYwLu4RQqg1Dq2n61QTB0YPqclr46M9RoAu4WgD3Wyo2ml42");
        ...
        useraccessdomain.setDomainHelp("E7Mq8q3xBXJ6iBSU5SQ2Fp1qhYpgZWvXFgbuUdFuIoqmCQaqmI");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainName("iWe1FBDA1PjVMBmU6Dl8LFDrjMrUPJzqrdiZ8Ucr7EfoaMr3Z0");
        useraccessdomain.setDomainDescription("w5HcJDA5BFqWcJ61klCDUHWldAHqMvrv5oy5GbpkJ2V59I7PHt");
        useraccessdomain.setDomainIcon("bsAVx7Qr4LlIbHAyllDWqTi9t9faFAq21gasOkKK7NmXLE2tky");
        ...
        User user = new User();
        user.setSessionTimeout(2433);
        user.setChangePasswordNextLogin(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1459233524842l));
        user.setPasswordExpiryDate(new java.sql.Timestamp(1459233524842l));
        user.setGenTempOneTimePassword(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setMultiFactorAuthEnabled(1);
        user.setPasswordAlgo("Vhtoa26poYFzLo4OSL1wAYFArVlJAycDTRvJsB9VNuHAvGBXrY");
        user.setIsLocked(1);
        user.setUserAccessCode(7094);
        user.setAllowMultipleLogin(1);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsDeleted(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("NudVZYP85uC93QFXGVPJIii9J33rqhF0M2Hr3bvsLYo9JVyi2x");
        Question question = new Question();
        question.setLevelid(5);
        question.setQuestionDetails("0BjNf0VX1e");
        question.setQuestion("1iipwsdZ5XMV2Rl9PavqXVlOucWXq9kEgJW0avj9MrY66VGd4j");
        question.setQuestionIcon("p7S4vuIO2fAIKinKwzBFCzEQn6KTcXDBUWFOMzyCqoLfaCOCRi");
        Question QuestionTest = new Question();
        if (isSave) {
            QuestionTest = questionRepository.save(question);
        }
        map.put("QuestionPrimaryKey", question._getPrimarykey());
        passrecovery.setAnswer("r9GDmkcqA55gHaedPxRmBi7bX4mT8F4XDORrd0CQTAW6QwL4xA");
        ...
        userdata.setPassword("0QdXXfXjY0lbp6U97Af3Tt4ox55kXcFHqFQJf8H968ZN2KEasG");
        userdata.setLast5Passwords("GVWSd9BEo24OPhXOV7jkppjxdfXMHHcL45KIBb3jEudSfE8N2K");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459233525077l));
        userdata.setOneTimePassword("8buT04DProv2y6FhwaCHyt2LAQO1CXHg");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 94017));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "hbkS94Agmuna7PUjqDapL277jMQxnRXt3CDnhaXIw5vVNbQroWh8mPyyeHEMfJ56v"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 4892));
