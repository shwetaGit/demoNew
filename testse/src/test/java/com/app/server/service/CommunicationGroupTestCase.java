...
public class CommunicationGroupTestCase {
    ...
    public void test1Save() {
        try {
            ...
            communicationgroup.setCommGroupDescription("3gfWgiz94a13fMYRyhAYmNfCT1dalBEIgEQPzt5pDGAwRJ3ZFV");
            communicationgroup.setCommGroupName("nZOsr3T4XlPk8qQuLAlz4ZguzSHfpSvv81AS92BrUhLy2qMACy");
    ...
    public void test2Update() {
        try {
            ...
            communicationgroup.setCommGroupDescription("B3BjjYU3C9LAi0TUp2d9ggSTZst2YIJurKSQcYrmxmx2YVUFAt");
            communicationgroup.setCommGroupName("Xen7jLDepFBiwOKAetLvKmST3DEAm4zjKARZlDTjttsDcfngXW");
