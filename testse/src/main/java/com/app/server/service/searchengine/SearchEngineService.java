package com.app.server.service.searchengine;
...
public class SearchEngineService {
	...
	public HttpEntity<ResponseBean> getAvailableLanguages(HttpServletRequest request, HttpServletResponse response) throws IOException, JSONException {
		...
		try {
			APICaller caller = new APICaller(appconfig.getSearchEngineConfig().getSearchAppURL() + "secure/SearchEngineController/getAvailableLanguages", "GET");
