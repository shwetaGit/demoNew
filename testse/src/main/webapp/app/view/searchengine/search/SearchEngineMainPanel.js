Ext.define('Testse.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testse.view.searchengine.search.NorthPanel', 'Testse.view.searchengine.search.SearchResult','Testse.view.searchengine.search.SearchEngineMainPanelController'],
