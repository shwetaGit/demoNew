Ext
		.define(
				'Testse.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testse.view.searchengine.search.SearchEngineMainPanelController','Testse.view.searchengine.search.PanelHeaderField' ,'Testse.view.searchengine.search.ReportGridView','Testse.view.searchengine.search.ReportChartView','Testse.view.searchengine.search.documentView','Testse.view.searchengine.search.DouMeanView','Testse.view.googlemaps.map.MapPanel'],
