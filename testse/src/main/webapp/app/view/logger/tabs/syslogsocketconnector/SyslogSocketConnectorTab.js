 ...
 * 
 */
Ext.define('Testse.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testse.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
