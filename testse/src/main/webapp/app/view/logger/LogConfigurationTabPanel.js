...
Ext
		.define(
				'Testse.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testse.view.logger.tabs.details.DetailsTab',
							'Testse.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testse.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testse.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testse.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testse.view.logger.LogConfigurationTabPanelController',
