 ...
 * 
 */
Ext.define('Testse.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testse.view.logalarm.mainscreen.AddLogAlarmController',
			'Testse.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testse.view.logalarm.mainscreen.AppAlarmPanel',
