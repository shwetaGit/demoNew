Ext.define("Testse.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Testse.view.clouddrive.CloudDriveController',
	             'Testse.view.clouddrive.documentview.DocumentsView',
	             'Testse.view.clouddrive.drivedetails.DriveDetails',
	             //'Testse.view.clouddrive.documentview.DocumentListView'
	             ],
