Ext.define('Testse.testse.web.com.controller.organizationboundedcontext.contacts.GenderMainController', {
     ...
     loadData: function(responseData) {
          this.view.down('#GenderForm').getViewModel().setData(responseData.response.data);
     },
