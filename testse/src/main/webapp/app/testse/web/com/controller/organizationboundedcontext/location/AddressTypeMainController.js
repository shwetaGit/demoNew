Ext.define('Testse.testse.web.com.controller.organizationboundedcontext.location.AddressTypeMainController', {
     ...
     loadData: function(responseData) {
          this.view.down('#AddressTypeForm').getViewModel().setData(responseData.response.data);
     },
