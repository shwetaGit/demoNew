Ext.define('Testse.testse.web.com.controller.aaaboundedcontext.authentication.QuestionMainController', {
     ...
     loadData: function(responseData) {
          this.view.down('#QuestionForm').getViewModel().setData(responseData.response.data);
     },
