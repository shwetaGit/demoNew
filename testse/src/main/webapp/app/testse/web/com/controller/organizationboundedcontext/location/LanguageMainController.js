Ext.define('Testse.testse.web.com.controller.organizationboundedcontext.location.LanguageMainController', {
     ...
     loadData: function(responseData) {
          this.view.down('#LanguageForm').getViewModel().setData(responseData.response.data);
     },
