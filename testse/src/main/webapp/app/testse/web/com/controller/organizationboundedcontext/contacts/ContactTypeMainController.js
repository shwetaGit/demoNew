Ext.define('Testse.testse.web.com.controller.organizationboundedcontext.contacts.ContactTypeMainController', {
     ...
     loadData: function(responseData) {
          this.view.down('#ContactTypeForm').getViewModel().setData(responseData.response.data);
     },
