Ext.define('Testse.testse.web.com.controller.organizationboundedcontext.contacts.CommunicationTypeMainController', {
     ...
     loadData: function(responseData) {
          this.view.down('#CommunicationTypeForm').getViewModel().setData(responseData.response.data);
     },
