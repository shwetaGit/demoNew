Ext.define('Testse.testse.web.com.controller.organizationboundedcontext.location.CityMainController', {
     ...
     loadData: function(responseData) {
          this.view.down('#CityForm').getViewModel().setData(responseData.response.data);
     },
