Ext.define('Testse.testse.web.com.controller.organizationboundedcontext.location.StateMainController', {
     ...
     loadData: function(responseData) {
          this.view.down('#StateForm').getViewModel().setData(responseData.response.data);
     },
