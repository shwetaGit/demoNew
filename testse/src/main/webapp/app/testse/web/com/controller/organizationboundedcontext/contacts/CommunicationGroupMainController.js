Ext.define('Testse.testse.web.com.controller.organizationboundedcontext.contacts.CommunicationGroupMainController', {
     extend: 'Testse.view.fw.frameworkController.FrameworkViewController',
     ...
     loadData: function(responseData) {
          this.view.down('#CommunicationGroupForm').getViewModel().setData(responseData.response.data);
     },
