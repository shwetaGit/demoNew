Ext.define('Testse.testse.web.com.controller.organizationboundedcontext.location.CountryMainController', {
     ...
     loadData: function(responseData) {
          this.view.down('#CountryForm').getViewModel().setData(responseData.response.data);
     },
