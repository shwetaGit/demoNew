Ext.define('Testse.testse.web.com.controller.organizationboundedcontext.contacts.TitleMainController', {
     ...
     loadData: function(responseData) {
          this.view.down('#TitleForm').getViewModel().setData(responseData.response.data);
     },
