Ext.define('Testse.testse.web.com.controller.organizationboundedcontext.location.TimezoneMainController', {
     ...
     loadData: function(responseData) {
          this.view.down('#TimezoneForm').getViewModel().setData(responseData.response.data);
     },
